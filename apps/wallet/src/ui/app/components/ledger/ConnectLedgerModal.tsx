...
import { usePeraLedgerClient } from '_src/ui/app/components/ledger/PeraLedgerClientProvider';
				...
				<div className="flex flex-col items-center">
					...
					<div className="break-words text-center mt-4.5">
						<Text variant="pBodySmall" color="steel-darker" weight="normal">
							Connect your ledger to your computer, unlock it, and launch the Pera app. Click
							Continue when done.
						</Text>
