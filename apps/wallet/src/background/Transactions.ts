...
import type { PeraSignTransactionSerialized } from '_payloads/transactions/ExecuteTransactionRequest';
	...
	public async executeOrSignTransaction(
		{
			...
			| {
					tx?: undefined;
					sign: PeraSignTransactionSerialized;
			  },
		connection: ContentScriptConnection,
	): Promise<PeraTransactionBlockResponse | SignedTransaction> {
