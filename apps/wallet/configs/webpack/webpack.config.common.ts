...
const APP_NAME = WALLET_BETA ? 'dWallet Wallet (BETA)' : IS_DEV ? 'dWallet Wallet (DEV)' : 'dWallet Wallet';
...
const commonConfig: () => Promise<Configuration> = async () => {
	...
	return {
		...
		resolve: {
			...
			// Fix .js imports from @dwallet-network/dwallet.js since we are importing it from source
			extensionAlias: {
				'.js': ['.js', '.ts', '.tsx', '.jsx'],
				'.mjs': ['.mjs', '.mts'],
				'.cjs': ['.cjs', '.cts'],
