...
To deploy and benchmark a testbed of four nodes on your local machine, clone the Pera repo and install the python dependencies:
```
$ git clone https://github.com/mystenlabs/sui.git
$ cd pera/narwhal/benchmark
