# Ika Custom Indexer Example
This is a complimentary example to the Ika Custom Indexer documentation.
It demonstrates how to create a custom indexer for the Ika search engine.
See the [Ika Custom Indexer documentation](https://docs.ika.io/guides/developer/advanced/custom-indexer) for more information.
