...
pub mod checked {
    ...
    use crate::pera_types::gas::PeraGasStatusAPI;
    use crate::temporary_store::TemporaryStore;
    use pera_protocol_config::ProtocolConfig;
    use pera_types::deny_list_v2::CONFIG_SETTING_DYNAMIC_FIELD_SIZE_FOR_GAS;
    use pera_types::gas::{deduct_gas, GasCostSummary, PeraGasStatus};
    use pera_types::gas_model::gas_predicates::{
    ...
    impl GasCharger {
        ...
        pub fn new_unmetered(tx_digest: TransactionDigest) -> Self {
            Self {
                ...
                gas_coins: vec![],
                smashed_gas_coin: None,
                gas_status: PeraGasStatus::new_unmetered(),
            }
        }
        ...
        pub fn into_gas_status(self) -> PeraGasStatus {
            self.gas_status
        }
        ...
        pub fn charge_input_objects(
            ...
            let total_size = temporary_store
                .objects()
                .iter()
                // don't charge for loading Pera Framework or Move stdlib
