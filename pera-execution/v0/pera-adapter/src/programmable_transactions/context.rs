...
mod checked {
    ...
    use pera_types::execution_status::CommandArgumentError;
    ...
    impl<'vm, 'state, 'a> ExecutionContext<'vm, 'state, 'a> {
        pub fn new(
            ...
            // TODO remove this
            let linkage = LinkageView::new(Box::new(state_view.as_pera_resolver()), init_linkage);
            ...
            // exist. Plus, Pera Move does not use these changes or events
    ...
    // Create a new Session peratable for resolving type and type operations rather than execution
