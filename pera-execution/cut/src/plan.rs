...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let pera_execution = root.join("pera-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&pera_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/pera-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "pera-adapter-latest".to_string(),
                "pera-execution-cut".to_string(),
                "pera-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/pera-execution/cut-cut",
                    "$PATH/pera-execution/cut-move-core-types",
                    "$PATH/pera-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/pera-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "pera-adapter-latest": CutPackage {
                        dst_name: "pera-adapter-feature",
                        src_path: "$PATH/pera-execution/latest/pera-adapter",
                        dst_path: "$PATH/pera-execution/exec-cut/pera-adapter",
                        ws_state: Member,
                    },
                    "pera-execution-cut": CutPackage {
                        dst_name: "pera-execution-cut-feature",
                        src_path: "$PATH/pera-execution/cut",
                        dst_path: "$PATH/pera-execution/cut-cut",
                        ws_state: Member,
                    },
                    "pera-verifier-latest": CutPackage {
                        dst_name: "pera-verifier-feature",
                        src_path: "$PATH/pera-execution/latest/pera-verifier",
                        dst_path: "$PATH/pera-execution/exec-cut/pera-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   pera-adapter-feature
                     pera-execution/exec-cut/pera-adapter
               from: pera-adapter-latest
                     pera-execution/latest/pera-adapter
             - to:   pera-execution-cut-feature
                     pera-execution/cut-cut
               from: pera-execution-cut
                     pera-execution/cut
             - to:   pera-verifier-feature
                     pera-execution/exec-cut/pera-verifier
               from: pera-verifier-latest
                     pera-execution/latest/pera-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     pera-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/pera-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/pera-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "pera-adapter-latest": CutPackage {
                        dst_name: "pera-adapter-feature",
                        src_path: "$PATH/pera-execution/latest/pera-adapter",
                        dst_path: "$PATH/pera-execution/feature/pera-adapter",
                        ws_state: Member,
                    },
                    "pera-execution-cut": CutPackage {
                        dst_name: "pera-execution-cut-feature",
                        src_path: "$PATH/pera-execution/cut",
                        dst_path: "$PATH/pera-execution/feature/cut",
                        ws_state: Member,
                    },
                    "pera-verifier-latest": CutPackage {
                        dst_name: "pera-verifier-feature",
                        src_path: "$PATH/pera-execution/latest/pera-verifier",
                        dst_path: "$PATH/pera-execution/feature/pera-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
