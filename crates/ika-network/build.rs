    ...
    let state_sync = anemo_build::manual::Service::builder()
        ...
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("ika_types::messages_checkpoint::CertifiedCheckpointSummary")
                .response_type("()")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .response_type("Option<ika_types::messages_checkpoint::CertifiedCheckpointSummary>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("ika_types::messages_checkpoint::CheckpointContentsDigest")
                .response_type("Option<ika_types::messages_checkpoint::FullCheckpointContents>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
