...
pub struct JsonRpcMetrics {
    ...
    pub get_stake_pera_result_size: Histogram,
    pub get_stake_pera_result_size_total: IntCounter,

    pub get_stake_pera_latency: Histogram,
    pub get_delegated_pera_latency: Histogram,
...
impl JsonRpcMetrics {
    pub fn new(registry: &prometheus::Registry) -> Self {
        Self {
            ...
            .unwrap(),
            get_stake_pera_result_size: Histogram::new_in_registry(
                "json_rpc_get_stake_pera_result_size",
                "The return size for get_stake_pera",
                registry,
            ),
            get_stake_pera_result_size_total: register_int_counter_with_registry!(
                "json_rpc_get_stake_pera_result_size_total",
                "The total return size for get_stake_pera",
                registry
            )
            .unwrap(),
            get_stake_pera_latency: Histogram::new_in_registry(
                "get_stake_pera_latency",
                "The latency of get stake pera, in ms",
                registry,
            ),
            get_delegated_pera_latency: Histogram::new_in_registry(
                "get_delegated_pera_latency",
                "The latency of get delegated pera, in ms",
                registry,
            ),
