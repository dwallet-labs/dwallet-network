...
use pera_types::effects::TransactionEffects as NativeTransactionEffects;
use pera_types::event::Event as NativeEvent;
use pera_types::quorum_driver_types::ExecuteTransactionRequestType;
use pera_types::transaction::SenderSignedData;
use pera_types::{signature::GenericSignature, transaction::Transaction};
pub struct Mutation;
...
impl Mutation {
    ...
    async fn execute_transaction_block(
        ...
        let options = PeraTransactionBlockResponseOptions::new()
            .with_events()
            .with_raw_input()
            .with_raw_effects();

        let result = pera_sdk_client
            .quorum_driver_api()
