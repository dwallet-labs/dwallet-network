...
use pera_graphql_rpc_client::simple_client::SimpleClient;
use pera_indexer::errors::IndexerError;
pub use pera_indexer::handlers::objects_snapshot_processor::SnapshotLagConfig;
use pera_indexer::store::indexer_store::IndexerStore;
use pera_indexer::store::PgIndexerStore;
use pera_indexer::test_utils::force_delete_database;
use pera_indexer::test_utils::start_test_indexer_impl;
use pera_indexer::test_utils::ReaderWriterConfig;
...
/// Takes in a simulated instantiation of a Pera blockchain and builds a cluster around it. This
...
pub async fn serve_executor(
    ...
    let executor_server_handle = tokio::spawn(async move {
        pera_rest_api::RestService::new_without_version(executor)
