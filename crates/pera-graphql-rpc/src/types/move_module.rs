...
use pera_package_resolver::Module as ParsedMoveModule;
...
use super::{base64::Base64, move_package::MovePackage, pera_address::PeraAddress};

#[derive(Clone)]
pub(crate) struct MoveModule {
    pub storage_id: PeraAddress,
    pub native: Vec<u8>,
