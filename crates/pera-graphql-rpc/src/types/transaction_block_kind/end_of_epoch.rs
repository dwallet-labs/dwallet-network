...
use pera_types::digests::ChainIdentifier as PeraChainIdentifier;
use pera_types::{
...
pub(crate) struct BridgeStateCreateTransaction {
    pub native: PeraChainIdentifier,
    /// The checkpoint sequence number this was viewed at.
    pub checkpoint_viewed_at: u64,
}
...
impl ChangeEpochTransaction {
    ...
    async fn system_packages(
        ...
        for c in cs {
            ...
            let object = Object::from_native(PeraAddress::from(runtime_id), native, c.c, None);
