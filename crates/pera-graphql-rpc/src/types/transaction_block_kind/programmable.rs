...
use pera_json_rpc_types::PeraArgument;
...
impl MoveCallTransaction {
    ...
    async fn package(&self) -> PeraAddress {
    ...
    fn from(pt: NativeProgrammableTransaction, checkpoint_viewed_at: u64) -> Self {
        ...
        match pt {
            ...
            N::Publish(modules, dependencies) => P::Publish(PublishTransaction {
                ...
                dependencies: dependencies.into_iter().map(PeraAddress::from).collect(),
            }),
...
impl From<PeraArgument> for TransactionArgument {
    fn from(argument: PeraArgument) -> Self {
        use PeraArgument as S;
        use TransactionArgument as A;
        match argument {
