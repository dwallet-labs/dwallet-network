...
fn select_ev(sender: Option<PeraAddress>, from: &str) -> RawQuery {
...
pub(crate) fn select_sender(sender: PeraAddress) -> RawQuery {
    select_ev(Some(sender), "event_senders")
}

pub(crate) fn select_event_type(event_type: &TypeFilter, sender: Option<PeraAddress>) -> RawQuery {
    match event_type {
