...
use async_graphql::*;
use pera_types::base_types::ObjectRef as NativeObjectRef;

use super::{object::Object, pera_address::PeraAddress, uint53::UInt53};
...
impl ObjectRead {
    ...
    async fn address(&self) -> PeraAddress {
        self.address_impl()
    }
...
impl ObjectRead {
    fn address_impl(&self) -> PeraAddress {
        PeraAddress::from(self.native.0)
    }
