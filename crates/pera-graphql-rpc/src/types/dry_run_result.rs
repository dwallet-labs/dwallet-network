...
use async_graphql::*;
use pera_json_rpc_types::{DevInspectResults, PeraExecutionResult};
use pera_types::effects::TransactionEffects as NativeTransactionEffects;
use pera_types::transaction::TransactionData as NativeTransactionData;
...
impl TryFrom<PeraExecutionResult> for DryRunEffect {
    type Error = crate::error::Error;

    fn try_from(result: PeraExecutionResult) -> Result<Self, Self::Error> {
