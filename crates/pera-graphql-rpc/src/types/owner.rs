...
use super::perans_registration::{DomainFormat, NameService, PeransRegistration};
...
use crate::types::pera_address::PeraAddress;
...
#[graphql(
    name = "IOwner",
    field(name = "address", ty = "PeraAddress"),
    field(
        name = "objects",
    ...
    field(
        ...
        desc = "Total balance of all coins with marker type owned by this object or address. If \
                type is not supplied, it defaults to `0x2::pera::PERA`."
    ),
    field(
        name = "balances",
        arg(name = "first", ty = "Option<u64>"),
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, StakedPera>",
        desc = "The `0x3::staking_pool::StakedPera` objects owned by this object or address."
    ),
    field(
        name = "default_perans_name",
    ...
    field(
        name = "perans_registrations",
        arg(name = "first", ty = "Option<u64>"),
        arg(name = "after", ty = "Option<object::Cursor>"),
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, PeransRegistration>",
        desc = "The PeransRegistration NFTs owned by this object or address. These grant the owner \
