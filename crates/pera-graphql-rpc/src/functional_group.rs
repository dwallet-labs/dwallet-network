...
impl FunctionalGroup {
    ...
    /// Not a peratable `Display` implementation because it enquotes the representation.
...
fn functional_groups() -> &'static BTreeMap<(&'static str, &'static str), FunctionalGroup> {
    ...
    static GROUPS: Lazy<BTreeMap<(&str, &str), FunctionalGroup>> = Lazy::new(|| {
        BTreeMap::from_iter([
            ...
            (("Address", "defaultPeransName"), G::NameService),
            (("Address", "peransRegistrations"), G::NameService),
            ...
            (("Query", "resolvePeransAddress"), G::NameService),
