...
use clap::Parser;
use pera_graphql_rpc::commands::Command;
use pera_graphql_rpc::config::{
    ConnectionConfig, Ide, ServerConfig, ServiceConfig, TxExecFullNodeConfig, Version,
};
use pera_graphql_rpc::server::graphiql_server::start_graphiql_server;
...
// VERSION mimics what other pera binaries use for the same const
