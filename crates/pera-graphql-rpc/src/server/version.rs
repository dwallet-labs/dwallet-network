...
pub(crate) static VERSION_HEADER: HeaderName = HeaderName::from_static("x-pera-rpc-version");

#[allow(unused)]
pub(crate) struct PeraRpcVersion(Vec<u8>, Vec<Vec<u8>>);
const NAMED_VERSIONS: [&str; 3] = ["beta", "legacy", "stable"];

impl headers::Header for PeraRpcVersion {
        ...
        I: Iterator<Item = &'i HeaderValue>,
    {
        ...
        Ok(PeraRpcVersion(value, values.collect()))
    }
