...
mod tests {
    ...
    async fn prep_executor_cluster() -> (ConnectionConfig, ExecutorCluster) {
        ...
        let cluster = pera_graphql_rpc::test_infra::cluster::serve_executor(
    ...
    async fn test_simple_client_validator_cluster() {
        ...
        let cluster =
            pera_graphql_rpc::test_infra::cluster::start_cluster(ConnectionConfig::default(), None)
                .await;
    ...
    async fn test_graphql_client_variables() {
        ...
        assert_eq!(
            data.get("obj1")
                ...
                .as_str()
                .unwrap(),
            PERA_FRAMEWORK_ADDRESS.to_canonical_string(true)
        );
        assert_eq!(
            data.get("obj2")
                .unwrap()
    ...
    async fn test_transaction_execution() {
        ...
        let tx = cluster
            ...
            .await
            .transfer_pera(Some(1_000), recipient)
            .build();
    ...
    async fn test_zklogin_sig_verify() {
        ...
        let tx_data = TestTransactionBuilder::new(zklogin_addr, gas, rgp)
            ...
            .build();
        let msg = IntentMessage::new(Intent::pera_transaction(), tx_data.clone());
    ...
    use pera_graphql_rpc::server::builder::tests::*;
    ...
    async fn test_timeout() {
        ...
        cluster
            .wait_for_checkpoint_catchup(0, Duration::from_secs(10))
            .await;
        // timeout test includes mutation timeout, which requies a [PeraClient] to be able to run
    ...
    async fn test_health_check() {
        ...
        let connection_config = ConnectionConfig::ci_integration_test_cfg();
        let cluster =
            pera_graphql_rpc::test_infra::cluster::start_cluster(connection_config, None).await;
