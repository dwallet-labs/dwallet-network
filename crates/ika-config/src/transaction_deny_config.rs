...
pub struct TransactionDenyConfig {
    ...
    /// A list of ika addresses that are not allowed to be used as the sender or sponsor.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    address_deny_list: Vec<IkaAddress>,
    ...
    #[serde(skip)]
    address_deny_set: OnceCell<HashSet<IkaAddress>>,
...
impl TransactionDenyConfig {
    ...
    pub fn get_address_deny_set(&self) -> &HashSet<IkaAddress> {
...
impl TransactionDenyConfigBuilder {
    ...
    pub fn add_denied_address(mut self, address: IkaAddress) -> Self {
