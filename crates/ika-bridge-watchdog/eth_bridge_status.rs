...
impl EthBridgeStatus {
    pub fn new(
        ...
        let bridge_contract = EthIkaBridge::new(bridge_address, provider.clone());
        Self {
            bridge_contract,
            metric,
        }
