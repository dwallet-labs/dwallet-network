...
use pera_json_rpc_types::PeraRawMoveObject;
use pera_package_management::PublishedAtError;
use pera_sdk::error::Error as SdkError;
use pera_types::{base_types::ObjectID, error::PeraObjectResponseError};
...
pub enum Error {
    ...
    #[error("Dependency ID contains a Pera object, not a Move package: {0}")]
    ObjectFoundWhenPackageExpected(ObjectID, PeraRawMoveObject),
    ...
    PeraObjectRefFailure(PeraObjectResponseError),
