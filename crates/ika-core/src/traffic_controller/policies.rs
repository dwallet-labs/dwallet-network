...
use ika_types::traffic_control::{FreqThresholdConfig, PolicyConfig, PolicyType, Weight};
...
pub struct FreqThresholdPolicy {
    ...
    /// all nodes at the same time. For Ika validators for example,
