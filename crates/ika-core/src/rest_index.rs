...
impl OwnerIndexKey {
    fn new(owner: IkaAddress, object_id: ObjectID) -> Self {
...
fn try_create_coin_index_info(object: &Object) -> Option<(CoinIndexKey, CoinIndexInfo)> {
    use ika_types::coin::CoinMetadata;
