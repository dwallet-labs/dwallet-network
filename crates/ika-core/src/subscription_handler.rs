...
use ika_json_rpc_types::{
    EffectsWithInput, EventFilter, IkaTransactionBlockEffects, IkaTransactionBlockEvents,
    TransactionFilter,
};
use ika_json_rpc_types::{IkaEvent, IkaTransactionBlockEffectsAPI};
...
pub struct SubscriptionHandler {
    event_streamer: Streamer<IkaEvent, IkaEvent, EventFilter>,
    transaction_streamer: Streamer<EffectsWithInput, IkaTransactionBlockEffects, TransactionFilter>,
}
...
impl SubscriptionHandler {
    ...
    pub async fn process_tx(
        ...
        effects: &IkaTransactionBlockEffects,
        events: &IkaTransactionBlockEvents,
    ) -> IkaResult {
        trace!(
    ...
    pub fn subscribe_events(&self, filter: EventFilter) -> impl Stream<Item = IkaEvent> {
    ...
    ) -> impl Stream<Item = IkaTransactionBlockEffects> {
