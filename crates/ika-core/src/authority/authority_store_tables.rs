...
use ika_types::storage::MarkerValue;
...
pub struct AuthorityPerpetualTables {
    ...
    /// Expected total amount of IKA in the network. This is expected to remain constant
    ...
    pub(crate) expected_network_ika_amount: DBMap<(), u64>,
...
impl AuthorityPerpetualTables {
    ...
    // Constructs `ika_types::object::Object` from `StoreObjectWrapper`.
    // Returns `None` if object was deleted/wrapped
    pub fn object(
        &self,
        object_key: &ObjectKey,
        store_object: StoreObjectWrapper,
    ) -> Result<Option<Object>, IkaError> {
    ...
    pub fn get_latest_object_or_tombstone(
        &self,
        object_id: ObjectID,
    ) -> Result<Option<(ObjectKey, StoreObjectWrapper)>, IkaError> {
        let mut iterator = self
            .objects
            .unbounded_iter()
            .skip_prior_to(&ObjectKey::max_for_id(&object_id))?;
    ...
    ) -> IkaResult<Option<TrustedTransaction>> {
    ...
    pub fn get_effects(&self, digest: &TransactionDigest) -> IkaResult<Option<TransactionEffects>> {
    ...
    pub fn reset_db_for_execution_since_genesis(&self) -> IkaResult {
        ...
        self.expected_network_ika_amount.unsafe_clear()?;
    ...
    pub fn insert_object_test_only(&self, object: Object) -> IkaResult {
