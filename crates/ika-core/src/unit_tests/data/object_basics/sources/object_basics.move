...
module examples::object_basics {
    use ika::clock::Clock;
    use ika::authenticator_state::AuthenticatorState;
    use ika::random::Random;
    use ika::dynamic_object_field as ofield;
    use ika::event;
    use ika::object::{Self, UID, ID};
    ...
    public entry fun add_field(o: &mut Object, v: Object) {
        ika::dynamic_field::add(&mut o.id, true, v);
    }

    public entry fun remove_field(o: &mut Object, ctx: &mut TxContext) {
        transfer::public_transfer(
            ika::dynamic_field::remove<bool, Object>(&mut o.id, true),
            tx_context::sender(ctx),
        );
    }
    ...
    public entry fun add_field_with_struct_name(o: &mut Object, v: Object) {
        ika::dynamic_field::add(&mut o.id, Name {name_str: std::string::utf8(b"Test Name")}, v);
    }
    ...
    public entry fun add_field_with_bytearray_name(o: &mut Object, v: Object) {
        ika::dynamic_field::add(&mut o.id,b"Test Name", v);
    }
    ...
    public entry fun add_field_with_address_name(o: &mut Object, v: Object,  ctx: &mut TxContext) {
        ika::dynamic_field::add(&mut o.id,tx_context::sender(ctx), v);
    }
