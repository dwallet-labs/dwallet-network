...
impl RocksDbStore {
    ...
    pub fn get_last_executed_checkpoint(&self) -> Result<Option<VerifiedCheckpointMessage>, IkaError> {
...
impl ReadStore for RocksDbStore {
    ...
    fn get_highest_verified_checkpoint(&self) -> Result<Option<VerifiedCheckpointMessage>, StorageError> {
        self.checkpoint_store
            .get_highest_verified_checkpoint()
            .map_err(Into::into)
    }

    fn get_highest_synced_checkpoint(&self) -> Result<Option<VerifiedCheckpointMessage>, StorageError> {
        self.checkpoint_store
    ...
    fn get_latest_checkpoint(&self) -> ika_types::storage::error::Result<VerifiedCheckpointMessage> {
        self.checkpoint_store
