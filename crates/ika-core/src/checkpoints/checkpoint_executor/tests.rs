...
use ika_types::messages_checkpoint::{ECMHLiveObjectSetDigest, EndOfEpochData, VerifiedCheckpoint};
...
async fn init_executor_test(
    ...
    let network_config =
        ika_swarm_config::network_config_builder::ConfigBuilder::new_with_temp_dir().build();
