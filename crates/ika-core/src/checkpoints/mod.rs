...
use crate::checkpoints::checkpoint_output::{
...
pub use crate::checkpoints::metrics::DWalletCheckpointMetrics;
...
pub struct CheckpointStore {
    ...
    epoch_last_checkpoint_map: DBMap<EpochId, DWalletCheckpointSequenceNumber>,
