...
use ika_types::storage::{MarkerValue, ObjectKey, ObjectOrTombstone, PackageObject};
...
impl ObjectCacheRead for ProxyCache {
    ...
    fn get_ika_system_state_object_unsafe(&self) -> IkaResult<IkaSystemState> {
        delegate_method!(self.get_ika_system_state_object_unsafe())
    }
...
impl ExecutionCacheReconfigAPI for ProxyCache {
    ...
    fn expensive_check_ika_conservation(
        ...
        delegate_method!(self.expensive_check_ika_conservation(old_epoch_store))
    }
