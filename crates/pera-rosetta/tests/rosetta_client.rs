...
pub async fn start_rosetta_test_server(client: PeraClient) -> (RosettaClient, Vec<JoinHandle<()>>) {
    let online_server = RosettaOnlineServer::new(PeraEnv::LocalNet, client);
    let offline_server = RosettaOfflineServer::new(PeraEnv::LocalNet);
...
impl RosettaClient {
    ...
    pub async fn rosetta_flow(
        ...
        let network_identifier = NetworkIdentifier {
            blockchain: "pera".to_string(),
            network: PeraEnv::LocalNet,
        };
        // Preprocess
            ...
            .call(
                ...
                &ConstructionCombineRequest {
                    ...
                    signatures: vec![Signature {
                        ...
                        hex_bytes: Hex::from_bytes(PeraSignature::signature_bytes(&signature)),
                    }],
                },
            )
            .await;
