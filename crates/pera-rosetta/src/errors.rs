...
/// Pera-Rosetta specific error types.
/// This contains all the errors returns by the pera-rosetta server.
...
pub enum Error {
    ...
    #[error(transparent)]
    PeraRpcError(#[from] pera_sdk::error::Error),
    #[error(transparent)]
