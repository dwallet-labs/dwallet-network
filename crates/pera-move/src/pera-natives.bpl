...
{%- for instance in pera_event_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native Pera event implementation for object type `{{instance.suffix}}`
...
{%- for instance in pera_types_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native Pera types implementation for object type `{{instance.suffix}}`
...
// ----------------------------------------------------------------------------------
// Native Pera prover implementation for object type `{{instance.suffix}}`
