...
#[test_only]
module dwallet::zklogin_verified_issuer_tests {
    use dwallet::zklogin_verified_issuer::{check_zklogin_issuer, delete, verify_zklogin_issuer, VerifiedIssuer};
    use std::string::utf8;
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::zklogin_verified_issuer::EInvalidProof)]
