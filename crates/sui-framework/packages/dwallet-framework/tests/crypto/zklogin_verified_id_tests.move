...
#[test_only]
module dwallet::zklogin_verified_id_tests {
    use dwallet::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};
    use std::string::utf8;
    use dwallet::test_scenario;

    #[test]
    #[expected_failure(abort_code = dwallet::zklogin_verified_id::EFunctionDisabled)]
