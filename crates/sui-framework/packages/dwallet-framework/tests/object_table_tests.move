...
#[test_only]
module dwallet::object_table_tests {
    use std::option;
    use dwallet::object_table::{Self, add, contains, borrow, borrow_mut, remove, value_id};
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::object_table::ETableNotEmpty)]
