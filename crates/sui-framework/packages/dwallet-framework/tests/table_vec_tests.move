...
#[test_only]
module dwallet::table_vec_tests {
    use dwallet::table_vec;
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::table_vec::ETableNonEmpty)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::table_vec::EIndexOutOfBound)]
