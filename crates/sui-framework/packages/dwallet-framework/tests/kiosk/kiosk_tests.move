...
module dwallet::kiosk_tests {
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EItemLocked)]
    ...
    fun test_purchase() {
        ...
        let payment = coin::mint_for_testing<DWLT>(AMT, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::ENotListed)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EListedExclusively)]
    ...
    #[allow(unused_field)]
    struct WrongAsset has key, store { id: dwallet::object::UID }

    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EItemNotFound)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EIncorrectAmount)]
    fun test_purchase_wrong_amount() {
        ...
        kiosk::place_and_list(&mut kiosk, &owner_cap, asset, AMT);
        let payment = coin::mint_for_testing<DWLT>(AMT + 1, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EAlreadyListed)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::ENotEmpty)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::ENotEnough)]
    ...
    fun test_uid_access() {
        ...
        assert!(dwallet::object::uid_to_inner(uid) == dwallet::object::id(&kiosk), 0);

        test::return_kiosk(kiosk, owner_cap, ctx);
    }

    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EUidAccessNotAllowed)]
