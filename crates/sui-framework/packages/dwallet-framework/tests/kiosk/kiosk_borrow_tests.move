...
module dwallet::kiosk_borrow_tests {
    use dwallet::kiosk_test_utils::{Self as utils, Asset};
    use dwallet::kiosk;
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::ENotOwner)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EItemIsListed)]
    ...
    fun test_borrow_val() {
        ...
        assert!(dwallet::object::id(&item) == id, 0);
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EWrongKiosk)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::kiosk::EItemMismatch)]
