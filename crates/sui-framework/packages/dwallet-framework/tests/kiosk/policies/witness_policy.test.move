...
#[test_only]
module dwallet::witness_policy_tests {
    use dwallet::witness_policy;
    use dwallet::tx_context::dummy as ctx;
    use dwallet::transfer_policy as policy;
    use dwallet::transfer_policy_tests::{
        Self as test,
        Asset
    };
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::witness_policy::ERuleNotFound)]
