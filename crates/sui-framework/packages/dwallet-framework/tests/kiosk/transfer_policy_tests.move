...
#[test_only]
module dwallet::malicious_policy {
    use dwallet::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module dwallet::transfer_policy_tests {
    use dwallet::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    use dwallet::tx_context::{Self, TxContext, dummy as ctx};
    use dwallet::object::{Self, ID, UID};
    use dwallet::dummy_policy;
    use dwallet::malicious_policy;
    use dwallet::vec_set;
    use dwallet::package;
    use dwallet::coin;
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::transfer_policy::EIllegalRule)]
