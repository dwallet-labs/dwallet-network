...
#[test_only]
module dwallet::kiosk_marketplace_ext {
    use dwallet::bag;
    use dwallet::dwlt::DWLT;
    use dwallet::coin::{Self, Coin};
    use dwallet::object::{Self, ID};
    use dwallet::tx_context::TxContext;
    use dwallet::kiosk_extension as ext;
    use dwallet::kiosk::{Self, KioskOwnerCap, Kiosk, PurchaseCap};
    use dwallet::transfer_policy::{Self as policy, TransferPolicy, TransferRequest};
    ...
    public fun bid<Market, T: key + store>(
        kiosk: &mut Kiosk, cap: &KioskOwnerCap, bid: Coin<DWLT>
    ) {
...
#[test_only]
module dwallet::kiosk_extensions_tests {
    ...
    #[test, expected_failure(abort_code = dwallet::kiosk_extension::EExtensionNotAllowed)]
    ...
    #[test, expected_failure(abort_code = dwallet::kiosk_extension::EExtensionNotInstalled)]
