...
module dwallet::pay_tests {
    ...
    fun test_coin_split_n() {
        ...
        let coin = coin::mint_for_testing<DWLT>(10, ctx);
        ...
        assert!(
            !test_scenario::has_most_recent_for_sender<Coin<DWLT>>(scenario),
            1
        );
    ...
    fun test_split_and_transfer_fail() {
        ...
        test_scenario::next_tx(scenario, TEST_SENDER_ADDR);
        let coin_transfer_fail = test_scenario::take_from_sender<Coin<DWLT>>(scenario);
