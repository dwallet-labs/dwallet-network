...
/// Similar to `dwallet::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `dwallet::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module dwallet::dynamic_object_field {
