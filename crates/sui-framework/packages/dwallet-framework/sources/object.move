...
module dwallet::object {
    ...
    friend dwallet::clock;
    friend dwallet::dynamic_field;
    friend dwallet::dynamic_object_field;
    friend dwallet::transfer;
    friend dwallet::authenticator_state;
    friend dwallet::random;

    #[test_only]
    friend dwallet::test_scenario;
    ...
    fun dwallet_system_state(ctx: &TxContext): UID {
