...
#[test_only]
module dwallet_system::validator_tests {
    ...
    use dwallet::balance;
    use dwallet_system::staking_pool::{Self, StakedSui};
    use std::vector;
    ...
    fun test_pending_validator_flow() {
        ...
        test_scenario::next_tx(scenario, sender);
        {
            ...
            let withdraw = test_scenario::take_from_sender_by_id<Coin<DWLT>>(scenario, *vector::borrow(&coin_ids, 0));
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EInvalidProofOfPossession)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EMetadataInvalidNetPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EMetadataInvalidWorkerPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EMetadataInvalidNetAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EMetadataInvalidPrimaryAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EMetadataInvalidWorkerAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EMetadataInvalidP2pAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = dwallet_system::validator::EValidatorMetadataExceedingLengthLimit)]
    #[test]
