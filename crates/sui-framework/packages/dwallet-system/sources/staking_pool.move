...
#[allow(unused_const)]
module dwallet_system::staking_pool {
    ...
    fun unwrap_staked_sui(staked_sui: StakedSui): Balance<DWLT> {
        let StakedSui {
            id,
            pool_id: _,
    ...
    public(friend) fun deposit_rewards(pool: &mut StakingPool, rewards: Balance<DWLT>) {
