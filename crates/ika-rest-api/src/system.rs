...
use ika_protocol_config::{ProtocolConfig, ProtocolConfigValue, ProtocolVersion};
use ika_sdk_types::types::{Address, ObjectId};
...
pub struct SystemStateSummary {
    ...
    #[serde_as(as = "ika_types::ika_serde::BigInt<u64>")]
    ...
    #[serde_as(as = "Vec<ika_types::ika_serde::BigInt<u64>>")]
    ...
    #[serde_as(as = "Vec<(_, ika_types::ika_serde::BigInt<u64>)>")]
...
/// This is the REST type for the ika validator. It flattens all inner structures
...
pub struct ValidatorSummary {
    // Metadata
    pub address: Address,
    pub protocol_public_key: ika_sdk_types::types::Bls12381PublicKey,
    pub network_public_key: ika_sdk_types::types::Ed25519PublicKey,
    pub worker_public_key: ika_sdk_types::types::Ed25519PublicKey,
    ...
    pub next_epoch_protocol_public_key: Option<ika_sdk_types::types::Bls12381PublicKey>,
    pub next_epoch_network_public_key: Option<ika_sdk_types::types::Ed25519PublicKey>,
    pub next_epoch_worker_public_key: Option<ika_sdk_types::types::Ed25519PublicKey>,
    ...
    #[serde_as(as = "Option<ika_types::ika_serde::BigInt<u64>>")]
    ...
    #[serde_as(as = "ika_types::ika_serde::BigInt<u64>")]
    #[schemars(with = "crate::_schemars::U64")]
    pub staking_pool_ika_balance: u64,
...
impl From<ika_types::ika_system_state::ika_system_state_summary::IkaValidatorSummary>
    for ValidatorSummary
{
    fn from(
        value: ika_types::ika_system_state::ika_system_state_summary::IkaValidatorSummary,
    ) -> Self {
        let ika_types::ika_system_state::ika_system_state_summary::IkaValidatorSummary {
            ika_address,
        ...
        Self {
            address: ika_address.into(),
            protocol_public_key: ika_sdk_types::types::Bls12381PublicKey::from_bytes(
                protocol_pubkey_bytes,
            )
            .unwrap(),
            network_public_key: ika_sdk_types::types::Ed25519PublicKey::from_bytes(
                network_pubkey_bytes,
            )
            .unwrap(),
            worker_public_key: ika_sdk_types::types::Ed25519PublicKey::from_bytes(
                worker_pubkey_bytes,
            )
            .unwrap(),
            proof_of_possession_bytes,
            ...
            next_epoch_protocol_public_key: next_epoch_protocol_pubkey_bytes
                .map(|bytes| ika_sdk_types::types::Bls12381PublicKey::from_bytes(bytes).unwrap()),
            next_epoch_network_public_key: next_epoch_network_pubkey_bytes
                .map(|bytes| ika_sdk_types::types::Ed25519PublicKey::from_bytes(bytes).unwrap()),
...
impl From<ika_types::ika_system_state::ika_system_state_summary::IkaSystemStateSummary>
    for SystemStateSummary
{
    fn from(
        value: ika_types::ika_system_state::ika_system_state_summary::IkaSystemStateSummary,
    ) -> Self {
        let ika_types::ika_system_state::ika_system_state_summary::IkaSystemStateSummary {
            epoch,
            protocol_version,
        ...
        OperationBuilder::new()
            ...
            .response(
                ...
                ResponseBuilder::new()
                    ...
                    .header::<String>(X_IKA_MIN_SUPPORTED_PROTOCOL_VERSION, generator)
                    .header::<String>(X_IKA_MAX_SUPPORTED_PROTOCOL_VERSION, generator)
                    .build(),
            )
            .build()
    }
...
pub const X_IKA_MIN_SUPPORTED_PROTOCOL_VERSION: &str = "x-ika-min-supported-protocol-version";
/// Maximum supported protocol version by this node
pub const X_IKA_MAX_SUPPORTED_PROTOCOL_VERSION: &str = "x-ika-max-supported-protocol-version";
...
fn supported_protocol_headers() -> SupportedProtocolHeaders {
    [
        (
            X_IKA_MIN_SUPPORTED_PROTOCOL_VERSION,
            ProtocolVersion::MIN.as_u64().to_string(),
        ),
        (
            X_IKA_MAX_SUPPORTED_PROTOCOL_VERSION,
