...
use ika_types::messages_checkpoint::{CertifiedCheckpointSummary, CheckpointSequenceNumber};
...
impl Client {
    ...
    pub async fn get_checkpoint_summary(
        ...
        self.inner
            ...
            .map(Response::into_inner)
            .and_then(|checkpoint| {
                ika_sdk_types::types::SignedCheckpointSummary {
    ...
    pub async fn execute_transaction(
        ...
        struct SignedTransaction<'a> {
            transaction: &'a ika_types::transaction::TransactionData,
            signatures: &'a [ika_types::signature::GenericSignature],
        }
