...
use ika_types::transaction_executor::TransactionExecutor;
use tap::Pipe;
...
pub use ika_types::full_checkpoint_content::{CheckpointData, CheckpointTransaction};
...
impl<C: std::fmt::Display> axum::response::IntoResponseParts for PageCursor<C> {
    ...
    fn into_response_parts(
        ...
        self.0
            .map(|cursor| [(crate::types::X_IKA_CURSOR, cursor.to_string())])
...
pub struct RestService {
    ...
    chain_id: ika_types::digests::ChainIdentifier,
...
impl RestService {
    ...
    pub fn chain_id(&self) -> ika_types::digests::ChainIdentifier {
        self.chain_id
    }
...
fn info(version: &'static str) -> openapiv3::v3_1::Info {
    ...
    openapiv3::v3_1::Info {
        title: "Ika Node Api".to_owned(),
        description: Some("REST Api for interacting with the Ika Blockchain".to_owned()),
