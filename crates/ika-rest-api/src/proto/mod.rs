...
impl TryFrom<&ika_sdk_types::types::Transaction> for Transaction {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::Transaction) -> Result<Self, Self::Error> {
...
impl TryFrom<&Transaction> for ika_sdk_types::types::Transaction {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::transaction::TransactionData> for Transaction {
    type Error = bcs::Error;

    fn try_from(value: &ika_types::transaction::TransactionData) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            transaction: bytes.into(),
        })
    }
...
impl TryFrom<&Transaction> for ika_types::transaction::TransactionData {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::TransactionEffects> for TransactionEffects {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::TransactionEffects) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            effects: bytes.into(),
        })
    }
...
impl TryFrom<&TransactionEffects> for ika_sdk_types::types::TransactionEffects {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::effects::TransactionEffects> for TransactionEffects {
    type Error = bcs::Error;

    fn try_from(value: &ika_types::effects::TransactionEffects) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            effects: bytes.into(),
        })
    }
...
impl TryFrom<&TransactionEffects> for ika_types::effects::TransactionEffects {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::TransactionEvents> for TransactionEvents {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::TransactionEvents) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            events: bytes.into(),
        })
    }
...
impl TryFrom<&TransactionEvents> for ika_sdk_types::types::TransactionEvents {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::effects::TransactionEvents> for TransactionEvents {
    type Error = bcs::Error;

    fn try_from(value: &ika_types::effects::TransactionEvents) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            events: bytes.into(),
        })
    }
...
impl TryFrom<&TransactionEvents> for ika_types::effects::TransactionEvents {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::Object> for Object {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::Object) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            object: bytes.into(),
        })
    }
...
impl TryFrom<&Object> for ika_sdk_types::types::Object {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::object::Object> for Object {
    type Error = bcs::Error;

    fn try_from(value: &ika_types::object::Object) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            object: bytes.into(),
        })
    }
...
impl TryFrom<&Object> for ika_types::object::Object {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::CheckpointSummary> for CheckpointSummary {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::CheckpointSummary) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            summary: bytes.into(),
        })
    }
...
impl TryFrom<&CheckpointSummary> for ika_sdk_types::types::CheckpointSummary {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::messages_checkpoint::CheckpointSummary> for CheckpointSummary {
    type Error = bcs::Error;

    fn try_from(
        value: &ika_types::messages_checkpoint::CheckpointSummary,
...
impl TryFrom<&CheckpointSummary> for ika_types::messages_checkpoint::CheckpointSummary {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::CheckpointContents> for CheckpointContents {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::CheckpointContents) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            contents: bytes.into(),
        })
    }
...
impl TryFrom<&CheckpointContents> for ika_sdk_types::types::CheckpointContents {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::messages_checkpoint::CheckpointContents> for CheckpointContents {
    type Error = bcs::Error;

    fn try_from(
        value: &ika_types::messages_checkpoint::CheckpointContents,
    ) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            contents: bytes.into(),
        })
...
impl TryFrom<&CheckpointContents> for ika_types::messages_checkpoint::CheckpointContents {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::ValidatorAggregatedSignature> for ValidatorAggregatedSignature {
    type Error = bcs::Error;

    fn try_from(
        value: &ika_sdk_types::types::ValidatorAggregatedSignature,
    ) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
...
impl TryFrom<&ValidatorAggregatedSignature> for ika_sdk_types::types::ValidatorAggregatedSignature {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::crypto::AuthorityStrongQuorumSignInfo> for ValidatorAggregatedSignature {
    type Error = bcs::Error;

    fn try_from(
        value: &ika_types::crypto::AuthorityStrongQuorumSignInfo,
    ) -> Result<Self, Self::Error> {
        bcs::to_bytes(&value).map(|bytes| Self {
            signature: bytes.into(),
        })
...
impl TryFrom<&ValidatorAggregatedSignature> for ika_types::crypto::AuthorityStrongQuorumSignInfo {
    type Error = bcs::Error;
...
impl TryFrom<&ika_sdk_types::types::UserSignature> for UserSignature {
    type Error = bcs::Error;

    fn try_from(value: &ika_sdk_types::types::UserSignature) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl TryFrom<&UserSignature> for ika_sdk_types::types::UserSignature {
    type Error = bcs::Error;
...
impl TryFrom<&ika_types::signature::GenericSignature> for UserSignature {
    type Error = bcs::Error;

    fn try_from(value: &ika_types::signature::GenericSignature) -> Result<Self, Self::Error> {
        Ok(Self {
            signature: ika_types::crypto::ToFromBytes::as_bytes(value)
                .to_vec()
                .into(),
        })
    }
...
impl TryFrom<&UserSignature> for ika_types::signature::GenericSignature {
    type Error = bcs::Error;

    fn try_from(value: &UserSignature) -> Result<Self, Self::Error> {
        ika_types::crypto::ToFromBytes::from_bytes(&value.signature)
...
impl TryFrom<GetObjectResponse> for crate::objects::ObjectResponse {
    ...
    fn try_from(value: GetObjectResponse) -> Result<Self, Self::Error> {
        Ok(Self {
            digest: ika_sdk_types::types::ObjectDigest::from_bytes(&value.digest)
                .map_err(|e| bcs::Error::Custom(e.to_string()))?,
            object: value
                .object
...
impl TryFrom<GetCheckpointResponse> for crate::checkpoints::CheckpointResponse {
    ...
    fn try_from(value: GetCheckpointResponse) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            digest: ika_sdk_types::types::CheckpointDigest::from_bytes(&value.digest)
                .map_err(|e| bcs::Error::Custom(e.to_string()))?,
            summary,
            signature,
            contents,
...
impl TryFrom<GetTransactionResponse> for crate::transactions::TransactionResponse {
    ...
    fn try_from(value: GetTransactionResponse) -> Result<Self, Self::Error> {
        Ok(Self {
            digest: ika_sdk_types::types::TransactionDigest::from_bytes(&value.digest)
                .map_err(|e| bcs::Error::Custom(e.to_string()))?,
            transaction: value
                .transaction
...
impl TryFrom<ika_types::full_checkpoint_content::CheckpointTransaction> for CheckpointTransaction {
    type Error = bcs::Error;

    fn try_from(
        transaction: ika_types::full_checkpoint_content::CheckpointTransaction,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl TryFrom<CheckpointTransaction> for ika_types::full_checkpoint_content::CheckpointTransaction {
    type Error = bcs::Error;
    ...
    fn try_from(transaction: CheckpointTransaction) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            transaction: ika_types::transaction::Transaction::new(
                ika_types::transaction::SenderSignedData::new(transaction_data, user_signatures),
            ),
            effects: transaction
                .effects
                .ok_or_else(|| bcs::Error::Custom("missing Effects".into()))?
...
impl TryFrom<ika_types::full_checkpoint_content::CheckpointData> for FullCheckpoint {
    type Error = bcs::Error;

    fn try_from(
        c: ika_types::full_checkpoint_content::CheckpointData,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl TryFrom<FullCheckpoint> for ika_types::full_checkpoint_content::CheckpointData {
    type Error = bcs::Error;
    ...
    fn try_from(checkpoint: FullCheckpoint) -> Result<Self, Self::Error> {
        ...
        let checkpoint_summary =
            ika_types::messages_checkpoint::CertifiedCheckpointSummary::new_from_data_and_sig(
                summary, signature,
            );
...
impl From<&ika_sdk_types::types::Address> for Address {
    fn from(value: &ika_sdk_types::types::Address) -> Self {
        Self {
...
impl TryFrom<&Address> for ika_sdk_types::types::Address {
    type Error = bcs::Error;
...
impl TryFrom<&Address> for ika_types::base_types::IkaAddress {
    type Error = bcs::Error;
...
impl From<&ika_sdk_types::types::TypeTag> for TypeTag {
    fn from(value: &ika_sdk_types::types::TypeTag) -> Self {
        Self {
...
impl TryFrom<&TypeTag> for ika_sdk_types::types::TypeTag {
    type Error = ika_sdk_types::types::TypeParseError;
...
impl TryFrom<&TypeTag> for ika_types::TypeTag {
    type Error = bcs::Error;

    fn try_from(value: &TypeTag) -> Result<Self, Self::Error> {
        value
            .type_tag
            .parse::<ika_types::TypeTag>()
            .map_err(|e| bcs::Error::Custom(e.to_string()))
    }
}
...
impl From<&ika_sdk_types::types::BalanceChange> for BalanceChange {
    fn from(value: &ika_sdk_types::types::BalanceChange) -> Self {
        Self {
...
impl TryFrom<&BalanceChange> for ika_sdk_types::types::BalanceChange {
    type Error = bcs::Error;
    ...
    fn try_from(value: &BalanceChange) -> Result<Self, Self::Error> {
        ...
        let coin_type = value
            ...
            .pipe(ika_sdk_types::types::TypeTag::try_from)
            .map_err(|e| bcs::Error::Custom(e.to_string()))?;
...
impl TryFrom<&BalanceChange> for crate::client::BalanceChange {
    ...
    fn try_from(value: &BalanceChange) -> Result<Self, Self::Error> {
        ...
        let coin_type = value
            ...
            .as_ref()
            .ok_or_else(|| bcs::Error::Custom("missing coin_type".into()))?
            .pipe(ika_types::TypeTag::try_from)
            .map_err(|e| bcs::Error::Custom(e.to_string()))?;
...
impl TryFrom<&EffectsFinality> for crate::transactions::EffectsFinality {
    ...
    fn try_from(value: &EffectsFinality) -> Result<Self, Self::Error> {
        let signature = value
            .signature
            .as_ref()
            .map(ika_sdk_types::types::ValidatorAggregatedSignature::try_from)
            .transpose()?;
...
impl TryFrom<&EffectsFinality> for crate::client::EffectsFinality {
    ...
    fn try_from(value: &EffectsFinality) -> Result<Self, Self::Error> {
        let signature = value
            .signature
            .as_ref()
            .map(ika_types::crypto::AuthorityStrongQuorumSignInfo::try_from)
            .transpose()?;
...
impl TryFrom<ika_sdk_types::types::SignedTransaction> for ExecuteTransactionRequest {
    type Error = bcs::Error;

    fn try_from(value: ika_sdk_types::types::SignedTransaction) -> Result<Self, Self::Error> {
        Ok(Self {
            transaction: Some(Transaction::try_from(&value.transaction)?),
            signatures: value
                .signatures
...
impl TryFrom<ExecuteTransactionRequest> for ika_sdk_types::types::SignedTransaction {
    type Error = bcs::Error;
...
impl TryFrom<ika_sdk_types::types::Transaction> for SimulateTransactionRequest {
    type Error = bcs::Error;
...
impl TryFrom<SimulateTransactionRequest> for ika_sdk_types::types::Transaction {
    type Error = bcs::Error;
...
impl From<&ika_sdk_types::types::ValidatorCommitteeMember> for ValidatorCommitteeMember {
    fn from(value: &ika_sdk_types::types::ValidatorCommitteeMember) -> Self {
        Self {
...
impl TryFrom<ValidatorCommitteeMember> for ika_sdk_types::types::ValidatorCommitteeMember {
    type Error = bcs::Error;

    fn try_from(value: ValidatorCommitteeMember) -> Result<Self, Self::Error> {
        Ok(Self {
            public_key: ika_sdk_types::types::Bls12381PublicKey::from_bytes(&value.public_key)
                .map_err(|e| bcs::Error::Custom(e.to_string()))?,
            stake: value.stake,
        })
    }
...
impl From<ika_sdk_types::types::ValidatorCommittee> for ValidatorCommittee {
    fn from(value: ika_sdk_types::types::ValidatorCommittee) -> Self {
        Self {
            epoch: value.epoch,
            members: value
                .members
...
impl TryFrom<ValidatorCommittee> for ika_sdk_types::types::ValidatorCommittee {
    type Error = bcs::Error;
