...
/// Ika `TransactionData` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Transaction {
    #[prost(bytes = "bytes", tag = "1")]
    pub transaction: ::prost::bytes::Bytes,
}
/// Ika `TransactionEffects` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionEffects {
    #[prost(bytes = "bytes", tag = "1")]
    pub effects: ::prost::bytes::Bytes,
}
/// Ika `TransactionEvents` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionEvents {
    #[prost(bytes = "bytes", tag = "1")]
    pub events: ::prost::bytes::Bytes,
}
/// Ika `Object` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Object {
    #[prost(bytes = "bytes", tag = "1")]
    pub object: ::prost::bytes::Bytes,
}
/// Ika `CheckpointSummary` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CheckpointSummary {
    #[prost(bytes = "bytes", tag = "1")]
    pub summary: ::prost::bytes::Bytes,
}
/// Ika `CheckpointContents` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CheckpointContents {
    #[prost(bytes = "bytes", tag = "1")]
    pub contents: ::prost::bytes::Bytes,
}
/// Ika `UserSignature` type serialized as bytes
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UserSignature {
    #[prost(bytes = "bytes", tag = "1")]
    pub signature: ::prost::bytes::Bytes,
}
/// Ika `ValidatorAggregatedSignature` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
