...
use ika_types::base_types::STD_ASCII_MODULE_NAME;
use ika_types::base_types::STD_ASCII_STRUCT_NAME;
use ika_types::base_types::STD_OPTION_MODULE_NAME;
use ika_types::base_types::STD_OPTION_STRUCT_NAME;
use ika_types::base_types::STD_UTF8_MODULE_NAME;
use ika_types::base_types::STD_UTF8_STRUCT_NAME;
        ...
        match (command, idx) {
            ...
            (Command::MakeMoveVector(make_move_vector), Some(_)) => {
                if let Some(ty) = &make_move_vector.type_ {
                    let ty =
                        ika_types::ika_sdk_types_conversions::type_tag_sdk_to_core(ty.clone())?;
