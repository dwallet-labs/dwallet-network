...
use ika_sdk_types::types::{Object, ObjectDigest, ObjectId, TypeTag, Version};
use ika_types::ika_sdk_types_conversions::type_tag_core_to_sdk;
use ika_types::{
    storage::{DynamicFieldIndexInfo, DynamicFieldKey},
    ika_sdk_types_conversions::SdkTypeConversionError,
};
use tap::Pipe;
        ...
        OperationBuilder::new()
            ...
            .response(
                ...
                ResponseBuilder::new()
                    ...
                    .header::<String>(crate::types::X_IKA_CURSOR, generator)
                    .build(),
            )
            .build()
    }
...
impl ListDynamicFieldsQueryParameters {
    ...
    pub fn start(&self) -> Option<ika_types::base_types::ObjectID> {
...
impl From<ika_types::dynamic_field::DynamicFieldType> for DynamicFieldType {
    fn from(value: ika_types::dynamic_field::DynamicFieldType) -> Self {
        match value {
            ika_types::dynamic_field::DynamicFieldType::DynamicField => Self::Field,
            ika_types::dynamic_field::DynamicFieldType::DynamicObject => Self::Object,
        }
    }
}
