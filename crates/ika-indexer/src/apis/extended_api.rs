...
use ika_json_rpc_api::{validate_limit, ExtendedApiServer, QUERY_MAX_RESULT_LIMIT_CHECKPOINTS};
use ika_json_rpc_types::{
    CheckpointedObjectID, EpochInfo, EpochPage, Page, QueryObjectsPage, IkaObjectResponseQuery,
};
...
impl IkaRpcModule for ExtendedApi {
    fn rpc(self) -> RpcModule<Self> {
        self.into_rpc()
    }

    fn rpc_doc_module() -> Module {
        ika_json_rpc_api::ExtendedApiOpenRpc::module_doc()
    }
}
