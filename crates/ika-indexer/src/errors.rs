...
use ika_json_rpc::name_service::NameServiceError;
use thiserror::Error;

use ika_types::base_types::ObjectIDParseError;
...
pub enum IndexerError {
    ...
    JsonRpcServerError(#[from] ika_json_rpc::error::Error),
    ...
    #[error(transparent)]
    ObjectResponseError(#[from] IkaObjectResponseError),
