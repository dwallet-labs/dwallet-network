...
use ika_json_rpc::get_balance_changes_from_effect;
use ika_json_rpc::get_object_changes;
use ika_json_rpc::ObjectProvider;
...
impl TxChangesProcessor {
    ...
    pub(crate) async fn get_changes(
        ...
        Vec<ika_json_rpc_types::BalanceChange>,
...
// This is a struct that is used to extract IkaSystemState and its dynamic children
...
impl<'a> ika_types::storage::ObjectStore for EpochEndIndexingObjectStore<'a> {
    fn get_object(
        &self,
        object_id: &ObjectID,
