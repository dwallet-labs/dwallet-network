...
#[derive(Clone)]
pub struct IkaTransactionBlockResponseBuilder<'a> {
    response: IkaTransactionBlockResponse,
    full_response: &'a IkaTransactionBlockResponse,
}

impl<'a> IkaTransactionBlockResponseBuilder<'a> {
    pub fn new(full_response: &'a IkaTransactionBlockResponse) -> Self {
        Self {
            response: IkaTransactionBlockResponse::default(),
            full_response,
        }
    }

    pub fn with_input(mut self) -> Self {
        self.response = IkaTransactionBlockResponse {
    ...
    pub fn build(self) -> IkaTransactionBlockResponse {
...
pub async fn set_up_on_mvr_mode(
    ...
    let server_handle = tokio::spawn(async move {
        ika_rest_api::RestService::new_without_version(sim)
