...
use pera_types::event::{Event, EventEnvelope, EventID};
...
pub type EventPage = Page<PeraEvent, EventID>;

#[serde_as]
#[derive(Eq, PartialEq, Clone, Debug, Serialize, Deserialize, JsonSchema)]
#[serde(rename = "Event", rename_all = "camelCase")]
pub struct PeraEvent {
...
impl From<EventEnvelope> for PeraEvent {
...
impl From<PeraEvent> for Event {
    fn from(val: PeraEvent) -> Self {
        Event {
...
impl EventFilter {
    fn try_matches(&self, item: &PeraEvent) -> PeraResult<bool> {
        Ok(match self {
...
impl Filter<PeraEvent> for EventFilter {
    fn matches(&self, item: &PeraEvent) -> bool {
