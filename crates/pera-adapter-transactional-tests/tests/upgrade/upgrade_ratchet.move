...
//# run pera::package::only_additive_upgrades --args object(1,1) --sender A
...
//# run pera::package::only_dep_upgrades --args object(1,1) --sender A
...
//# run pera::package::make_immutable --args object(1,1) --sender A
