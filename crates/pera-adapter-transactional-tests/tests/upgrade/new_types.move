...
module Test_DepV1::DepM1 {
    ...
    public struct DepObj has key, store { id: pera::object::UID, v: u64 }

    public fun foo(ctx: &mut pera::tx_context::TxContext) {
        pera::transfer::share_object(DepObj { id: pera::object::new(ctx), v: 42 });
    }
...
module Test_DepV2::DepM1 {
    ...
    public fun foo(ctx: &mut pera::tx_context::TxContext) {
        pera::transfer::share_object(DepObj { id: pera::object::new(ctx), v: 7 });
    }
...
module Test_V1::M1 {
    ...
    public entry fun bar(ctx: &mut pera::tx_context::TxContext) {
        DepM1::foo(ctx);
    }
