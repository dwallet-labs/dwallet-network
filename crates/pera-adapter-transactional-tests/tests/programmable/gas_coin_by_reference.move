...
//> test::m1::t1<pera::coin::Coin<pera::pera::PERA>>(Gas)

//# programmable --sender A
//> test::m1::t2<pera::coin::Coin<pera::pera::PERA>>(Gas)

//# programmable --sender A
//> test::m1::t2<pera::coin::Coin<pera::pera::PERA>>(Gas)

//# programmable --sender A
//> test::m1::t4<pera::coin::Coin<pera::pera::PERA>>(Gas)

//# programmable --sender A
//> test::m1::t5<pera::coin::Coin<pera::pera::PERA>>(Gas)

//# programmable --sender A
//> test::m1::t6<pera::coin::Coin<pera::pera::PERA>>(Gas)
