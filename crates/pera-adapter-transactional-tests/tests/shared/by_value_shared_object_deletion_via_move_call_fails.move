...
module t2::o2 {
    ...
    public fun share_coin(o2: Coin<PERA>) {
...
//> 0: t2::o2::id<pera::coin::Coin<pera::pera::PERA>>(Input(1));
//> 1: SplitCoins(Result(0), [Input(0)]);
//> 2: TransferObjects([Result(1)], Input(2));
//> 3: pera::transfer::public_share_object<pera::coin::Coin<pera::pera::PERA>>(Input(1));
