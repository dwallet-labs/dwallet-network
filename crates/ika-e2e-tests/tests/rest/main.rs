...
async fn transfer_coin(
    context: &ika_sdk::wallet_context::WalletContext,
) -> ika_sdk_types::types::TransactionDigest {
    ...
    let txn = context.sign_transaction(
        &ika_test_transaction_builder::TestTransactionBuilder::new(sender, gas_object, gas_price)
