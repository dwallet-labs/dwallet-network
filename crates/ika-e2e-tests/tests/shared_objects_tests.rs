...
use ika_macros::{register_fail_point_async, sim_test};
...
use ika_types::execution_status::{CommandArgumentError, ExecutionFailureStatus, ExecutionStatus};
use ika_types::messages_grpc::{LayoutGenerationOption, ObjectInfoRequest};
use ika_types::transaction::{CallArg, ObjectArg};
use test_cluster::TestClusterBuilder;
use tokio::time::sleep;

/// Send a simple shared object transaction to Ika and ensures the client gets back a response.
#[sim_test]
...
/// End-to-end shared transaction test for a Ika validator. It does not test the client or wallet,
/// but tests the end-to-end flow from Ika to consensus.
#[sim_test]
