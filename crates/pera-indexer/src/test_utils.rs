...
#[derive(Clone)]
pub struct PeraTransactionBlockResponseBuilder<'a> {
    response: PeraTransactionBlockResponse,
    full_response: &'a PeraTransactionBlockResponse,
}

impl<'a> PeraTransactionBlockResponseBuilder<'a> {
    pub fn new(full_response: &'a PeraTransactionBlockResponse) -> Self {
        Self {
            response: PeraTransactionBlockResponse::default(),
            full_response,
        }
    }

    pub fn with_input(mut self) -> Self {
        self.response = PeraTransactionBlockResponse {
    ...
    pub fn build(self) -> PeraTransactionBlockResponse {
