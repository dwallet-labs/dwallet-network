...
use pera_json_rpc::name_service::NameServiceError;
use thiserror::Error;

use pera_types::base_types::ObjectIDParseError;
...
pub enum IndexerError {
    ...
    JsonRpcServerError(#[from] pera_json_rpc::error::Error),
    ...
    #[error(transparent)]
    ObjectResponseError(#[from] PeraObjectResponseError),
