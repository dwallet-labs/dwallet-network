...
use pera_json_rpc::coin_api::{parse_to_struct_tag, parse_to_type_tag};
use pera_json_rpc::PeraRpcModule;
use pera_json_rpc_api::{cap_page_limit, CoinReadApiServer};
use pera_json_rpc_types::{Balance, CoinPage, Page, PeraCoinMetadata};
...
impl<T: R2D2Connection> PeraRpcModule for CoinReadApi<T> {
    fn rpc(self) -> RpcModule<Self> {
        self.into_rpc()
    }

    fn rpc_doc_module() -> Module {
        pera_json_rpc_api::CoinReadApiOpenRpc::module_doc()
    }
}
