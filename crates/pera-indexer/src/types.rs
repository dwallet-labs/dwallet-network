...
use pera_types::event::SystemEpochInfoEvent;
...
impl IndexedCheckpoint {
    pub fn from_pera_checkpoint(
        checkpoint: &pera_types::messages_checkpoint::CertifiedCheckpointSummary,
        contents: &pera_types::messages_checkpoint::CheckpointContents,
...
impl IndexedEpochInfo {
    pub fn from_new_system_state_summary(
        new_system_state_summary: PeraSystemStateSummary,
    ...
    pub fn from_end_of_epoch_data(
        system_state_summary: &PeraSystemStateSummary,
...
pub fn owner_to_owner_info(owner: &Owner) -> (OwnerType, Option<PeraAddress>) {
    match owner {
...
pub struct IndexedTransaction {
    ...
    pub balance_change: Vec<pera_json_rpc_types::BalanceChange>,
    pub events: Vec<pera_types::event::Event>,
...
pub struct TxIndex {
    ...
    pub payers: Vec<PeraAddress>,
    pub sender: PeraAddress,
    pub recipients: Vec<PeraAddress>,
...
// PeraTransactionBlockResponseWithOptions is only used on the reading path
pub struct PeraTransactionBlockResponseWithOptions {
    pub response: PeraTransactionBlockResponse,
    pub options: PeraTransactionBlockResponseOptions,
}

impl From<PeraTransactionBlockResponseWithOptions> for PeraTransactionBlockResponse {
    fn from(value: PeraTransactionBlockResponseWithOptions) -> Self {
        let PeraTransactionBlockResponseWithOptions { response, options } = value;
