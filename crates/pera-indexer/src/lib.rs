...
use pera_json_rpc::ServerType;
use pera_json_rpc::{JsonRpcServerBuilder, ServerHandle};
use pera_json_rpc_api::CLIENT_SDK_TYPE_HEADER;
...
#[clap(
    name = "Pera indexer",
    about = "An off-fullnode service serving data from Pera protocol",
...
pub struct IndexerConfig {
    ...
    #[clap(long, default_value = Some("https://checkpoints.mainnet.pera.io"), global = true)]
    ...
    fn default() -> Self {
        Self {
            db_url: Some(secrecy::Secret::new(
                "postgres://postgres:postgres@localhost:5432/pera_indexer".to_string(),
            )),
            db_user_name: None,
            db_password: None,
            db_host: None,
            ...
            remote_store_url: Some("https://checkpoints.mainnet.pera.io".to_string()),
