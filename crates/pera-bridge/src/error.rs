...
pub enum BridgeError {
    ...
    // Found a bridge event but not in a recognized Pera bridge package
    BridgeEventInUnrecognizedPeraPackage,
    ...
    // Pera transaction failure due to generic error
    PeraTxFailureGeneric(String),
