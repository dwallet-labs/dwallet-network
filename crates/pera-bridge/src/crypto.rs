...
mod tests {
    ...
    use crate::test_utils::{get_test_authority_and_key, get_test_pera_to_eth_bridge_action};
    ...
    fn test_sign_and_verify_bridge_event_basic() -> anyhow::Result<()> {
        ...
        let mismatched_action: BridgeAction =
            get_test_pera_to_eth_bridge_action(None, Some(2), Some(3), Some(4), None, None, None);
        ...
        let action2: BridgeAction =
            get_test_pera_to_eth_bridge_action(None, Some(3), Some(5), Some(77), None, None, None);
    ...
    fn test_bridge_sig_verification_regression_test() {
        ...
        let action = BridgeAction::PeraToEthBridgeAction(PeraToEthBridgeAction {
            pera_tx_digest: TransactionDigest::random(),
            pera_tx_event_index: 0,
            pera_bridge_event: EmittedPeraToEthTokenBridgeV1 {
                nonce: 1,
                pera_chain_id: BridgeChainId::PeraTestnet,
                pera_address: PeraAddress::from_str(
                ...
                amount_pera_adjusted: 100000u64,
            },
        });
