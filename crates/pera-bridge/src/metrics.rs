...
pub struct BridgeMetrics {
    pub(crate) err_build_pera_transaction: IntCounter,
    pub(crate) err_signature_aggregation: IntCounter,
    pub(crate) err_pera_transaction_submission: IntCounter,
    pub(crate) err_pera_transaction_submission_too_many_failures: IntCounter,
    pub(crate) err_pera_transaction_execution: IntCounter,
    ...
    pub last_synced_pera_checkpoint: IntGauge,
    pub(crate) last_finalized_eth_block: IntGauge,
    pub(crate) last_synced_eth_block: IntGauge,

    pub(crate) pera_watcher_received_events: IntCounter,
    pub(crate) pera_watcher_received_actions: IntCounter,
    pub(crate) pera_watcher_unrecognized_events: IntCounter,
...
impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            err_build_pera_transaction: register_int_counter_with_registry!(
                "bridge_err_build_pera_transaction",
                "Total number of errors of building pera transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            err_pera_transaction_submission: register_int_counter_with_registry!(
                "bridge_err_pera_transaction_submission",
                "Total number of errors of submitting pera transactions",
                registry,
            )
            .unwrap(),
            err_pera_transaction_submission_too_many_failures: register_int_counter_with_registry!(
                "bridge_err_pera_transaction_submission_too_many_failures",
                "Total number of continuous failures to submitting pera transactions",
                registry,
            )
            .unwrap(),
            err_pera_transaction_execution: register_int_counter_with_registry!(
                "bridge_err_pera_transaction_execution",
                "Total number of failures of pera transaction execution",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            pera_watcher_received_events: register_int_counter_with_registry!(
                "bridge_pera_watcher_received_events",
                "Total number of received events in pera watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            pera_watcher_received_actions: register_int_counter_with_registry!(
                "bridge_pera_watcher_received_actions",
                "Total number of received actions in pera watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            pera_watcher_unrecognized_events: register_int_counter_with_registry!(
                "bridge_pera_watcher_unrecognized_events",
                "Total number of unrecognized events in pera watcher",
                registry,
            )
            .unwrap(),
            ...
            gas_coin_balance: register_int_gauge_with_registry!(
                ...
                "Current balance of gas coin, in npera",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_synced_pera_checkpoint: register_int_gauge_with_registry!(
                "last_synced_pera_checkpoint",
                "The latest pera checkpoint that indexer synced",
                registry,
            )
            .unwrap(),
