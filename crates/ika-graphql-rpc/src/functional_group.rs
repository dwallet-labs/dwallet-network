...
impl FunctionalGroup {
    ...
    /// Not a ikatable `Display` implementation because it enquotes the representation.
...
fn functional_groups() -> &'static BTreeMap<(&'static str, &'static str), FunctionalGroup> {
    ...
    static GROUPS: Lazy<BTreeMap<(&str, &str), FunctionalGroup>> = Lazy::new(|| {
        BTreeMap::from_iter([
            ...
            (("Address", "defaultIkansName"), G::NameService),
            (("Address", "ikansRegistrations"), G::NameService),
            ...
            (("Query", "resolveIkansAddress"), G::NameService),
