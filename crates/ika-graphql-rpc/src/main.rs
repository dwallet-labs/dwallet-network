...
use clap::Parser;
use ika_graphql_rpc::commands::Command;
use ika_graphql_rpc::config::{ServerConfig, ServiceConfig, Version};
use ika_graphql_rpc::server::graphiql_server::start_graphiql_server;
...
// VERSION mimics what other ika binaries use for the same const
