...
use async_graphql::*;
use ika_types::base_types::ObjectRef as NativeObjectRef;

use super::{object::Object, ika_address::IkaAddress, uint53::UInt53};
...
impl ObjectRead {
    ...
    async fn address(&self) -> IkaAddress {
        self.address_impl()
    }
...
impl ObjectRead {
    fn address_impl(&self) -> IkaAddress {
        IkaAddress::from(self.native.0)
    }
