...
use async_graphql::*;
use ika_json_rpc_types::{DevInspectResults, IkaExecutionResult};
use ika_types::effects::TransactionEffects as NativeTransactionEffects;
use ika_types::transaction::TransactionData as NativeTransactionData;
...
impl TryFrom<IkaExecutionResult> for DryRunEffect {
    type Error = crate::error::Error;

    fn try_from(result: IkaExecutionResult) -> Result<Self, Self::Error> {
