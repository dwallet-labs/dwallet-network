...
use ika_types::digests::ChainIdentifier as IkaChainIdentifier;
use ika_types::{
...
impl ChangeEpochTransaction {
    ...
    async fn system_packages(
        ...
        for c in cs {
            ...
            let object = Object::from_native(IkaAddress::from(runtime_id), native, c.c, None);
