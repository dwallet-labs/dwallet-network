...
use ika_types::authenticator_state::{ActiveJwk, AuthenticatorStateInner};
...
pub(crate) async fn verify_zklogin_signature(
    ...
    let df = DynamicField::query(
        ctx,
        IKA_AUTHENTICATOR_STATE_ADDRESS.into(),
        None,
        DynamicFieldName {
