...
use super::ikans_registration::{DomainFormat, NameService, IkansRegistration};
use crate::data::Db;
...
use crate::types::ika_address::IkaAddress;
...
#[graphql(
    name = "IOwner",
    field(name = "address", ty = "IkaAddress"),
    field(
        name = "objects",
    ...
    field(
        ...
        desc = "Total balance of all coins with marker type owned by this object or address. If \
                type is not supplied, it defaults to `0x2::ika::IKA`."
    ),
    field(
        name = "balances",
        arg(name = "first", ty = "Option<u64>"),
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, StakedIka>",
        desc = "The `0x3::staking_pool::StakedIka` objects owned by this object or address."
    ),
    field(
        name = "default_ikans_name",
    ...
    field(
        name = "ikans_registrations",
        arg(name = "first", ty = "Option<u64>"),
        arg(name = "after", ty = "Option<object::Cursor>"),
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, IkansRegistration>",
        desc = "The IkansRegistration NFTs owned by this object or address. These grant the owner \
