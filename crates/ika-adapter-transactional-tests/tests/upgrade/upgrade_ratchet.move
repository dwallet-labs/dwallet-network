...
//# run ika::package::only_additive_upgrades --args object(1,1) --sender A
...
//# run ika::package::only_dep_upgrades --args object(1,1) --sender A
...
//# run ika::package::make_immutable --args object(1,1) --sender A
