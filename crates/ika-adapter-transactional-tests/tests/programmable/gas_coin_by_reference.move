...
//> test::m1::t1<ika::coin::Coin<ika::ika::IKA>>(Gas)

//# programmable --sender A
//> test::m1::t2<ika::coin::Coin<ika::ika::IKA>>(Gas)

//# programmable --sender A
//> test::m1::t2<ika::coin::Coin<ika::ika::IKA>>(Gas)

//# programmable --sender A
//> test::m1::t4<ika::coin::Coin<ika::ika::IKA>>(Gas)

//# programmable --sender A
//> test::m1::t5<ika::coin::Coin<ika::ika::IKA>>(Gas)

//# programmable --sender A
//> test::m1::t6<ika::coin::Coin<ika::ika::IKA>>(Gas)
