...
pub trait FaucetClient {
    async fn request_ika_coins(&self, request_address: IkaAddress) -> FaucetResponse;
    async fn batch_request_ika_coins(&self, request_address: IkaAddress) -> BatchFaucetResponse;
...
impl FaucetClient for RemoteFaucetClient {
    /// Request test IKA coins from faucet.
