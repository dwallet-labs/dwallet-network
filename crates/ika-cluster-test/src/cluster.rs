...
use ika_config::{PersistedConfig, IKA_KEYSTORE_FILENAME, IKA_NETWORK_CONFIG};
use ika_graphql_rpc::config::{ConnectionConfig, ServiceConfig};
use ika_graphql_rpc::test_infra::cluster::start_graphql_server_with_fn_rpc;
...
use ika_types::crypto::{get_key_pair, AccountKeyPair};
use tempfile::tempdir;
use test_cluster::{TestCluster, TestClusterBuilder};
use tracing::info;

const DEVNET_FAUCET_ADDR: &str = "https://faucet.devnet.ika.io:443";
const STAGING_FAUCET_ADDR: &str = "https://faucet.staging.ika.io:443";
const CONTINUOUS_FAUCET_ADDR: &str = "https://faucet.ci.ika.io:443";
const CONTINUOUS_NOMAD_FAUCET_ADDR: &str = "https://faucet.nomad.ci.ika.io:443";
const TESTNET_FAUCET_ADDR: &str = "https://faucet.testnet.ika.io:443";
const DEVNET_FULLNODE_ADDR: &str = "https://rpc.devnet.ika.io:443";
const STAGING_FULLNODE_ADDR: &str = "https://fullnode.staging.ika.io:443";
const CONTINUOUS_FULLNODE_ADDR: &str = "https://fullnode.ci.ika.io:443";
const CONTINUOUS_NOMAD_FULLNODE_ADDR: &str = "https://fullnode.nomad.ci.ika.io:443";
const TESTNET_FULLNODE_ADDR: &str = "https://fullnode.testnet.ika.io:443";
...
impl Cluster for LocalNewCluster {
    async fn start(options: &ClusterTestOpt) -> Result<Self, anyhow::Error> {
        ...
        if let Some(config_dir) = options.config_dir.clone() {
            ...
            let network_config_path = config_dir.join(IKA_NETWORK_CONFIG);
        ...
        let faucet_address = IkaAddress::from(faucet_key.public());
...
pub fn new_wallet_context_from_cluster(
    ...
    let address: IkaAddress = key_pair.public().into();
    keystore
        .add_key(None, IkaKeyPair::Ed25519(key_pair))
        .unwrap();
    IkaClientConfig {
        keystore,
        envs: vec![IkaEnv {
