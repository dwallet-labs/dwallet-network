...
pub const PERA_VALIDATOR_SERVER_NAME: &str = "pera";
...
mod tests {
    ...
    fn verify_allowall() {
        ...
        let verifier = ClientCertVerifier::new(AllowAll, PERA_VALIDATOR_SERVER_NAME.to_string());
    ...
    fn verify_server_cert() {
        ...
        let verifier =
            ServerCertVerifier::new(allowed_public_key, PERA_VALIDATOR_SERVER_NAME.to_string());
    ...
    fn verify_hashset() {
        ...
        let verifier =
            ClientCertVerifier::new(allowlist.clone(), PERA_VALIDATOR_SERVER_NAME.to_string());
    ...
    fn invalid_server_name() {
        ...
        let cert = SelfSignedCertificate::new(keypair.private(), "not-pera");
        ...
        // Allowed public key but the server-name in the cert is not the required "pera"
        ...
        let server_verifier =
            ServerCertVerifier::new(public_key, PERA_VALIDATOR_SERVER_NAME.to_string());
    ...
    async fn axum_acceptor() {
        ...
        let client_certificate =
            SelfSignedCertificate::new(client_keypair.private(), PERA_VALIDATOR_SERVER_NAME);
