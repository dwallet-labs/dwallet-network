...
use ika_json_rpc_types::ProtocolConfigResponse;
use ika_json_rpc_types::{
    Checkpoint, CheckpointId, CheckpointPage, IkaEvent, IkaGetPastObjectRequest,
    IkaObjectDataOptions, IkaObjectResponse, IkaPastObjectResponse, IkaTransactionBlockResponse,
...
#[open_rpc(namespace = "ika", tag = "Read API")]
