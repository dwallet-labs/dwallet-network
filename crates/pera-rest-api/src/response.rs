...
use crate::{
    ...
    types::{
        X_PERA_CHAIN, X_PERA_CHAIN_ID, X_PERA_CHECKPOINT_HEIGHT, X_PERA_EPOCH,
        X_PERA_LOWEST_AVAILABLE_CHECKPOINT, X_PERA_LOWEST_AVAILABLE_CHECKPOINT_OBJECTS,
        X_PERA_TIMESTAMP_MS,
    },
...
pub async fn append_info_headers(
    ...
    headers.insert(
        X_PERA_LOWEST_AVAILABLE_CHECKPOINT,
        lowest_available_checkpoint.to_string().try_into().unwrap(),
    );

    headers.insert(
        X_PERA_LOWEST_AVAILABLE_CHECKPOINT_OBJECTS,
