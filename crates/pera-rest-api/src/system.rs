...
pub struct SystemStateSummary {
    ...
    #[serde_as(as = "pera_types::pera_serde::BigInt<u64>")]
    ...
    #[serde_as(as = "Vec<pera_types::pera_serde::BigInt<u64>>")]
    ...
    #[serde_as(as = "Vec<(_, pera_types::pera_serde::BigInt<u64>)>")]
...
pub struct ValidatorSummary {
    ...
    pub next_epoch_protocol_public_key: Option<pera_sdk2::types::Bls12381PublicKey>,
    pub next_epoch_network_public_key: Option<pera_sdk2::types::Ed25519PublicKey>,
    pub next_epoch_worker_public_key: Option<pera_sdk2::types::Ed25519PublicKey>,
    ...
    #[serde_as(as = "Option<pera_types::pera_serde::BigInt<u64>>")]
...
impl From<pera_types::pera_system_state::pera_system_state_summary::PeraValidatorSummary>
    for ValidatorSummary
{
    fn from(
        value: pera_types::pera_system_state::pera_system_state_summary::PeraValidatorSummary,
    ) -> Self {
        let pera_types::pera_system_state::pera_system_state_summary::PeraValidatorSummary {
            pera_address,
            ...
            staking_pool_pera_balance,
            rewards_pool,
            pool_token_balance,
            pending_stake,
            pending_total_pera_withdraw,
        ...
        Self {
            address: pera_address.into(),
            protocol_public_key: pera_sdk2::types::Bls12381PublicKey::from_bytes(
                protocol_pubkey_bytes,
            )
            .unwrap(),
            ...
            next_epoch_protocol_public_key: next_epoch_protocol_pubkey_bytes
                .map(|bytes| pera_sdk2::types::Bls12381PublicKey::from_bytes(bytes).unwrap()),
            next_epoch_network_public_key: next_epoch_network_pubkey_bytes
                .map(|bytes| pera_sdk2::types::Ed25519PublicKey::from_bytes(bytes).unwrap()),
...
impl From<pera_types::pera_system_state::pera_system_state_summary::PeraSystemStateSummary>
    for SystemStateSummary
{
    fn from(
        value: pera_types::pera_system_state::pera_system_state_summary::PeraSystemStateSummary,
    ) -> Self {
        let pera_types::pera_system_state::pera_system_state_summary::PeraSystemStateSummary {
            epoch,
            protocol_version,
        ...
        OperationBuilder::new()
            ...
            .response(
                ...
                ResponseBuilder::new()
                    ...
                    .header::<String>(X_PERA_MIN_SUPPORTED_PROTOCOL_VERSION, generator)
                    .header::<String>(X_PERA_MAX_SUPPORTED_PROTOCOL_VERSION, generator)
                    .build(),
            )
            .build()
    }
...
pub const X_PERA_MIN_SUPPORTED_PROTOCOL_VERSION: &str = "x-pera-min-supported-protocol-version";
/// Maximum supported protocol version by this node
pub const X_PERA_MAX_SUPPORTED_PROTOCOL_VERSION: &str = "x-pera-max-supported-protocol-version";
...
fn supported_protocol_headers() -> SupportedProtocolHeaders {
    [
        (
            X_PERA_MIN_SUPPORTED_PROTOCOL_VERSION,
            ProtocolVersion::MIN.as_u64().to_string(),
        ),
        (
            X_PERA_MAX_SUPPORTED_PROTOCOL_VERSION,
