...
impl From<pera_types::storage::error::Error> for RestError {
    fn from(value: pera_types::storage::error::Error) -> Self {
        Self {
...
impl From<pera_types::quorum_driver_types::QuorumDriverError> for RestError {
    fn from(error: pera_types::quorum_driver_types::QuorumDriverError) -> Self {
