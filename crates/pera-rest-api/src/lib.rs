...
pub use pera_types::full_checkpoint_content::{CheckpointData, CheckpointTransaction};
...
impl<T: serde::Serialize, C: std::fmt::Display> axum::response::IntoResponse for Page<T, C> {
    fn into_response(self) -> axum::response::Response {
        let cursor = self
            .cursor
            .map(|cursor| [(crate::types::X_PERA_CURSOR, cursor.to_string())]);
...
pub struct RestService {
    ...
    chain_id: pera_types::digests::ChainIdentifier,
...
impl RestService {
    ...
    pub fn chain_id(&self) -> pera_types::digests::ChainIdentifier {
        self.chain_id
    }
...
fn info() -> openapiv3::v3_1::Info {
    ...
    openapiv3::v3_1::Info {
        title: "Pera Node Api".to_owned(),
        description: Some("REST Api for interacting with the Pera Blockchain".to_owned()),
        ...
        license: Some(License {
            name: "BSD 3-Clause Clear License".to_owned(),
            identifier: Some("BSD-3-Clause-Clear".to_owned()),
            ..Default::default()
        }),
