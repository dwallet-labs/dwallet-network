        ...
        OperationBuilder::new()
            ...
            .response(
                ...
                ResponseBuilder::new()
                    ...
                    .header::<String>(crate::types::X_PERA_CURSOR, generator)
                    .build(),
            )
            .build()
    }
...
impl ListDynamicFieldsQueryParameters {
    ...
    pub fn start(&self) -> Option<pera_types::base_types::ObjectID> {
...
impl From<pera_types::dynamic_field::DynamicFieldType> for DynamicFieldType {
    fn from(value: pera_types::dynamic_field::DynamicFieldType) -> Self {
        match value {
            pera_types::dynamic_field::DynamicFieldType::DynamicField => Self::Field,
            pera_types::dynamic_field::DynamicFieldType::DynamicObject => Self::Object,
        }
    }
}
