...
use ika_sdk::rpc_types::StakeStatus;
...
use ika_sdk::error::IkaRpcResult;
...
async fn get_checkpoint(ctx: &OnlineServerContext) -> IkaRpcResult<CheckpointSequenceNumber> {
    ctx.client
        .read_api()
