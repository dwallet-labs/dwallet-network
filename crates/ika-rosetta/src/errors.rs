...
use crate::types::{BlockHash, OperationType, PublicKey, IkaEnv};
...
/// Ika-Rosetta specific error types.
/// This contains all the errors returns by the ika-rosetta server.
...
pub enum Error {
    ...
    #[error(transparent)]
    IkaRpcError(#[from] ika_sdk::error::Error),
    #[error(transparent)]
