...
pub struct IkaCheckpointDatasource {
...
#[async_trait]
impl Datasource<CheckpointTxnData> for IkaCheckpointDatasource {
    async fn start_data_retrieval(
        ...
        tracing::info!(
            "Starting Ika checkpoint data retrieval with batch size {}",
...
impl Worker for IndexerWorker<CheckpointTxnData> {
    ...
    async fn process_checkpoint(&self, checkpoint: &IkaCheckpointData) -> anyhow::Result<()> {
        tracing::trace!(
            "Received checkpoint [{}] {}: {}",
