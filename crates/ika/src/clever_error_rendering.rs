...
use ika_types::{base_types::ObjectID, Identifier};
...
///
/// This function is used to render Clever Errors for on-chain errors only within the Ika CLI. This
...
pub(crate) async fn render_clever_error_opt(
    ...
    let error = 'error: {
        ...
        let IkaRawData::Package(package) = read_api
