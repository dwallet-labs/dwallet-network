...
use ika_types::base_types::{random_object_ref, ObjectRef};
use ika_types::effects::TransactionEffectsAPI;
use ika_types::transaction::Command;
use ika_types::transaction::{CallArg, ObjectArg};
use ika_types::{base_types::ObjectID, object::Owner};
use ika_types::{base_types::IkaAddress, crypto::get_key_pair, transaction::Transaction};
use ika_types::{transaction::TransactionData, utils::to_sender_signed_transaction};
use tracing::debug;
...
impl Payload for AdversarialTestPayload {
    fn make_new_payload(&mut self, effects: &ExecutionEffects) {
        ...
        let stat = match effects {
            ...
            ExecutionEffects::IkaTransactionBlockEffects(_) => unimplemented!("Not impl"),
        };
