...
pub const MAX_GAS_FOR_TESTING: u64 = 1_000 * NIKA_PER_IKA;

// TODO: get this information from protocol config
// This is the maximum budget that can be set for a transaction. 50 IKA.
pub const MAX_BUDGET: u64 = 50 * NIKA_PER_IKA;
