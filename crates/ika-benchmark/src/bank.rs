...
use std::sync::Arc;
use ika_core::test_utils::{make_pay_ika_transaction, make_transfer_ika_transaction};
...
impl BenchmarkBank {
    ...
    async fn pay_ika(
        ...
        let tx = make_pay_ika_transaction(
            init_coin.0,
            vec![],
            recipient_addresses,
            amounts,
        ...
        let address_map: HashMap<IkaAddress, Arc<AccountKeyPair>> = coin_configs
            .iter()
