...
use ika_json_rpc::transaction_builder_api::TransactionBuilderApi as IkaTransactionBuilderApi;
use ika_json_rpc_types::{IkaObjectDataFilter, IkaObjectDataOptions, IkaObjectResponse};
use ika_transaction_builder::DataReader;
...
impl TransactionBuilderApi {
    ...
    pub fn new(inner: IndexerReader) -> IkaTransactionBuilderApi {
        IkaTransactionBuilderApi::new_with_data_reader(std::sync::Arc::new(Self { inner }))
    }
}
