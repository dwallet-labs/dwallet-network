...
use ika_json_rpc::coin_api::{parse_to_struct_tag, parse_to_type_tag};
use ika_json_rpc::IkaRpcModule;
use ika_json_rpc_api::{cap_page_limit, CoinReadApiServer};
use ika_json_rpc_types::{Balance, CoinPage, Page, IkaCoinMetadata};
...
impl IkaRpcModule for CoinReadApi {
    ...
    fn rpc_doc_module() -> Module {
        ika_json_rpc_api::CoinReadApiOpenRpc::module_doc()
    }
}
