...
//# run 0x3::ika_system::request_add_stake --args object(0x5) object(3,0) @validator_0 --sender C
...
//# run-graphql
{
  objects(filter: {type: "0x3::staking_pool::StakedIka"}) {
    edges {
      node {
        asMoveObject {
          contents {
...
//# run-graphql
# Fetch coins of 0x2::ika::IKA inner type
{
  objects(filter: {type: "0x2::coin::Coin<0x2::ika::IKA>"}) {
    edges {
      node {
        asMoveObject {
          contents {
