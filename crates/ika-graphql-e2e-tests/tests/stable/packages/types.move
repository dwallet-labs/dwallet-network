...
{
    type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::ika::IKA>>") {
        repr
        signature
        layout
    }
...
{
    token: type(type: "0x2::token::Token<0x2::ika::IKA>") {
        abilities
    }

    coin: type(type: "0x2::coin::Coin<0x2::ika::IKA>") {
        abilities
    }

    balance: type(type: "0x2::balance::Balance<0x2::ika::IKA>") {
        abilities
    }

    coin_vector: type(type: "vector<0x2::coin::Coin<0x2::ika::IKA>>") {
        abilities
    }
