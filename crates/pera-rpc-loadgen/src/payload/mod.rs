...
impl Command {
    ...
    pub fn new_pay_pera() -> Self {
        Self {
            data: CommandData::PayPera(PayPera {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<PeraAddress>, chunk_size: usize) -> Self {
