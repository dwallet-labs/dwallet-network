...
use clap::Parser;
use ika_indexer_alt::args::Command;
use ika_indexer_alt::bootstrap::bootstrap;
use ika_indexer_alt::db::reset_database;
use ika_indexer_alt::handlers::kv_epoch_ends::KvEpochEnds;
use ika_indexer_alt::handlers::kv_epoch_starts::KvEpochStarts;
use ika_indexer_alt::handlers::kv_feature_flags::KvFeatureFlags;
use ika_indexer_alt::handlers::kv_protocol_configs::KvProtocolConfigs;
use ika_indexer_alt::pipeline::concurrent::PrunerConfig;
use ika_indexer_alt::{
    args::Args,
    handlers::{
