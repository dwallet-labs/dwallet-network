...
use ika_json_rpc_types::IkaRawMoveObject;
use ika_package_management::PublishedAtError;
use ika_sdk::error::Error as SdkError;
use ika_types::{base_types::ObjectID, error::IkaObjectResponseError};
...
pub enum Error {
    ...
    #[error("Dependency ID contains a Ika object, not a Move package: {0}")]
    ObjectFoundWhenPackageExpected(ObjectID, IkaRawMoveObject),
    ...
    IkaObjectRefFailure(IkaObjectResponseError),
