...
module examples::object_basics {
    ...
    use pera::authenticator_state::AuthenticatorState;
    use pera::random::Random;
    use pera::dynamic_object_field as ofield;
    use pera::event;
    use pera::object::{Self, UID, ID};
    ...
    public entry fun add_field(o: &mut Object, v: Object) {
        pera::dynamic_field::add(&mut o.id, true, v);
    }

    public entry fun remove_field(o: &mut Object, ctx: &mut TxContext) {
        transfer::public_transfer(
            pera::dynamic_field::remove<bool, Object>(&mut o.id, true),
            tx_context::sender(ctx),
        );
    }
    ...
    public entry fun add_field_with_struct_name(o: &mut Object, v: Object) {
        pera::dynamic_field::add(&mut o.id, Name {name_str: std::string::utf8(b"Test Name")}, v);
    }
    ...
    public entry fun add_field_with_bytearray_name(o: &mut Object, v: Object) {
        pera::dynamic_field::add(&mut o.id,b"Test Name", v);
    }
    ...
    public entry fun add_field_with_address_name(o: &mut Object, v: Object,  ctx: &mut TxContext) {
        pera::dynamic_field::add(&mut o.id,tx_context::sender(ctx), v);
    }
