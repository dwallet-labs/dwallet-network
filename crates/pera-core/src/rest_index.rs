...
impl OwnerIndexKey {
    fn new(owner: PeraAddress, object_id: ObjectID) -> Self {
...
fn try_create_dynamic_field_info(
    ...
    let (name_value, dynamic_field_type, object_id) = {
        let layout = pera_types::layout_resolver::into_struct_layout(
            resolver
...
fn try_create_coin_index_info(object: &Object) -> Option<(CoinIndexKey, CoinIndexInfo)> {
    use pera_types::coin::CoinMetadata;
