...
impl ObjectLocks {
    ...
    pub(crate) fn try_set_transaction_lock(
        ...
        if prev_lock != new_lock {
            ...
            Err(PeraError::ObjectLockConflict {
                obj_ref: *obj_ref,
    ...
    fn verify_live_object(obj_ref: &ObjectRef, live_object: &Object) -> PeraResult {
