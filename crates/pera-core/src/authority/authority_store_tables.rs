...
pub struct AuthorityPerpetualTables {
    ...
    /// Expected total amount of PERA in the network. This is expected to remain constant
    ...
    pub(crate) expected_network_pera_amount: DBMap<(), u64>,
...
impl AuthorityPerpetualTables {
    ...
    // Constructs `pera_types::object::Object` from `StoreObjectWrapper`.
    // Returns `None` if object was deleted/wrapped
    pub fn object(
        &self,
        object_key: &ObjectKey,
        store_object: StoreObjectWrapper,
    ) -> Result<Option<Object>, PeraError> {
    ...
    pub fn get_latest_object_or_tombstone(
        &self,
        object_id: ObjectID,
    ) -> Result<Option<(ObjectKey, StoreObjectWrapper)>, PeraError> {
        let mut iterator = self
            .objects
            .unbounded_iter()
            .skip_prior_to(&ObjectKey::max_for_id(&object_id))?;
    ...
    pub fn get_highest_pruned_checkpoint(&self) -> PeraResult<CheckpointSequenceNumber> {
    ...
    ) -> PeraResult<Option<TrustedTransaction>> {
    ...
    pub fn reset_db_for_execution_since_genesis(&self) -> PeraResult {
        ...
        self.expected_network_pera_amount.unsafe_clear()?;
    ...
    pub fn insert_object_test_only(&self, object: Object) -> PeraResult {
