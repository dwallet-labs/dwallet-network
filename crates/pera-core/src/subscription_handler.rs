...
use pera_json_rpc_types::{
    EffectsWithInput, EventFilter, PeraTransactionBlockEffects, PeraTransactionBlockEvents,
    TransactionFilter,
};
use pera_json_rpc_types::{PeraEvent, PeraTransactionBlockEffectsAPI};
...
impl SubscriptionHandler {
    ...
    pub async fn process_tx(
        ...
        effects: &PeraTransactionBlockEffects,
        events: &PeraTransactionBlockEvents,
    ) -> PeraResult {
        trace!(
    ...
    pub fn subscribe_events(&self, filter: EventFilter) -> impl Stream<Item = PeraEvent> {
    ...
    ) -> impl Stream<Item = PeraTransactionBlockEffects> {
