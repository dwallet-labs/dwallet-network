...
pub trait FaucetClient {
    async fn request_pera_coins(&self, request_address: PeraAddress) -> FaucetResponse;
    async fn batch_request_pera_coins(&self, request_address: PeraAddress) -> BatchFaucetResponse;
...
impl FaucetClient for RemoteFaucetClient {
    /// Request test PERA coins from faucet.
