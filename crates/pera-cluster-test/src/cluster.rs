...
use pera_graphql_rpc::test_infra::cluster::start_graphql_server_with_fn_rpc;
...
const DEVNET_FAUCET_ADDR: &str = "https://faucet.devnet.pera.io:443";
const STAGING_FAUCET_ADDR: &str = "https://faucet.staging.pera.io:443";
const CONTINUOUS_FAUCET_ADDR: &str = "https://faucet.ci.pera.io:443";
const CONTINUOUS_NOMAD_FAUCET_ADDR: &str = "https://faucet.nomad.ci.pera.io:443";
const TESTNET_FAUCET_ADDR: &str = "https://faucet.testnet.pera.io:443";
const DEVNET_FULLNODE_ADDR: &str = "https://rpc.devnet.pera.io:443";
const STAGING_FULLNODE_ADDR: &str = "https://fullnode.staging.pera.io:443";
const CONTINUOUS_FULLNODE_ADDR: &str = "https://fullnode.ci.pera.io:443";
const CONTINUOUS_NOMAD_FULLNODE_ADDR: &str = "https://fullnode.nomad.ci.pera.io:443";
const TESTNET_FULLNODE_ADDR: &str = "https://fullnode.testnet.pera.io:443";
...
impl Cluster for LocalNewCluster {
    async fn start(options: &ClusterTestOpt) -> Result<Self, anyhow::Error> {
        ...
        if let Some(config_dir) = options.config_dir.clone() {
            ...
            let network_config_path = config_dir.join(PERA_NETWORK_CONFIG);
        ...
        let faucet_address = PeraAddress::from(faucet_key.public());
...
pub fn new_wallet_context_from_cluster(
    ...
    let address: PeraAddress = key_pair.public().into();
    keystore
        .add_key(None, PeraKeyPair::Ed25519(key_pair))
        .unwrap();
    PeraClientConfig {
        keystore,
        envs: vec![PeraEnv {
