...
#[async_trait]
pub trait Faucet {
    /// Send `Coin<PERA>` of the specified amount to the recipient
    async fn send(
        &self,
        id: Uuid,
    ...
    /// Send `Coin<PERA>` of the specified amount to the recipient in a batch request
    async fn batch_send(
        &self,
        id: Uuid,
        recipient: PeraAddress,
...
#[clap(
    name = "Pera Faucet",
    about = "Faucet for requesting test tokens on Pera",
