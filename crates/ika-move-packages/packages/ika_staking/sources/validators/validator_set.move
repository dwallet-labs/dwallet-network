...
module ika_staking::validator_set;
...
public struct ValidatorSet<phantom Witness: drop> has store {
...
public fun request_add_validator_candidate<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  current_epoch: u64,
  name: String,
...
public fun request_remove_validator_candidate<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  epoch: u64,
...
public fun update_pending_active_set<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  validator_id: ID,
  current_epoch: u64,
...
public fun request_add_validator<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  current_epoch: u64,
  cap: &ValidatorCap<Witness>,
) {
...
public fun assert_no_pending_or_active_duplicates<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  validator_id: ID,
) {
...
public fun request_remove_validator<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  current_epoch: u64,
  cap: &ValidatorCap<Witness>,
) {
...
public fun request_add_stake<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  epoch: u64,
  validator_id: ID,
  stake: Balance<IKA>,
...
public fun request_withdraw_stake<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
...
public fun withdraw_stake<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  staked_ika: StakedIka,
  current_epoch: u64,
  ctx: &mut TxContext,
...
public fun rotate_operation_cap<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  cap: &ValidatorCap<Witness>,
  ctx: &mut TxContext,
...
/// The original object is thus revoked.
public fun rotate_commission_cap<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  cap: &ValidatorCap<Witness>,
  ctx: &mut TxContext,
...
public fun collect_commission<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
...
public fun set_validator_name<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  name: String,
...
public fun validator_metadata<Witness: drop>(
  self: &ValidatorSet<Witness>,
  validator_id: ID,
): ValidatorMetadata {
...
public fun set_validator_metadata<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  cap: &ValidatorOperationCap<Witness>,
  metadata: ValidatorMetadata,
) {
...
public fun set_next_commission<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
...
public fun set_next_epoch_network_address<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  network_address: String,
  cap: &ValidatorOperationCap<Witness>,
) {
...
public fun set_next_epoch_p2p_address<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  p2p_address: String,
  cap: &ValidatorOperationCap<Witness>,
) {
...
public fun set_next_epoch_consensus_address<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  consensus_address: String,
  cap: &ValidatorOperationCap<Witness>,
) {
...
public fun set_next_epoch_protocol_pubkey_bytes<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  protocol_pubkey_bytes: vector<u8>,
...
public fun set_next_epoch_network_pubkey_bytes<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  network_pubkey_bytes: vector<u8>,
  cap: &ValidatorOperationCap<Witness>,
) {
...
public fun set_next_epoch_consensus_pubkey_bytes<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  consensus_pubkey_bytes: vector<u8>,
  cap: &ValidatorOperationCap<Witness>,
) {
...
public fun set_next_epoch_class_groups_pubkey_and_proof_bytes<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  class_groups_pubkey_and_proof_bytes: ClassGroupsPublicKeyAndProof,
  cap: &ValidatorOperationCap<Witness>,
) {
...
public fun initiate_mid_epoch_reconfiguration<Witness: drop>(self: &mut ValidatorSet<Witness>) {
...
public fun advance_epoch<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  new_epoch: u64,
...
fun activate_added_validators<Witness: drop>(self: &mut ValidatorSet<Witness>, new_epoch: u64) {
...
public fun set_min_validator_count<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  min_validator_count: u64,
) {
...
public fun set_max_validator_count<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  max_validator_count: u64,
) {
...
public fun set_min_validator_joining_stake<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  min_validator_joining_stake: u64,
) {
...
public fun set_max_validator_change_count<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  max_validator_change_count: u64,
) {
...
public fun set_reward_slashing_rate<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  reward_slashing_rate: u16,
) {
...
public fun total_stake<Witness: drop>(self: &ValidatorSet<Witness>): u64 {
  self.total_stake
}

public fun validator_total_stake_amount<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  validator_id: ID,
): u64 {
...
public fun token_exchange_rates<Witness: drop>(
  self: &ValidatorSet<Witness>,
  validator_id: ID,
...
public fun pending_active_validators_count<Witness: drop>(self: &ValidatorSet<Witness>): u64 {
  self.pending_active_set.borrow().size()
}

/// Returns true if exists in active validators.
public fun is_active_validator<Witness: drop>(
  self: &ValidatorSet<Witness>,
  validator_id: ID,
): bool {
...
public fun get_reporters_of<Witness: drop>(
  self: &ValidatorSet<Witness>,
  validator_id: ID,
): VecSet<ID> {
...
fun is_duplicate_with_pending_validator<Witness: drop>(
  self: &ValidatorSet<Witness>,
...
public fun get_validator_mut<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  validator_id: ID,
): &mut Validator {
  assert!(self.validators.contains(validator_id), ENotAValidator);
...
public fun get_validator<Witness: drop>(
  self: &ValidatorSet<Witness>,
  validator_id: ID,
): &Validator {
  assert!(self.validators.contains(validator_id), ENotAValidator);
...
fun get_validator_indices<Witness: drop>(
  self: &ValidatorSet<Witness>,
...
public fun verify_validator_cap<Witness: drop>(
  self: &ValidatorSet<Witness>,
  cap: &ValidatorCap<Witness>,
) {
  let validator_id = cap.validator_id();
...
public fun verify_operation_cap<Witness: drop>(
  self: &ValidatorSet<Witness>,
  cap: &ValidatorOperationCap<Witness>,
) {
  let validator_id = cap.validator_id();
...
public fun verify_commission_cap<Witness: drop>(
  self: &ValidatorSet<Witness>,
  cap: &ValidatorCommissionCap<Witness>,
) {
  let validator_id = cap.validator_id();
...
fun process_pending_validators<Witness: drop>(self: &mut ValidatorSet<Witness>) {
...
fun calculate_total_stakes<Witness: drop>(self: &mut ValidatorSet<Witness>): u64 {
  let mut stake = 0;
  let members = *self.active_committee.members();
  members.do!(|member| {
...
fun compute_slashed_validators<Witness: drop>(self: &mut ValidatorSet<Witness>): vector<ID> {
...
fun compute_unadjusted_reward_distribution<Witness: drop>(
  self: &ValidatorSet<Witness>,
...
fun compute_adjusted_reward_distribution<Witness: drop>(
  self: &ValidatorSet<Witness>,
  total_voting_power: u64,
...
fun distribute_reward<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  new_epoch: u64,
...
fun emit_validator_epoch_events<Witness: drop>(
  self: &ValidatorSet<Witness>,
  new_epoch: u64,
...
public fun report_validator<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  operation_cap: &ValidatorOperationCap<Witness>,
  reportee_id: ID,
) {
...
public fun undo_report_validator<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  operation_cap: &ValidatorOperationCap<Witness>,
  reportee_id: ID,
) {
...
fun report_validator_impl<Witness: drop>(
  operation_cap: &ValidatorOperationCap<Witness>,
  reportee_id: ID,
...
fun undo_report_validator_impl<Witness: drop>(
  operation_cap: &ValidatorOperationCap<Witness>,
  reportee_id: ID,
  validator_report_records: &mut VecMap<ID, VecSet<ID>>,
) {
...
public fun active_committee<Witness: drop>(self: &ValidatorSet<Witness>): BlsCommittee {
  self.active_committee
}

/// Return the next epoch active committee in `self`
public fun next_epoch_active_committee<Witness: drop>(
  self: &ValidatorSet<Witness>,
): Option<BlsCommittee> {
...
public fun pending_active_set<Witness: drop>(self: &ValidatorSet<Witness>): &PendingActiveSet {
  self.pending_active_set.borrow()
}

/// Returns true if the `validator_id` is a validator candidate.
public fun is_validator_candidate<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  validator_id: ID,
): bool {
  let validator = self.get_validator(validator_id);
...
public fun is_inactive_validator<Witness: drop>(
  self: &mut ValidatorSet<Witness>,
  validator_id: ID,
): bool {
  let validator = self.get_validator(validator_id);
...
public fun calculate_rewards<Witness: drop>(
  self: &ValidatorSet<Witness>,
  validator_id: ID,
...
public fun can_withdraw_staked_ika_early<Witness: drop>(
  self: &ValidatorSet<Witness>,
  staked_ika: &StakedIka,
  current_epoch: u64,
): bool {
