...
module ika_staking::pending_active_set;
...
public fun insert_or_update_or_remove(
...
public fun update(set: &mut PendingActiveSet, validator_id: ID, staked_amount: u64): bool {
...
public fun remove(set: &mut PendingActiveSet, validator_id: ID): bool {
...
public fun find_validator_index(set: &PendingActiveSet, validator_id: ID): Option<u64> {
...
public fun active_ids_and_stake(set: &PendingActiveSet): (vector<ID>, vector<u64>) {
...
#[test_only]
public fun current_min_validator_joining_stake(set: &PendingActiveSet): u64 {
