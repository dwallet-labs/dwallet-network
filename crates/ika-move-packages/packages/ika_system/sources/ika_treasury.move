...
module ika_system::ika_treasury;
...
public struct IkaTreasury has store {
...
public(package) fun set_stake_subsidy_rate(self: &mut IkaTreasury, stake_subsidy_rate: u16) {
...
public fun stake_subsidy_amount_per_distribution(self: &IkaTreasury): u64 {
    self.stake_subsidy_amount_per_distribution
}

/// Returns the number of distributions that have occurred.
public(package) fun get_stake_subsidy_distribution_counter(self: &IkaTreasury): u64 {
    self.stake_subsidy_distribution_counter
}

#[test_only]
public(package) fun set_stake_subsidy_distribution_counter(self: &mut IkaTreasury, stake_subsidy_distribution_counter: u64) {
