...
public fun empty(ctx: &mut TxContext): ClassGroupsPublicKeyAndProofBuilder {
...
public fun destroy(self: ClassGroupsPublicKeyAndProof): table_vec::TableVec<vector<u8>> {
