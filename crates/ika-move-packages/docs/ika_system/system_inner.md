    ...
    <b>while</b> (i &lt; len) {
        <b>let</b> message_data_type = bcs_body.peel_vec_length();
            <b>if</b> (message_data_type == 0) {
                ...
                <b>let</b> _dwallet_id = object::id_from_address(bcs_body.peel_address());
                <b>let</b> _encrypted_user_secret_key_share_id = object::id_from_address(bcs_body.peel_address());
                <b>let</b> _rejected = bcs_body.peel_bool();
