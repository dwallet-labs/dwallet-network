...
use ika_indexer_builder::metrics::IndexerMetricProvider;

#[derive(Clone, Debug)]
pub struct BridgeIndexerMetrics {
    pub(crate) total_ika_bridge_transactions: IntCounter,
    pub(crate) total_ika_token_deposited: IntCounter,
    pub(crate) total_ika_token_transfer_approved: IntCounter,
    pub(crate) total_ika_token_transfer_claimed: IntCounter,
    pub(crate) total_ika_bridge_txn_other: IntCounter,
    ...
    pub(crate) last_committed_ika_checkpoint: IntGauge,
...
impl BridgeIndexerMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            total_ika_bridge_transactions: register_int_counter_with_registry!(
                "bridge_indexer_total_ika_bridge_transactions",
                "Total number of ika bridge transactions",
                registry,
            )
            .unwrap(),
            total_ika_token_deposited: register_int_counter_with_registry!(
                "bridge_indexer_total_ika_token_deposited",
                "Total number of ika token deposited transactions",
                registry,
            )
            .unwrap(),
            total_ika_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_indexer_total_ika_token_transfer_approved",
                "Total number of ika token approved transactions",
                registry,
            )
            .unwrap(),
            total_ika_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_indexer_total_ika_token_transfer_claimed",
                "Total number of ika token claimed transactions",
                registry,
            )
            .unwrap(),
            total_ika_bridge_txn_other: register_int_counter_with_registry!(
                "bridge_indexer_total_ika_bridge_txn_other",
                "Total number of other ika bridge transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_committed_ika_checkpoint: register_int_gauge_with_registry!(
                "bridge_indexer_last_committed_ika_checkpoint",
                "The latest ika checkpoint that indexer committed to DB",
                registry,
            )
            .unwrap(),
