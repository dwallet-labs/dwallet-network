...
use ika_types::base_types::{EpochId, ObjectID, ObjectRef, SequenceNumber, VersionNumber};
...
use ika_types::transaction::{InputObjectKind, InputObjects, ObjectReadResult, TransactionKey};
            ...
            let obj: Option<Object> = match kind {
                ...
                InputObjectKind::SharedMoveObject { id, .. } => {
                    let shared_locks = shared_locks_cell
                        ...
                        .as_ref()
                        .ok_or_else(|| IkaError::GenericAuthorityError {
