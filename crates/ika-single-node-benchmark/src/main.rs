...
use clap::Parser;
use ika_single_node_benchmark::command::Command;
use ika_single_node_benchmark::run_benchmark;
use ika_single_node_benchmark::workload::Workload;

#[tokio::main]
async fn main() {
    let _guard = telemetry_subscribers::TelemetryConfig::new()
        .with_log_level("off,ika_single_node_benchmark=info")
        .with_env()
        .init();
