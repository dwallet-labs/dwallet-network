...
/// Similar to `ika::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `ika::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module ika::dynamic_object_field;
