...
#[test_only]
module ika::poseidon_tests {
    use ika::poseidon::poseidon_bn254;
    ...
    #[test]
    #[expected_failure(abort_code = ika::poseidon::ENonCanonicalInput)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::poseidon::EEmptyInput)]
