...
#[test_only]
module ika::zklogin_verified_id_tests {
    use ika::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};
    use ika::test_scenario;

    #[test]
    #[expected_failure(abort_code = ika::zklogin_verified_id::EFunctionDisabled)]
