...
#[test_only]
module ika::zklogin_verified_issuer_tests {
    use ika::zklogin_verified_issuer::{check_zklogin_issuer, delete, verify_zklogin_issuer, VerifiedIssuer};
    ...
    #[test]
    #[expected_failure(abort_code = ika::zklogin_verified_issuer::EInvalidProof)]
