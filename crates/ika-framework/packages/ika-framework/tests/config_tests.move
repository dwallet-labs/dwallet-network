...
#[test_only]
module ika::config_tests {

    use ika::config::{Self, Config};
    ...
    fun config_create<WriteCap>(cap: &mut WriteCap, ctx: &mut TxContext) {
        ika::config::share(ika::config::new(cap, ctx))
    }
    ...
    #[test, expected_failure(abort_code = ika::config::EAlreadySetForEpoch)]
    ...
    #[test, expected_failure(abort_code = ika::config::ENotSetForEpoch)]
    ...
    #[test, expected_failure(abort_code = ika::dynamic_field::EFieldTypeMismatch)]
