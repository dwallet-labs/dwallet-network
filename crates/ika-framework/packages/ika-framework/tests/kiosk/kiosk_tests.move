...
module ika::kiosk_tests {
    use ika::kiosk_test_utils::{Self as test, Asset};
    use ika::ika::IKA;
    use ika::coin;
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EItemLocked)]
    ...
    fun test_purchase() {
        ...
        let payment = coin::mint_for_testing<IKA>(AMT, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::ENotListed)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EListedExclusively)]
    ...
    #[allow(unused_field)]
    public struct WrongAsset has key, store { id: ika::object::UID }

    #[test]
    #[expected_failure(abort_code = ika::kiosk::EItemNotFound)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EIncorrectAmount)]
    fun test_purchase_wrong_amount() {
        ...
        kiosk.place_and_list(&owner_cap, asset, AMT);
        let payment = coin::mint_for_testing<IKA>(AMT + 1, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EAlreadyListed)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::ENotEmpty)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::ENotEnough)]
    ...
    fun test_uid_access() {
        ...
        let uid = kiosk.uid();
        assert!(ika::object::uid_to_inner(uid) == ika::object::id(&kiosk));

        test::return_kiosk(kiosk, owner_cap, ctx);
    }

    #[test]
    #[expected_failure(abort_code = ika::kiosk::EUidAccessNotAllowed)]
