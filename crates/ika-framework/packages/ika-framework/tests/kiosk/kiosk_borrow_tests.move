...
module ika::kiosk_borrow_tests {
    use ika::kiosk_test_utils::{Self as utils, Asset};
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::ENotOwner)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EItemIsListed)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EWrongKiosk)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::kiosk::EItemMismatch)]
