...
module ika::royalty_policy {
    use ika::ika::IKA;
    use ika::coin::{Self, Coin};
    use ika::transfer_policy::{
        Self as policy,
        TransferPolicy,
        TransferPolicyCap,
        TransferRequest
...
#[test_only]
module ika::royalty_policy_tests {
    use ika::coin;
    use ika::ika::IKA;
    use ika::royalty_policy;
    use ika::transfer_policy as policy;
    use ika::transfer_policy_tests as test;
    ...
    fun test_default_flow() {
        ...
        let mut payment = coin::mint_for_testing<IKA>(2000, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = ika::royalty_policy::EIncorrectArgument)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::royalty_policy::EInsufficientAmount)]
    fun test_insufficient_amount() {
        ...
        // Requires 1_000 NIKA, coin has only 999
        let mut request = policy::new_request(test::fresh_id(ctx), 100_000, test::fresh_id(ctx));
        let mut payment = coin::mint_for_testing<IKA>(999, ctx);
