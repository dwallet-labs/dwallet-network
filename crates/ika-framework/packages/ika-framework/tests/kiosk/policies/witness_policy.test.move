...
#[test_only]
module ika::witness_policy_tests {
    use ika::witness_policy;
    use ika::transfer_policy as policy;
    use ika::transfer_policy_tests::{
        Self as test,
        Asset
    };
    ...
    #[test]
    #[expected_failure(abort_code = ika::witness_policy::ERuleNotFound)]
