...
#[test_only]
module ika::malicious_policy {
    use ika::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module ika::transfer_policy_tests {
    use ika::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    use ika::dummy_policy;
    use ika::malicious_policy;
    use ika::package;
    use ika::coin;
    ...
    #[test]
    #[expected_failure(abort_code = ika::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = ika::transfer_policy::EIllegalRule)]
