...
#[test_only]
module ika_system::validator_tests {
    use ika::bag;
    use ika::balance;
    ...
    fun test_validator_owner_flow() {
        ...
        let scenario = &mut scenario_val;
        {
            ...
            assert!(validator.ika_address() == sender);
    ...
    fun test_pending_validator_flow() {
        ...
        scenario.next_tx(sender);
        {
            let coin_ids = scenario.ids_for_sender<StakedIka>();
            let stake = scenario.take_from_sender_by_id<StakedIka>(coin_ids[0]);
            let ctx = scenario.ctx();
        ...
        scenario.next_tx(sender);
        {
            ...
            let withdraw = scenario.take_from_sender_by_id<Coin<IKA>>(coin_ids[0]);
    ...
    #[expected_failure(abort_code = ika_system::validator::EInvalidProofOfPossession)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EMetadataInvalidNetPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EMetadataInvalidWorkerPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EMetadataInvalidNetAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EMetadataInvalidPrimaryAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EMetadataInvalidWorkerAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EMetadataInvalidP2pAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = ika_system::validator::EValidatorMetadataExceedingLengthLimit)]
    #[test]
