...
-  [Function `execute_add_tokens_on_ika`](#0xb_bridge_execute_add_tokens_on_ika)
...
<b>use</b> <a href="../ika-framework/package.md#0x2_package">0x2::package</a>;
...
<dt>
<code>sequence_nums: <a href="../ika-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u8, <a href="../move-stdlib/u64.md#0x1_u64">u64</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>token_transfer_records: <a href="../ika-framework/linked_table.md#0x2_linked_table_LinkedTable">linked_table::LinkedTable</a>&lt;<a href="message.md#0xb_message_BridgeMessageKey">message::BridgeMessageKey</a>, <a href="bridge.md#0xb_bridge_BridgeRecord">bridge::BridgeRecord</a>&gt;</code>
</dt>
<dd>
...
<a name="0xb_bridge_EInvariantIkaInitializedTokenTransferShouldNotBeClaimed"></a>



<pre><code><b>const</b> <a href="bridge.md#0xb_bridge_EInvariantIkaInitializedTokenTransferShouldNotBeClaimed">EInvariantIkaInitializedTokenTransferShouldNotBeClaimed</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 10;
</code></pre>
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_create">create</a>(id: <a href="../ika-framework/object.md#0x2_object_UID">object::UID</a>, chain_id: u8, ctx: &<b>mut</b> <a href="../ika-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_create">create</a>(id: UID, chain_id: u8, ctx: &<b>mut</b> TxContext) {
    ...
    <b>let</b> bridge_inner = <a href="bridge.md#0xb_bridge_BridgeInner">BridgeInner</a> {
        ...
        chain_id,
        sequence_nums: <a href="../ika-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
        ...
        token_transfer_records: <a href="../ika-framework/linked_table.md#0x2_linked_table_new">linked_table::new</a>(ctx),
    ...
    <b>let</b> <a href="bridge.md#0xb_bridge">bridge</a> = <a href="bridge.md#0xb_bridge_Bridge">Bridge</a> {
        id,
        inner: <a href="../ika-framework/versioned.md#0x2_versioned_create">versioned::create</a>(<a href="bridge.md#0xb_bridge_CURRENT_VERSION">CURRENT_VERSION</a>, bridge_inner, ctx),
    };
    <a href="../ika-framework/transfer.md#0x2_transfer_share_object">transfer::share_object</a>(<a href="bridge.md#0xb_bridge">bridge</a>);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_register_foreign_token">register_foreign_token</a>&lt;T&gt;(<a href="bridge.md#0xb_bridge">bridge</a>: &<b>mut</b> <a href="bridge.md#0xb_bridge_Bridge">bridge::Bridge</a>, tc: <a href="../ika-framework/coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;T&gt;, uc: <a href="../ika-framework/package.md#0x2_package_UpgradeCap">package::UpgradeCap</a>, metadata: &<a href="../ika-framework/coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_send_token">send_token</a>&lt;T&gt;(
    ...
    <b>let</b> token_amount = token.<a href="../ika-framework/balance.md#0x2_balance">balance</a>().value();
    ...
    // emit <a href="../ika-framework/event.md#0x2_event">event</a>
    emit(
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_approve_token_transfer">approve_token_transfer</a>(
    ...
    // retrieve pending <a href="message.md#0xb_message">message</a> <b>if</b> source chain is Ika, the initial <a href="message.md#0xb_message">message</a>
    // must exist on chain
    <b>if</b> (<a href="message.md#0xb_message">message</a>.source_chain() == inner.chain_id) {
        ...
        <b>assert</b>!(!record.claimed, <a href="bridge.md#0xb_bridge_EInvariantIkaInitializedTokenTransferShouldNotBeClaimed">EInvariantIkaInitializedTokenTransferShouldNotBeClaimed</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_claim_and_transfer_token">claim_and_transfer_token</a>&lt;T&gt;(
    ...
    <b>let</b> (token, owner) = <a href="bridge.md#0xb_bridge">bridge</a>.<a href="bridge.md#0xb_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(<a href="../ika-framework/clock.md#0x2_clock">clock</a>, source_chain, bridge_seq_num, ctx);
    <b>if</b> (token.is_some()) {
        <a href="../ika-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(token.destroy_some(), owner)
    } <b>else</b> {
        token.destroy_none();
    };
}
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_execute_system_message">execute_system_message</a>(
    ...
    } <b>else</b> <b>if</b> (message_type == <a href="message_types.md#0xb_message_types_add_tokens_on_ika">message_types::add_tokens_on_ika</a>()) {
        <b>let</b> payload = <a href="message.md#0xb_message">message</a>.extract_add_tokens_on_ika();
        inner.<a href="bridge.md#0xb_bridge_execute_add_tokens_on_ika">execute_add_tokens_on_ika</a>(payload);
    } <b>else</b> {
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_load_inner">load_inner</a>(
    ...
    // TODO: Replace this <b>with</b> a lazy <b>update</b> function when we add a new version of the inner <a href="../ika-framework/object.md#0x2_object">object</a>.
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(
    ...
    // Make sure <a href="../ika-framework/transfer.md#0x2_transfer">transfer</a> is within limit.
    <b>if</b> (!inner
...
<a name="0xb_bridge_execute_add_tokens_on_ika"></a>

## Function `execute_add_tokens_on_ika`



<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_execute_add_tokens_on_ika">execute_add_tokens_on_ika</a>(inner: &<b>mut</b> <a href="bridge.md#0xb_bridge_BridgeInner">bridge::BridgeInner</a>, payload: <a href="message.md#0xb_message_AddTokenOnIka">message::AddTokenOnIka</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_execute_add_tokens_on_ika">execute_add_tokens_on_ika</a>(inner: &<b>mut</b> <a href="bridge.md#0xb_bridge_BridgeInner">BridgeInner</a>, payload: AddTokenOnIka) {
