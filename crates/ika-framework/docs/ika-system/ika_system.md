...
-  [Function `validator_voting_powers`](#0x3_ika_system_validator_voting_powers)
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="ika_system.md#0x3_ika_system_create">create</a>(
    id: UID,
    validators: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;,
    <a href="storage_fund.md#0x3_storage_fund">storage_fund</a>: Balance&lt;IKA&gt;,
    ...
    <b>let</b> system_state = <a href="ika_system_state_inner.md#0x3_ika_system_state_inner_create">ika_system_state_inner::create</a>(
        validators,
    ...
    <b>let</b> version = <a href="ika_system_state_inner.md#0x3_ika_system_state_inner_genesis_system_state_version">ika_system_state_inner::genesis_system_state_version</a>();
    <b>let</b> <b>mut</b> self = <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a> {
        id,
        version,
    };
    <a href="../ika-framework/dynamic_field.md#0x2_dynamic_field_add">dynamic_field::add</a>(&<b>mut</b> self.id, version, system_state);
    <a href="../ika-framework/transfer.md#0x2_transfer_share_object">transfer::share_object</a>(self);
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_add_validator_candidate">request_add_validator_candidate</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ...
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_add_validator_candidate">request_add_validator_candidate</a>(
        pubkey_bytes,
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_remove_validator_candidate">request_remove_validator_candidate</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_remove_validator_candidate">request_remove_validator_candidate</a>(ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_add_validator">request_add_validator</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_add_validator">request_add_validator</a>(ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_remove_validator">request_remove_validator</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_remove_validator">request_remove_validator</a>(ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_set_gas_price">request_set_gas_price</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    cap: &UnverifiedValidatorOperationCap,
    new_gas_price: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_set_gas_price">request_set_gas_price</a>(cap, new_gas_price)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_set_candidate_validator_gas_price">set_candidate_validator_gas_price</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    cap: &UnverifiedValidatorOperationCap,
    new_gas_price: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_set_candidate_validator_gas_price">set_candidate_validator_gas_price</a>(cap, new_gas_price)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_set_commission_rate">request_set_commission_rate</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    new_commission_rate: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_set_commission_rate">request_set_commission_rate</a>(new_commission_rate, ctx)
}
</code></pre>
...
<a name="0x3_ika_system_set_candidate_validator_commission_rate"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_set_candidate_validator_commission_rate">set_candidate_validator_commission_rate</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    new_commission_rate: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_set_candidate_validator_commission_rate">set_candidate_validator_commission_rate</a>(new_commission_rate, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_add_stake">request_add_stake</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    stake: Coin&lt;IKA&gt;,
    validator_address: <b>address</b>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> staked_ika = <a href="ika_system.md#0x3_ika_system_request_add_stake_non_entry">request_add_stake_non_entry</a>(wrapper, stake, validator_address, ctx);
    <a href="../ika-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(staked_ika, ctx.sender());
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_add_stake_non_entry">request_add_stake_non_entry</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    stake: Coin&lt;IKA&gt;,
    validator_address: <b>address</b>,
    ctx: &<b>mut</b> TxContext,
    ...
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_add_stake">request_add_stake</a>(stake, validator_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_add_stake_mul_coin">request_add_stake_mul_coin</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ...
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    <b>let</b> staked_ika = self.<a href="ika_system.md#0x3_ika_system_request_add_stake_mul_coin">request_add_stake_mul_coin</a>(stakes, stake_amount, validator_address, ctx);
    <a href="../ika-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(staked_ika, ctx.sender());
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_withdraw_stake">request_withdraw_stake</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    staked_ika: StakedIka,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> withdrawn_stake = <a href="ika_system.md#0x3_ika_system_request_withdraw_stake_non_entry">request_withdraw_stake_non_entry</a>(wrapper, staked_ika, ctx);
    <a href="../ika-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(withdrawn_stake.into_coin(ctx), ctx.sender());
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_convert_to_fungible_staked_ika">convert_to_fungible_staked_ika</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    staked_ika: StakedIka,
    ctx: &<b>mut</b> TxContext,
): FungibleStakedIka {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_convert_to_fungible_staked_ika">convert_to_fungible_staked_ika</a>(staked_ika, ctx)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_redeem_fungible_staked_ika">redeem_fungible_staked_ika</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    fungible_staked_ika: FungibleStakedIka,
    ctx: &TxContext,
): Balance&lt;IKA&gt; {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_redeem_fungible_staked_ika">redeem_fungible_staked_ika</a>(fungible_staked_ika, ctx)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_request_withdraw_stake_non_entry">request_withdraw_stake_non_entry</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    staked_ika: StakedIka,
    ctx: &<b>mut</b> TxContext,
) : Balance&lt;IKA&gt; {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_request_withdraw_stake">request_withdraw_stake</a>(staked_ika, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_report_validator">report_validator</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    cap: &UnverifiedValidatorOperationCap,
    reportee_addr: <b>address</b>,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_report_validator">report_validator</a>(cap, reportee_addr)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_undo_report_validator">undo_report_validator</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    cap: &UnverifiedValidatorOperationCap,
    reportee_addr: <b>address</b>,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_undo_report_validator">undo_report_validator</a>(cap, reportee_addr)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_rotate_operation_cap">rotate_operation_cap</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_rotate_operation_cap">rotate_operation_cap</a>(ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_name">update_validator_name</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    name: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_name">update_validator_name</a>(name, ctx)
}
</code></pre>
...
<a name="0x3_ika_system_update_validator_description"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_description">update_validator_description</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    description: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_description">update_validator_description</a>(description, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_image_url">update_validator_image_url</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    image_url: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_image_url">update_validator_image_url</a>(image_url, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_project_url">update_validator_project_url</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    project_url: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_project_url">update_validator_project_url</a>(project_url, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_network_address">update_validator_next_epoch_network_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    network_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_network_address">update_validator_next_epoch_network_address</a>(network_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_network_address">update_candidate_validator_network_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    network_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_network_address">update_candidate_validator_network_address</a>(network_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_p2p_address">update_validator_next_epoch_p2p_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    p2p_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_p2p_address">update_validator_next_epoch_p2p_address</a>(p2p_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_p2p_address">update_candidate_validator_p2p_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    p2p_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_p2p_address">update_candidate_validator_p2p_address</a>(p2p_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_primary_address">update_validator_next_epoch_primary_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    primary_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_primary_address">update_validator_next_epoch_primary_address</a>(primary_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_primary_address">update_candidate_validator_primary_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    primary_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_primary_address">update_candidate_validator_primary_address</a>(primary_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_worker_address">update_validator_next_epoch_worker_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    worker_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_worker_address">update_validator_next_epoch_worker_address</a>(worker_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_worker_address">update_candidate_validator_worker_address</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    worker_address: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_worker_address">update_candidate_validator_worker_address</a>(worker_address, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_protocol_pubkey">update_validator_next_epoch_protocol_pubkey</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    ...
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_protocol_pubkey">update_validator_next_epoch_protocol_pubkey</a>(protocol_pubkey, proof_of_possession, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_protocol_pubkey">update_candidate_validator_protocol_pubkey</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    protocol_pubkey: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    proof_of_possession: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
    ...
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_protocol_pubkey">update_candidate_validator_protocol_pubkey</a>(protocol_pubkey, proof_of_possession, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_worker_pubkey">update_validator_next_epoch_worker_pubkey</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    worker_pubkey: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_worker_pubkey">update_validator_next_epoch_worker_pubkey</a>(worker_pubkey, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_worker_pubkey">update_candidate_validator_worker_pubkey</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    worker_pubkey: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_worker_pubkey">update_candidate_validator_worker_pubkey</a>(worker_pubkey, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_network_pubkey">update_validator_next_epoch_network_pubkey</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    network_pubkey: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_validator_next_epoch_network_pubkey">update_validator_next_epoch_network_pubkey</a>(network_pubkey, ctx)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="ika_system.md#0x3_ika_system_update_candidate_validator_network_pubkey">update_candidate_validator_network_pubkey</a>(
    self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    network_pubkey: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self);
    self.<a href="ika_system.md#0x3_ika_system_update_candidate_validator_network_pubkey">update_candidate_validator_network_pubkey</a>(network_pubkey, ctx)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_validator_address_by_pool_id">validator_address_by_pool_id</a>(wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>, pool_id: &ID): <b>address</b> {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_validator_address_by_pool_id">validator_address_by_pool_id</a>(pool_id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_pool_exchange_rates">pool_exchange_rates</a>(
    wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>,
    pool_id: &ID
): &Table&lt;<a href="../move-stdlib/u64.md#0x1_u64">u64</a>, PoolTokenExchangeRate&gt;  {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_pool_exchange_rates">pool_exchange_rates</a>(pool_id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="ika_system.md#0x3_ika_system_active_validator_addresses">active_validator_addresses</a>(wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt; {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state">load_system_state</a>(wrapper);
    self.<a href="ika_system.md#0x3_ika_system_active_validator_addresses">active_validator_addresses</a>()
}
</code></pre>
...
<pre><code><b>fun</b> <a href="ika_system.md#0x3_ika_system_advance_epoch">advance_epoch</a>(
    ...
    <b>assert</b>!(ctx.sender() == @0x0, <a href="ika_system.md#0x3_ika_system_ENotSystemAddress">ENotSystemAddress</a>);
    <b>let</b> storage_rebate = self.<a href="ika_system.md#0x3_ika_system_advance_epoch">advance_epoch</a>(
        new_epoch,
...
<pre><code><b>fun</b> <a href="ika_system.md#0x3_ika_system_load_system_state">load_system_state</a>(self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>): &IkaSystemStateInnerV2 {
    <a href="ika_system.md#0x3_ika_system_load_inner_maybe_upgrade">load_inner_maybe_upgrade</a>(self)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="ika_system.md#0x3_ika_system_load_system_state_mut">load_system_state_mut</a>(self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>): &<b>mut</b> IkaSystemStateInnerV2 {
    <a href="ika_system.md#0x3_ika_system_load_inner_maybe_upgrade">load_inner_maybe_upgrade</a>(self)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="ika_system.md#0x3_ika_system_load_inner_maybe_upgrade">load_inner_maybe_upgrade</a>(self: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>): &<b>mut</b> IkaSystemStateInnerV2 {
    <b>if</b> (self.version == 1) {
      <b>let</b> v1: IkaSystemStateInner = <a href="../ika-framework/dynamic_field.md#0x2_dynamic_field_remove">dynamic_field::remove</a>(&<b>mut</b> self.id, self.version);
      <b>let</b> v2 = v1.v1_to_v2();
      self.version = 2;
      <a href="../ika-framework/dynamic_field.md#0x2_dynamic_field_add">dynamic_field::add</a>(&<b>mut</b> self.id, self.version, v2);
    };

    <b>let</b> inner: &<b>mut</b> IkaSystemStateInnerV2 = <a href="../ika-framework/dynamic_field.md#0x2_dynamic_field_borrow_mut">dynamic_field::borrow_mut</a>(
        &<b>mut</b> self.id,
        self.version
    );
    <b>assert</b>!(inner.system_state_version() == self.version, <a href="ika_system.md#0x3_ika_system_EWrongInnerVersion">EWrongInnerVersion</a>);
    inner
}
</code></pre>
...
<pre><code><b>fun</b> <a href="ika_system.md#0x3_ika_system_validator_voting_powers">validator_voting_powers</a>(wrapper: &<b>mut</b> <a href="ika_system.md#0x3_ika_system_IkaSystemState">IkaSystemState</a>): VecMap&lt;<b>address</b>, <a href="../move-stdlib/u64.md#0x1_u64">u64</a>&gt; {
    <b>let</b> self = <a href="ika_system.md#0x3_ika_system_load_system_state">load_system_state</a>(wrapper);
    <a href="ika_system_state_inner.md#0x3_ika_system_state_inner_active_validator_voting_powers">ika_system_state_inner::active_validator_voting_powers</a>(self)
}
</code></pre>
