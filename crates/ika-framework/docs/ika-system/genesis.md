...
<b>use</b> <a href="ika_system.md#0x3_ika_system">0x3::ika_system</a>;
...
<dl>
<dt>
<code>stake_subsidy_fund_nika: <a href="../move-stdlib/u64.md#0x1_u64">u64</a></code>
</dt>
<dd>
...
<dt>
<code>amount_nika: <a href="../move-stdlib/u64.md#0x1_u64">u64</a></code>
</dt>
<dd>
...
It will create a singleton IkaSystemState object, which contains
all the information we need in the system.


<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_create">create</a>(ika_system_state_id: <a href="../ika-framework/object.md#0x2_object_UID">object::UID</a>, ika_supply: <a href="../ika-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../ika-framework/ika.md#0x2_ika_IKA">ika::IKA</a>&gt;, genesis_chain_parameters: <a href="genesis.md#0x3_genesis_GenesisChainParameters">genesis::GenesisChainParameters</a>, genesis_validators: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x3_genesis_GenesisValidatorMetadata">genesis::GenesisValidatorMetadata</a>&gt;, token_distribution_schedule: <a href="genesis.md#0x3_genesis_TokenDistributionSchedule">genesis::TokenDistributionSchedule</a>, ctx: &<b>mut</b> <a href="../ika-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_create">create</a>(
    ...
    <b>mut</b> ika_supply: Balance&lt;IKA&gt;,
    ...
    <b>let</b> <a href="genesis.md#0x3_genesis_TokenDistributionSchedule">TokenDistributionSchedule</a> {
        stake_subsidy_fund_nika,
        allocations,
    } = token_distribution_schedule;

    <b>let</b> subsidy_fund = ika_supply.split(stake_subsidy_fund_nika);
    <b>let</b> <a href="storage_fund.md#0x3_storage_fund">storage_fund</a> = <a href="../ika-framework/balance.md#0x2_balance_zero">balance::zero</a>();
    ...
    <b>let</b> system_parameters = <a href="ika_system_state_inner.md#0x3_ika_system_state_inner_create_system_parameters">ika_system_state_inner::create_system_parameters</a>(
    ...
    <a href="ika_system.md#0x3_ika_system_create">ika_system::create</a>(
        ika_system_state_id,
        validators,
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(ika_supply: <a href="../ika-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../ika-framework/ika.md#0x2_ika_IKA">ika::IKA</a>&gt;, allocations: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x3_genesis_TokenAllocation">genesis::TokenAllocation</a>&gt;, validators: &<b>mut</b> <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<b>mut</b> <a href="../ika-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(
    ...
    <b>while</b> (!allocations.is_empty()) {
        ...
        <b>let</b> allocation_balance = ika_supply.split(amount_nika);
        ...
        <b>if</b> (staked_with_validator.is_some()) {
            ...
            <a href="../ika-framework/ika.md#0x2_ika_transfer">ika::transfer</a>(
    ...
    // Provided allocations must fully allocate the ika_supply and there
    // should be none left at this point.
    ika_supply.destroy_zero();
}
</code></pre>
