...
use epoch_start_ika_system_state::EpochStartSystemState;
...
pub type IkaSystemStateInnerInit = IkaSystemStateInnerV1;
pub type IkaValidatorInit = ValidatorV1;
...
impl IkaSystemState {
    ...
    pub fn into_genesis_version_for_tooling(self) -> IkaSystemStateInnerInit {
        match self {
...
//     object_store: &dyn ObjectStore,
// ) -> Result<IkaSystemStateWrapper, SuiError> {
//     let wrapper = object_store
//         .get_object(&IKA_SYSTEM_STATE_OBJECT_ID)?
//         // Don't panic here on None because object_store is a generic store.
//         .ok_or_else(|| {
//             SuiError::IkaSystemStateReadError("IkaSystemStateWrapper object not found".to_owned())
//         })?;
//     let move_object = wrapper.data.try_as_move().ok_or_else(|| {
//         SuiError::IkaSystemStateReadError(
...
//         .map_err(|err| SuiError::IkaSystemStateReadError(err.to_string()))?;
//     Ok(result)
// }
// 
// pub fn get_ika_system_state(object_store: &dyn ObjectStore) -> Result<IkaSystemState, SuiError> {
...
//         }
//         _ => Err(SuiError::IkaSystemStateReadError(format!(
...
//     table_id: ObjectID,
//     key: &K,
// ) -> Result<IkaValidatorSummary, SuiError>
// where
...
//         .map_err(|err| {
//             SuiError::IkaSystemStateReadError(format!(
