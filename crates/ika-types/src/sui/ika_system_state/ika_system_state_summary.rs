...
use sui_types::committee::{CommitteeWithNetworkMetadata, NetworkMetadata};
...
pub struct IkaSystemStateSummary {
    ...
    #[schemars(with = "BigInt<u64>")]
    #[serde_as(as = "Readable<BigInt<u64>, _>")]
    pub ika_treasury_total_supply: u64,
...
impl Default for IkaSystemStateSummary {
    fn default() -> Self {
        Self {
            ...
            computation_price_per_unit_size: 1,
            safe_mode: false,
            ...
            ika_treasury_total_supply: 0,
            stake_subsidy_distribution_counter: 0,
            stake_subsidy_amount_per_distribution: 0,
            stake_subsidy_period_length: 0,
            stake_subsidy_rate: 0,
            total_stake: 0,
...
impl Default for IkaValidatorSummary {
    fn default() -> Self {
        Self {
            ...
            next_epoch_proof_of_possession_bytes: None,
            ...
            commission_rate: 0,
            next_epoch_stake: 0,
            next_epoch_computation_price: 0,
