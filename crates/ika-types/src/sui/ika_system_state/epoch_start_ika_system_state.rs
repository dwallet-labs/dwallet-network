    ...
    pub fn new_at_next_epoch_for_testing(&self) -> Self {
        ...
        match self {
            Self::V1(state) => Self::V1(EpochStartSystemStateV1 {
                ...
                computation_price_per_unit_size: state.computation_price_per_unit_size,
...
impl EpochStartSystemStateV1 {
    ...
    pub fn new_for_testing_with_epoch(epoch: EpochId) -> Self {
        Self {
            ...
            computation_price_per_unit_size: sui_types::transaction::DEFAULT_VALIDATOR_GAS_PRICE,
            safe_mode: false,
    ...
    fn get_consensus_committee(&self) -> ConsensusCommittee {
        ...
        for (i, (name, stake)) in ika_committee.members().enumerate() {
            ...
            authorities.push(Authority {
                ...
                address: active_validator.narwhal_primary_address.clone(),
                ...
                authority_key: consensus_config::AuthorityPublicKey::new(
                    ...
                    bls12381::min_sig::BLS12381KeyPair::generate(&mut StdRng::from_seed([0; 32])).public().clone()
                ),
                protocol_key: consensus_config::ProtocolPublicKey::new(
                    active_validator.narwhal_worker_pubkey.clone(),
                ),
                network_key: consensus_config::NetworkPublicKey::new(
                    active_validator.narwhal_network_pubkey.clone(),
                ),
            });
        }
...
mod test {
    ...
    use super::super::epoch_start_ika_system_state::{
