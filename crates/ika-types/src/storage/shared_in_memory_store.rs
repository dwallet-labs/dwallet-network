...
pub struct InMemoryStore {
    ...
    checkpoints: HashMap<CheckpointMessageDigest, VerifiedDWalletCheckpointMessage>,
...
impl InMemoryStore {
    ...
    pub fn get_highest_verified_checkpoint(&self) -> Option<&VerifiedDWalletCheckpointMessage> {
        self.highest_verified_checkpoint
            .as_ref()
            .and_then(|(_, digest)| self.get_checkpoint_by_digest(digest))
    }

    pub fn get_highest_synced_checkpoint(&self) -> Option<&VerifiedDWalletCheckpointMessage> {
    ...
    pub fn checkpoints(
        &self,
    ) -> &HashMap<CheckpointMessageDigest, VerifiedDWalletCheckpointMessage> {
        &self.checkpoints
    }
