...
use crate::error::{ExecutionError, IkaError};
...
) -> IkaResult<PackageFetchResults<PackageObject>> {
...
pub fn get_module_by_id<S: BackingPackageStore>(
    store: &S,
    id: &ModuleId,
) -> anyhow::Result<Option<CompiledModule>, IkaError> {
