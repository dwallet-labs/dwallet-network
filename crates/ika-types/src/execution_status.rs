...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a IKA coin.")]
    InvalidGasObject,
    ...
    #[error(
        "Ika Move Bytecode Verification Error. \
        Please run the Ika Move Verifier for more information."
    )]
    IkaMoveVerificationError,
    ...
    #[error(
        "Ika Move Bytecode Verification Timeout. \
        Please run the Ika Move Verifier for more information."
    )]
    IkaMoveVerificationTimedout,
