...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, IkaGasStatusAPI};
    ...
    /// A list of constant costs of various operations in Ika.
    pub struct IkaCostTable {
    ...
    impl std::fmt::Debug for IkaCostTable {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            // TODO: dump the fields.
            write!(f, "IkaCostTable(...)")
        }
    }
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Ika) for in this object.
    ...
    impl IkaGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let ika_cost_table = IkaCostTable::new(config, gas_price);
            let gas_rounding_step = config.gas_rounding_step_as_option();
            Self::new(
                GasStatus::new(
                    ika_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> IkaGasStatus {
            Self::new(
    ...
    impl IkaGasStatusAPI for IkaGasStatus {
