...
pub mod checked {
    ...
    use crate::{
        ...
        error::{ExecutionError, IkaResult, UserInputError, UserInputResult},
        gas_model::{gas_v2::IkaGasStatus as IkaGasStatusV2, tables::GasStatus},
        object::Object,
        ika_serde::{BigInt, Readable},
    ...
    #[enum_dispatch(IkaGasStatusAPI)]
    #[derive(Debug)]
    pub enum IkaGasStatus {
    ...
    impl IkaGasStatus {
        pub fn new(
            ...
            Ok(Self::V2(IkaGasStatusV2::new_with_budget(
                gas_budget,
                gas_price,
                reference_gas_price,
                config,
        ...
        pub fn new_unmetered() -> Self {
            Self::V2(IkaGasStatusV2::new_unmetered())
        }

        // This is the only public API on IkaGasStatus, all other gas related operations should
