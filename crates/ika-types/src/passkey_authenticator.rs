...
impl<'de> Deserialize<'de> for PasskeyAuthenticator {
        ...
        D: Deserializer<'de>,
    {
        ...
        serializable
            .try_into()
            .map_err(|e: IkaError| Error::custom(e.to_string()))
    }
}
...
impl Serialize for PasskeyAuthenticator {
    ...
    {
        let mut bytes = Vec::with_capacity(Secp256r1IkaSignature::LENGTH);
        ...
        let raw = RawPasskeyAuthenticator {
            ...
            user_signature: Signature::Secp256r1IkaSignature(
                Secp256r1IkaSignature::from_bytes(&bytes).unwrap(),
            ),
        };
...
impl PasskeyAuthenticator {
    ...
    pub fn get_pk(&self) -> IkaResult<PublicKey> {
...
impl AuthenticatorTrait for PasskeyAuthenticator {
        ...
        T: Serialize,
    {
        ...
        if author != IkaAddress::from(&self.get_pk()?) {
            return Err(IkaError::InvalidSignature {
