...
use crate::ika_system_state::ika_system_state_summary::{
    IkaSystemStateSummary, IkaValidatorSummary,
};
use crate::ika_system_state::{AdvanceEpochParams, IkaSystemStateTrait};
...
pub struct SimTestIkaSystemStateInnerV1 {
    pub epoch: u64,
...
impl IkaSystemStateTrait for SimTestIkaSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
            ...
            self.validators
                ...
                .map(|validator| {
                    ...
                    EpochStartValidatorInfoV1 {
                        ika_address: metadata.ika_address,
    ...
    fn into_ika_system_state_summary(self) -> IkaSystemStateSummary {
        IkaSystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestIkaSystemStateInnerShallowV2 {
...
impl IkaSystemStateTrait for SimTestIkaSystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestIkaSystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl IkaSystemStateTrait for SimTestIkaSystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
