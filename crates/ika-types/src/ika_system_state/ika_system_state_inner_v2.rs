...
use super::epoch_start_ika_system_state::EpochStartValidatorInfoV1;
use super::ika_system_state_inner_v1::ValidatorV1;
...
use crate::ika_system_state::get_validators_from_table_vec;
use crate::ika_system_state::ika_system_state_inner_v1::{
    StakeSubsidyV1, StorageFundV1, ValidatorSetV1,
};
use serde::{Deserialize, Serialize};

/// Rust version of the Move ika::ika_system::SystemParametersV2 type
...
/// Rust version of the Move ika_system::ika_system::IkaSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct IkaSystemStateInnerV2 {
    pub epoch: u64,
    ...
    pub validator_report_records: VecMap<IkaAddress, VecSet<IkaAddress>>,
...
impl IkaSystemStateTrait for IkaSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
