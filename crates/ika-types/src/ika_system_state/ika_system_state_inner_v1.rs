...
use crate::base_types::{ObjectID, IkaAddress};
...
use super::{get_validators_from_table_vec, AdvanceEpochParams, IkaSystemStateTrait};
...
impl ValidatorMetadataV1 {
    ...
    pub fn verify(&self) -> Result<VerifiedValidatorMetadataV1, u64> {
        ...
        verify_proof_of_possession(&pop, &protocol_pubkey, self.ika_address)
            .map_err(|_| E_METADATA_INVALID_POP)?;
...
pub struct ValidatorSetV1 {
    ...
    pub at_risk_validators: VecMap<IkaAddress, u64>,
    pub extra_fields: Bag,
}
...
pub struct UnverifiedValidatorOperationCapV1 {
    pub id: ObjectID,
    pub authorizer_validator_address: IkaAddress,
}
