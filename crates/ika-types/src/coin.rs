...
use crate::{base_types::ObjectID, id::UID, IKA_FRAMEWORK_ADDRESS};
use move_core_types::{
...
// Rust version of the Move ika::coin::Coin type
...
impl Coin {
    ...
    pub fn is_coin(other: &StructTag) -> bool {
        other.address == IKA_FRAMEWORK_ADDRESS
...
// Rust version of the Move ika::coin::TreasuryCap type
...
impl TreasuryCap {
    ...
    pub fn from_bcs_bytes(content: &[u8]) -> Result<Self, IkaError> {
        bcs::from_bytes(content).map_err(|err| IkaError::ObjectDeserializationError {
...
// Rust version of the Move ika::coin::CoinMetadata type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
