...
use crate::base_types::{ObjectID, IkaAddress, TransactionDigest};
...
/// A universal Ika event type encapsulating different types of events
...
impl Event {
    ...
    pub fn is_system_epoch_info_event(&self) -> bool {
        self.type_.address == IKA_SYSTEM_ADDRESS
            && self.type_.module.as_ident_str() == ident_str!("ika_system_state_inner")
