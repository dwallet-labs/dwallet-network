...
//! Module for conversions between ika-core types and ika-sdk types
//!
...
impl From<crate::base_types::IkaAddress> for Address {
    fn from(value: crate::base_types::IkaAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<Address> for crate::base_types::IkaAddress {
...
impl From<crate::base_types::IkaAddress> for ObjectId {
    fn from(value: crate::base_types::IkaAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<ObjectId> for crate::base_types::IkaAddress {
    fn from(value: ObjectId) -> Self {
        crate::base_types::ObjectID::new(value.into_inner()).into()
    }
}
