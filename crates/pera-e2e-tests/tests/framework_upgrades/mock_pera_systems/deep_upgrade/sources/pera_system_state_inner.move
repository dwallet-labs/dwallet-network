...
module pera_system::pera_system_state_inner {
    ...
    use pera_system::validator::{Validator, ValidatorV2};
    ...
    public(package) fun protocol_version(self: &PeraSystemStateInnerV2): u64 { self.protocol_version }
    public(package) fun system_state_version(self: &PeraSystemStateInnerV2): u64 { self.system_state_version }
    ...
    public(package) fun v1_to_v2(v1: PeraSystemStateInner): PeraSystemStateInnerV2 {
    ...
    fun touch_dummy_inactive_validator(self: &mut PeraSystemStateInnerV2) {
