...
/// Send a simple shared object transaction to Pera and ensures the client gets back a response.
#[sim_test]
...
/// End-to-end shared transaction test for a Pera validator. It does not test the client or wallet,
/// but tests the end-to-end flow from Pera to consensus.
#[sim_test]
