...
use ika_json_rpc_api::TRANSACTION_EXECUTION_CLIENT_ERROR_CODE;
use ika_types::traffic_control::ClientIdSource;
use ika_types::traffic_control::{PolicyConfig, Weight};
use tracing::error;

use crate::routing_layer::RpcRouter;
use ika_json_rpc_api::CLIENT_TARGET_API_VERSION_HEADER;
...
fn handle_traffic_resp(
    ...
    traffic_controller.tally(TrafficTally {
        ...
        // such as `ika_executeTransactionBlock`, as this can enable
        // node operators who wish to rate limit their transcation
        // traffic and incentivize high volume clients to choose a
        // ikatable rpc provider (or run their own). Later we may want
