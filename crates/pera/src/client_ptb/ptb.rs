...
impl PTB {
    ...
    pub async fn execute(self, context: &mut WalletContext) -> Result<(), Error> {
        ...
        let transaction_response = match transaction_response {
            PeraClientCommandResult::DryRun(_) => {
            ...
            PeraClientCommandResult::TransactionBlock(response) => response,
...
pub fn ptb_description() -> clap::Command {
    clap::Command::new("pera client ptb")
        .about(
        ...
        .arg(arg!(
            --"gas-budget" <NPERA>
            "An optional gas budget for this PTB (in NPERA). If gas budget is not provided, the \
        ...
        .long_help(
            ...
            \n --make-move-vec <pera::coin::Coin<pera::pera::PERA>> [gas]"
        )
