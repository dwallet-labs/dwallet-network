...
use pera_json_rpc_types::{PeraObjectDataOptions, PeraRawData};
use pera_sdk::apis::ReadApi;
use pera_types::{base_types::ObjectID, Identifier};
...
///
/// This function is used to render Clever Errors for on-chain errors only within the Pera CLI. This
...
pub(crate) async fn render_clever_error_opt(
    ...
    let error = 'error: {
        ...
        let PeraRawData::Package(package) = read_api
