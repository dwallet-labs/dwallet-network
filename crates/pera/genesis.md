...
This document lays out the step-by-step process for orchestrating a Pera Genesis Ceremony.
...
- An Ed25519 key can be created using `pera keytool generate`
...
$ pera genesis-ceremony add-validator \
...
```
$ pera genesis-ceremony add-gas-object \
    --address <PeraAddress> \
    --object-id <ObjectId> \
    --valud <# of pera coins>
$ git add .
...
```
$ pera genesis-ceremony verify-and-sign \
    --key-file <path to key file>
$ git add .
...
```
$ pera genesis-ceremony finalize
```
