...
pub struct WatchdogMetrics {
    ...
    pub ika_bridge_paused: IntGauge,
}
    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            total_supplies: register_int_gauge_vec_with_registry!(
                ...
                "Current total supplies of coins on Ika based on Treasury Cap",
                &["token_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            ika_bridge_paused: register_int_gauge_with_registry!(
                "bridge_ika_bridge_paused",
                "Whether the ika bridge is paused",
                registry,
            )
            .unwrap(),
        }
