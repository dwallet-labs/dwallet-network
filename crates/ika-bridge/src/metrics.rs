...
pub struct BridgeMetrics {
    pub(crate) err_build_ika_transaction: IntCounter,
    pub(crate) err_signature_aggregation: IntCounter,
    pub(crate) err_signature_aggregation_too_many_failures: IntCounter,
    pub(crate) err_ika_transaction_submission: IntCounter,
    pub(crate) err_ika_transaction_submission_too_many_failures: IntCounter,
    pub(crate) err_ika_transaction_execution: IntCounter,
    ...
    pub(crate) last_synced_ika_checkpoints: IntGaugeVec,
    pub(crate) last_finalized_eth_block: IntGauge,
    pub(crate) last_synced_eth_blocks: IntGaugeVec,

    pub(crate) ika_watcher_received_events: IntCounter,
    pub(crate) ika_watcher_received_actions: IntCounter,
    pub(crate) ika_watcher_unrecognized_events: IntCounter,
    ...
    pub(crate) ika_rpc_errors: IntCounterVec,
...
impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            err_build_ika_transaction: register_int_counter_with_registry!(
                "bridge_err_build_ika_transaction",
                "Total number of errors of building ika transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            err_ika_transaction_submission: register_int_counter_with_registry!(
                "bridge_err_ika_transaction_submission",
                "Total number of errors of submitting ika transactions",
                registry,
            )
            .unwrap(),
            err_ika_transaction_submission_too_many_failures: register_int_counter_with_registry!(
                "bridge_err_ika_transaction_submission_too_many_failures",
                "Total number of continuous failures to submitting ika transactions",
                registry,
            )
            .unwrap(),
            err_ika_transaction_execution: register_int_counter_with_registry!(
                "bridge_err_ika_transaction_execution",
                "Total number of failures of ika transaction execution",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            ika_watcher_received_events: register_int_counter_with_registry!(
                "bridge_ika_watcher_received_events",
                "Total number of received events in ika watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            ika_watcher_received_actions: register_int_counter_with_registry!(
                "bridge_ika_watcher_received_actions",
                "Total number of received actions in ika watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            ika_watcher_unrecognized_events: register_int_counter_with_registry!(
                "bridge_ika_watcher_unrecognized_events",
                "Total number of unrecognized events in ika watcher",
                registry,
            )
            .unwrap(),
            ...
            gas_coin_balance: register_int_gauge_with_registry!(
                ...
                "Current balance of gas coin, in nika",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_synced_ika_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_ika_checkpoints",
                "The latest ika checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            ika_rpc_errors: register_int_counter_vec_with_registry!(
                "bridge_ika_rpc_errors",
                "Total number of errors from ika RPC, by RPC method",
                &["method"],
                registry,
            )
            .unwrap(),
