...
pub enum BridgeError {
    ...
    // Found a bridge event but not in a recognized Ika bridge package
    BridgeEventInUnrecognizedIkaPackage,
    ...
    // Ika transaction failure due to generic error
    IkaTxFailureGeneric(String),
