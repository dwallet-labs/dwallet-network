...
fn main() {
    ...
    let access_structure =
        WeightedThresholdAccessStructure::new(3 as PartyID, weighted_parties).unwrap();

    let dpp = public_output
    ...
    for i in 1..=4 {
        let decryption_key_share = public_output
            .default_decryption_key_shares::<secp256k1::GroupElement>(i as PartyID, pk);
