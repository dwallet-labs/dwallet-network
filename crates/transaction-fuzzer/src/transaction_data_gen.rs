...
pub fn gen_gas_data(sender: IkaAddress) -> impl Strategy<Value = GasData> {
    (
...
pub fn transaction_data_gen(sender: IkaAddress) -> impl Strategy<Value = TransactionData> {
...
{
    pub fn new(sender: IkaAddress) -> Self {
        Self {
            kind: None,
            sender,
            gas_data: None,
