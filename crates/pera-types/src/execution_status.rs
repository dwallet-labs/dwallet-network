...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a PERA coin.")]
    InvalidGasObject,
    ...
    #[error(
        "Pera Move Bytecode Verification Error. \
        Please run the Pera Move Verifier for more information."
    )]
    PeraMoveVerificationError,
    ...
    #[error(
        "Pera Move Bytecode Verification Timeout. \
        Please run the Pera Move Verifier for more information."
    )]
    PeraMoveVerificationTimedout,
