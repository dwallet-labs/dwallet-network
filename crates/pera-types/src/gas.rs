...
pub mod checked {
    ...
    use crate::{
        ...
        error::{ExecutionError, PeraResult, UserInputError, UserInputResult},
        gas_model::{gas_v2::PeraGasStatus as PeraGasStatusV2, tables::GasStatus},
        object::Object,
        pera_serde::{BigInt, Readable},
    ...
    #[enum_dispatch(PeraGasStatusAPI)]
    #[derive(Debug)]
    pub enum PeraGasStatus {
    ...
    impl PeraGasStatus {
        pub fn new(
            ...
            Ok(Self::V2(PeraGasStatusV2::new_with_budget(
                gas_budget,
                gas_price,
                reference_gas_price,
                config,
        ...
        pub fn new_unmetered() -> Self {
            Self::V2(PeraGasStatusV2::new_unmetered())
        }

        // This is the only public API on PeraGasStatus, all other gas related operations should
