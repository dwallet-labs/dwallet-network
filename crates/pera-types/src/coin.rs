...
use crate::{base_types::ObjectID, id::UID, PERA_FRAMEWORK_ADDRESS};
use move_core_types::{
...
// Rust version of the Move pera::coin::Coin type
...
impl Coin {
    ...
    pub fn is_coin(other: &StructTag) -> bool {
        other.address == PERA_FRAMEWORK_ADDRESS
...
// Rust version of the Move pera::coin::TreasuryCap type
...
impl TreasuryCap {
    ...
    pub fn from_bcs_bytes(content: &[u8]) -> Result<Self, PeraError> {
        bcs::from_bytes(content).map_err(|err| PeraError::ObjectDeserializationError {
...
// Rust version of the Move pera::coin::CoinMetadata type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
