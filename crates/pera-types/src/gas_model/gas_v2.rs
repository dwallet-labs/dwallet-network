...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, PeraGasStatusAPI};
    ...
    /// A list of constant costs of various operations in Pera.
    pub struct PeraCostTable {
    ...
    impl std::fmt::Debug for PeraCostTable {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            // TODO: dump the fields.
            write!(f, "PeraCostTable(...)")
        }
    }
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Pera) for in this object.
        /// This is computed at the end of execution while determining storage charges.
        /// The value is in Pera.
    ...
    impl PeraGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let pera_cost_table = PeraCostTable::new(config, gas_price);
            let gas_rounding_step = config.gas_rounding_step_as_option();
            Self::new(
                GasStatus::new(
                    pera_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> PeraGasStatus {
            Self::new(
    ...
    impl PeraGasStatusAPI for PeraGasStatus {
