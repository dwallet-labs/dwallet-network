...
use crate::base_types::{ObjectID, PeraAddress, TransactionDigest};
...
/// A universal Pera event type encapsulating different types of events
...
/// Unique ID of a Pera Event, the ID is a combination of tx seq number and event seq number,
...
impl Event {
    ...
    pub fn is_system_epoch_info_event(&self) -> bool {
        self.type_.address == PERA_SYSTEM_ADDRESS
            && self.type_.module.as_ident_str() == ident_str!("pera_system_state_inner")
