...
use crate::{base_types::ObjectID, PERA_FRAMEWORK_ADDRESS};
...
pub const RESOLVED_PERA_ID: (&AccountAddress, &IdentStr, &IdentStr) =
    (&PERA_FRAMEWORK_ADDRESS, OBJECT_MODULE_NAME, ID_STRUCT_NAME);

/// Rust version of the Move pera::object::Info type
