...
//! Module for conversions between pera-core types and pera-sdk types
//!
...
impl From<crate::base_types::PeraAddress> for Address {
    fn from(value: crate::base_types::PeraAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<Address> for crate::base_types::PeraAddress {
...
impl From<crate::base_types::PeraAddress> for ObjectId {
    fn from(value: crate::base_types::PeraAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<ObjectId> for crate::base_types::PeraAddress {
    fn from(value: ObjectId) -> Self {
        crate::base_types::ObjectID::new(value.into_inner()).into()
    }
}
