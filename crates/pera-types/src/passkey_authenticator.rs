...
impl<'de> Deserialize<'de> for PasskeyAuthenticator {
        ...
        D: Deserializer<'de>,
    {
        ...
        serializable
            .try_into()
            .map_err(|e: PeraError| Error::custom(e.to_string()))
    }
}
...
impl Serialize for PasskeyAuthenticator {
    ...
    {
        let mut bytes = Vec::with_capacity(Secp256r1PeraSignature::LENGTH);
        ...
        let raw = RawPasskeyAuthenticator {
            ...
            user_signature: Signature::Secp256r1PeraSignature(
                Secp256r1PeraSignature::from_bytes(&bytes).unwrap(),
            ),
        };
...
impl PasskeyAuthenticator {
    ...
    pub fn get_pk(&self) -> PeraResult<PublicKey> {
...
impl AuthenticatorTrait for PasskeyAuthenticator {
        ...
        T: Serialize,
    {
        ...
        if author != PeraAddress::from(&self.get_pk()?) {
            return Err(PeraError::InvalidSignature {
