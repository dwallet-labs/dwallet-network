...
use crate::pera_system_state::pera_system_state_summary::{
...
pub struct SimTestPeraSystemStateInnerV1 {
    pub epoch: u64,
...
impl PeraSystemStateTrait for SimTestPeraSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_pera_system_state_summary(self) -> PeraSystemStateSummary {
        PeraSystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestPeraSystemStateInnerShallowV2 {
...
impl PeraSystemStateTrait for SimTestPeraSystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestPeraSystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl PeraSystemStateTrait for SimTestPeraSystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
