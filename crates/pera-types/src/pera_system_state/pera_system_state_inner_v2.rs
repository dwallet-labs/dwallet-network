...
use super::pera_system_state_inner_v1::ValidatorV1;
use super::pera_system_state_summary::{PeraSystemStateSummary, PeraValidatorSummary};
use super::{AdvanceEpochParams, PeraSystemStateTrait};
...
/// Rust version of the Move pera_system::pera_system::PeraSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct PeraSystemStateInnerV2 {
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
    pub encrypted_decryption_key_share: VecMap<u8, Vec<DwalletMPCNetworkKey>>,
...
impl PeraSystemStateTrait for PeraSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_pera_system_state_summary(self) -> PeraSystemStateSummary {
        ...
        PeraSystemStateSummary {
            ...
            stake_subsidy_period_length,
            stake_subsidy_decrease_rate,
            decryption_key_shares: encrypted_decryption_key_share
                .contents
                .iter()
