...
/// DynamicPeerValidationConfig controls what pera-node binaries that are functioning as a validator that we'll speak with.
...
fn remote_write_url() -> String {
    "http://metrics-gw.testnet.pera.io/api/v1/push".to_string()
}
