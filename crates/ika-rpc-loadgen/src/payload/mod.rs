...
use ika_types::{
    base_types::IkaAddress, digests::TransactionDigest,
...
impl Command {
    ...
    pub fn new_pay_ika() -> Self {
        Self {
            data: CommandData::PayIka(PayIka {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<IkaAddress>, chunk_size: usize) -> Self {
