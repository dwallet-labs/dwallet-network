...
use ika_storage::object_store::util::{
    find_all_dirs_with_epoch_prefix, find_all_files_with_epoch_prefix,
};
use ika_types::base_types::EpochId;
...
pub struct AnalyticsIndexerConfig {
    ...
    #[clap(
        long,
        default_value = "https://checkpoints.mainnet.ika.io",
        global = true
    )]
    ...
    #[clap(
        ...
        long,
        global = true,
        default_value = "/opt/ika/db/package_cache"
    )]
