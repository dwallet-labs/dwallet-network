...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug)]
#[diesel(table_name = pera_progress_store, primary_key(txn_digest))]
pub struct PeraProgressStore {
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug)]
#[diesel(table_name = pera_error_transactions, primary_key(txn_digest))]
pub struct PeraErrorTransactions {
    pub txn_digest: Vec<u8>,
    pub sender_address: Vec<u8>,
    pub timestamp_ms: i64,
