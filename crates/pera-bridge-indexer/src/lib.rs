...
use crate::models::{PeraErrorTransactions, TokenTransfer as DBTokenTransfer};
...
impl PeraTxnError {
    fn to_db(&self) -> PeraErrorTransactions {
        PeraErrorTransactions {
