...
#[test_only]
module pera::config_tests {

    use pera::config::{Self, Config};
    use pera::test_scenario as ts;
    ...
    fun config_create<WriteCap>(cap: &mut WriteCap, ctx: &mut TxContext) {
        pera::config::share(pera::config::new(cap, ctx))
    }
    ...
    #[test, expected_failure(abort_code = pera::config::EAlreadySetForEpoch)]
    ...
    #[test, expected_failure(abort_code = pera::config::ENotSetForEpoch)]
    ...
    #[test, expected_failure(abort_code = pera::dynamic_field::EFieldTypeMismatch)]
