...
#[test_only]
module pera::poseidon_tests {
    use pera::poseidon::poseidon_bn254;
    ...
    #[test]
    #[expected_failure(abort_code = pera::poseidon::ENonCanonicalInput)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::poseidon::EEmptyInput)]
