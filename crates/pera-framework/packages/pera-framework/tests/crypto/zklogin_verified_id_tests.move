...
#[test_only]
module pera::zklogin_verified_id_tests {
    use pera::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};
    use pera::test_scenario;

    #[test]
    #[expected_failure(abort_code = pera::zklogin_verified_id::EFunctionDisabled)]
