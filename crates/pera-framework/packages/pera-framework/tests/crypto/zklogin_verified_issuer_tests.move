...
#[test_only]
module pera::zklogin_verified_issuer_tests {
    use pera::zklogin_verified_issuer::{check_zklogin_issuer, delete, verify_zklogin_issuer, VerifiedIssuer};
    ...
    #[test]
    #[expected_failure(abort_code = pera::zklogin_verified_issuer::EInvalidProof)]
