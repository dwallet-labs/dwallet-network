...
#[test_only]
module pera::witness_policy_tests {
    use pera::witness_policy;
    use pera::transfer_policy as policy;
    use pera::transfer_policy_tests::{
        Self as test,
        Asset
    };
    ...
    #[test]
    #[expected_failure(abort_code = pera::witness_policy::ERuleNotFound)]
