...
#[test_only]
module pera::malicious_policy {
    use pera::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module pera::transfer_policy_tests {
    use pera::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    use pera::dummy_policy;
    use pera::malicious_policy;
    use pera::package;
    use pera::coin;
    ...
    #[test]
    #[expected_failure(abort_code = pera::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::transfer_policy::EIllegalRule)]
