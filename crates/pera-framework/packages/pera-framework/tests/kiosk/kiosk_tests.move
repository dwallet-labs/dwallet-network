...
module pera::kiosk_tests {
    use pera::kiosk_test_utils::{Self as test, Asset};
    use pera::pera::PERA;
    use pera::coin;
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EItemLocked)]
    ...
    fun test_purchase() {
        ...
        let payment = coin::mint_for_testing<PERA>(AMT, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::ENotListed)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EListedExclusively)]
    ...
    #[allow(unused_field)]
    public struct WrongAsset has key, store { id: pera::object::UID }

    #[test]
    #[expected_failure(abort_code = pera::kiosk::EItemNotFound)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EIncorrectAmount)]
    fun test_purchase_wrong_amount() {
        ...
        kiosk.place_and_list(&owner_cap, asset, AMT);
        let payment = coin::mint_for_testing<PERA>(AMT + 1, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EAlreadyListed)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::ENotEmpty)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::ENotEnough)]
    ...
    fun test_uid_access() {
        ...
        let uid = kiosk.uid();
        assert!(pera::object::uid_to_inner(uid) == pera::object::id(&kiosk));

        test::return_kiosk(kiosk, owner_cap, ctx);
    }

    #[test]
    #[expected_failure(abort_code = pera::kiosk::EUidAccessNotAllowed)]
