...
module pera::kiosk_borrow_tests {
    use pera::kiosk_test_utils::{Self as utils, Asset};
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::ENotOwner)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EItemIsListed)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EWrongKiosk)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::kiosk::EItemMismatch)]
