...
module pera::token_test_utils {
    use pera::coin::{Self, TreasuryCap};
    use pera::token::{Self, Token, TokenPolicy, TokenPolicyCap};
    ...
    public fun return_treasury_cap(treasury_cap: TreasuryCap<TEST>) {
        pera::transfer::public_share_object(treasury_cap)
    }
