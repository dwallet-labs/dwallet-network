...
#[test_only]
module pera::package_tests {
    use pera::package::{Self, UpgradeCap, UpgradeTicket};
    use pera::test_utils;
    ...
    fun test_upgrade_policy_reflected_in_ticket() {
        ...
        while (!policies.is_empty()) {
            ...
            let ticket = check_ticket(&mut cap, policy, pera::hash::blake2b256(&vector[policy]));
    ...
    fun test_full_upgrade_flow() {
        ...
        let ticket = cap.authorize_upgrade(
            package::dep_only_policy(),
            pera::hash::blake2b256(&b"package contents"),
        );
    ...
    #[test]
    #[expected_failure(abort_code = pera::package::ETooPermissive)]
    ...
    #[test]
    #[expected_failure(abort_code = pera::package::EAlreadyAuthorized)]
    fun test_failure_to_authorize_multiple_upgrades() {
        ...
        let _ticket0 = cap.authorize_upgrade(
            package::compatible_policy(),
            pera::hash::blake2b256(&b"package contents 0"),
        );
        ...
        let _ticket1 = cap.authorize_upgrade(
            package::compatible_policy(),
            pera::hash::blake2b256(&b"package contents 1"),
        );
    ...
    #[test]
    #[expected_failure(abort_code = pera::package::EWrongUpgradeCap)]
