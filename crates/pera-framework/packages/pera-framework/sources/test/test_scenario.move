...
module pera::test_scenario {
    ...
    /// Utility for mocking a multi-transaction Pera execution in a single Move procedure.
    ...
    public fun return_to_address<T: key>(account: address, t: T) {
        ...
        pera::transfer::transfer_impl(t, account)
    }
    ...
    public fun return_immutable<T: key>(t: T) {
        ...
        pera::transfer::freeze_object_impl(t)
    }
    ...
    public fun return_shared<T: key>(t: T) {
        ...
        pera::transfer::share_object_impl(t)
    }
    ...
    public fun receiving_ticket_by_id<T: key>(
        ...
        pera::transfer::make_receiver(object_id, version)
    }
    ...
    /// test scenario.
    public fun return_receiving_ticket<T: key>(ticket: pera::transfer::Receiving<T>) {
        let id = pera::transfer::receiving_id(&ticket);
