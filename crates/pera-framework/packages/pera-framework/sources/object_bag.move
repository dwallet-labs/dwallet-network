...
/// Similar to `pera::bag`, an `ObjectBag` is a heterogeneous map-like collection. But unlike
/// `pera::bag`, the values bound to these dynamic fields _must_ be objects themselves. This allows
