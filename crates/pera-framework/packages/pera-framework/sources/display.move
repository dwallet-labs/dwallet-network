...
module pera::display {
    ...
    /// the discovery.
    ///
    /// Since Pera RPC supports querying events by type, finding a Display for the T
...
#[test_only]
module pera::display_tests {
    use pera::test_scenario as test;
    use std::string::String;
    use pera::package;
    use pera::display;
