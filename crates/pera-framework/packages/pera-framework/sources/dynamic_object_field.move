...
/// Similar to `pera::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `pera::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module pera::dynamic_object_field {
