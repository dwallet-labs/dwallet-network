...
module pera_system::dwallet_2pc_mpc_ecdsa_k1 {
    ...
    public fun sign_uniq_metadata(
        ...
        while (i < presigns_len) {
            ...
            let uniq_test = UniqTest<UniqPresignPerMessage> {
    ...
    public fun publish_partially_signed_messages(
        ...
        assert!(messages_len == presigns_len, EExtraDataAndMessagesLenMismatch);
    ...
    public fun future_sign(
        ...
        while (i < message_approvals_len) {
            ...
            let hashed_message = vector::pop_back(&mut hashed_messages);
            let data = UniqPresignPerMessage {
                presign_id: presign_session_id,
                presign_output: presign,
            };
            event::emit(StartSignEvent<UniqPresignPerMessage> { 
                session_id: id,
                initiator: tx_context::sender(ctx),
                batched_session_id: batch_session_id,
                dwallet_id,
