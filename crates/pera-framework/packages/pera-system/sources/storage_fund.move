...
module pera_system::storage_fund {
    ...
    public struct StorageFund has store {
        total_object_storage_rebates: Balance<PERA>,
        non_refundable_balance: Balance<PERA>,
    }

    /// Called by `pera_system` at genesis time.
    public(package) fun new(initial_fund: Balance<PERA>) : StorageFund {
        StorageFund {
    ...
    /// Called by `pera_system` at epoch change times to process the inflows and outflows of storage fund.
