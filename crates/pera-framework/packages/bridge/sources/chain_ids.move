...
module bridge::chain_ids {
    ...
    // Chain IDs
    const PeraMainnet: u8 = 0;
    const PeraTestnet: u8 = 1;
    const PeraCustom: u8 = 2;
    ...
    public fun pera_mainnet(): u8 { PeraMainnet }
    public fun pera_testnet(): u8 { PeraTestnet }
    public fun pera_custom(): u8 { PeraCustom }
    ...
    public fun valid_routes(): vector<BridgeRoute> {
        vector[
            BridgeRoute { source: PeraMainnet, destination: EthMainnet },
            BridgeRoute { source: EthMainnet, destination: PeraMainnet },

            BridgeRoute { source: PeraTestnet, destination: EthSepolia },
            BridgeRoute { source: PeraTestnet, destination: EthCustom },
            BridgeRoute { source: PeraCustom, destination: EthCustom },
            BridgeRoute { source: PeraCustom, destination: EthSepolia },
            BridgeRoute { source: EthSepolia, destination: PeraTestnet },
            BridgeRoute { source: EthSepolia, destination: PeraCustom },
            BridgeRoute { source: EthCustom, destination: PeraTestnet },
            BridgeRoute { source: EthCustom, destination: PeraCustom }
        ]
    }
    ...
    #[test]
    fun test_chains_ok() {
        assert_valid_chain_id(PeraMainnet);
        assert_valid_chain_id(PeraTestnet);
        assert_valid_chain_id(PeraCustom);
    ...
    #[test]
    #[expected_failure(abort_code = EInvalidBridgeRoute)]
    fun test_pera_chains_error() {
        // this will break if we add one more pera chain id and should be corrected
    ...
    #[test]
    #[expected_failure(abort_code = EInvalidBridgeRoute)]
    fun test_routes_err_pera_1() {
        get_route(PeraMainnet, PeraMainnet);
    }

    #[test]
    #[expected_failure(abort_code = EInvalidBridgeRoute)]
    fun test_routes_err_pera_2() {
        get_route(PeraMainnet, PeraTestnet);
    }

    #[test]
    #[expected_failure(abort_code = EInvalidBridgeRoute)]
    fun test_routes_err_pera_3() {
        get_route(PeraMainnet, EthSepolia);
    }

    #[test]
    #[expected_failure(abort_code = EInvalidBridgeRoute)]
    fun test_routes_err_pera_4() {
        get_route(PeraMainnet, EthCustom);
    }
    ...
    fun test_routes_err_eth_3() {
        get_route(EthMainnet, PeraCustom);
    }

    #[test]
    #[expected_failure(abort_code = EInvalidBridgeRoute)]
    fun test_routes_err_eth_4() {
        get_route(EthMainnet, PeraTestnet);
    }
}
