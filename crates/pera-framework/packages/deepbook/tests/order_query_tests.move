...
module deepbook::order_query_tests {
    ...
    fun test_order_query_pagination() {
        ...
        let pool = test_scenario::take_shared<Pool<PERA, USD>>(&scenario);
    ...
    fun prepare_scenario(): Scenario {
        ...
        let mut pool = test_scenario::take_shared<Pool<PERA, USD>>(&scenario);
        ...
        custodian_v2::deposit(base_custodian, mint_for_testing<PERA>(1000000, ctx(&mut scenario)), account_cap_user);
    ...
    fun add_orders(order_count: u64, timestamp: u64, price: Option<u64>, scenario: &mut Scenario) {
        ...
        while (n <= order_count) {
            ...
            let mut pool = test_scenario::take_shared<Pool<PERA, USD>>(scenario);
            let clock = test_scenario::take_shared<Clock>(scenario);
            clob_v2::place_limit_order<PERA, USD>(
                &mut pool,
                CLIENT_ID_ALICE,
                price,
                200,
