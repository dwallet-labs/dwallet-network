...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_new">new</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(ctx: &<b>mut</b> TxContext): <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt; {
    <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_front">front</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): &Option&lt;K&gt; {
    &<a href="../pera-framework/table.md#0x2_table">table</a>.head
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_back">back</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): &Option&lt;K&gt; {
    &<a href="../pera-framework/table.md#0x2_table">table</a>.tail
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_push_front">push_front</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(
    <a href="../pera-framework/table.md#0x2_table">table</a>: &<b>mut</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;,
    k: K,
    value: V,
) {
    <b>let</b> old_head = <a href="../pera-framework/table.md#0x2_table">table</a>.head.swap_or_fill(k);
    <b>if</b> (<a href="../pera-framework/table.md#0x2_table">table</a>.tail.is_none()) <a href="../pera-framework/table.md#0x2_table">table</a>.tail.fill(k);
    ...
    <b>let</b> next = <b>if</b> (old_head.is_some()) {
        ...
        field::borrow_mut&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, old_head_k).prev = <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(k);
        <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(old_head_k)
    } <b>else</b> {
        <a href="../move-stdlib/option.md#0x1_option_none">option::none</a>()
    };
    field::add(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, k, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a> { prev, next, value });
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_push_back">push_back</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(
    <a href="../pera-framework/table.md#0x2_table">table</a>: &<b>mut</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;,
    k: K,
    value: V,
) {
    <b>if</b> (<a href="../pera-framework/table.md#0x2_table">table</a>.head.is_none()) <a href="../pera-framework/table.md#0x2_table">table</a>.head.fill(k);
    <b>let</b> old_tail = <a href="../pera-framework/table.md#0x2_table">table</a>.tail.swap_or_fill(k);
    <b>let</b> prev = <b>if</b> (old_tail.is_some()) {
        <b>let</b> old_tail_k = old_tail.destroy_some();
        field::borrow_mut&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, old_tail_k).next = <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(k);
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): &V {
    &field::borrow&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../pera-framework/table.md#0x2_table">table</a>.id, k).value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_borrow_mut">borrow_mut</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(
    <a href="../pera-framework/table.md#0x2_table">table</a>: &<b>mut</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;,
    k: K,
): &<b>mut</b> V {
    &<b>mut</b> field::borrow_mut&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, k).value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_prev">prev</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): &Option&lt;K&gt; {
    &field::borrow&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../pera-framework/table.md#0x2_table">table</a>.id, k).prev
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_next">next</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): &Option&lt;K&gt; {
    &field::borrow&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../pera-framework/table.md#0x2_table">table</a>.id, k).next
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_remove">remove</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<b>mut</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): V {
    <b>let</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt; { prev, next, value } = field::remove(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, k);
    <a href="../pera-framework/table.md#0x2_table">table</a>.size = <a href="../pera-framework/table.md#0x2_table">table</a>.size - 1;
    <b>if</b> (prev.is_some()) {
        field::borrow_mut&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, *prev.<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>()).next = next
    };
    <b>if</b> (next.is_some()) {
        field::borrow_mut&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../pera-framework/table.md#0x2_table">table</a>.id, *next.<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>()).prev = prev
    };
    <b>if</b> (<a href="../pera-framework/table.md#0x2_table">table</a>.head.<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>() == &k) <a href="../pera-framework/table.md#0x2_table">table</a>.head = next;
    <b>if</b> (<a href="../pera-framework/table.md#0x2_table">table</a>.tail.<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>() == &k) <a href="../pera-framework/table.md#0x2_table">table</a>.tail = prev;
    value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_pop_front">pop_front</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<b>mut</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(<a href="../pera-framework/table.md#0x2_table">table</a>.head.is_some(), <a href="../pera-framework/linked_table.md#0x2_linked_table_ETableIsEmpty">ETableIsEmpty</a>);
    <b>let</b> head = *<a href="../pera-framework/table.md#0x2_table">table</a>.head.<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>();
    (head, <a href="../pera-framework/table.md#0x2_table">table</a>.<a href="../pera-framework/linked_table.md#0x2_linked_table_remove">remove</a>(head))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_pop_back">pop_back</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<b>mut</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(<a href="../pera-framework/table.md#0x2_table">table</a>.tail.is_some(), <a href="../pera-framework/linked_table.md#0x2_linked_table_ETableIsEmpty">ETableIsEmpty</a>);
    <b>let</b> tail = *<a href="../pera-framework/table.md#0x2_table">table</a>.tail.<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">borrow</a>();
    (tail, <a href="../pera-framework/table.md#0x2_table">table</a>.<a href="../pera-framework/linked_table.md#0x2_linked_table_remove">remove</a>(tail))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_contains">contains</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): bool {
    field::exists_with_type&lt;K, <a href="../pera-framework/linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../pera-framework/table.md#0x2_table">table</a>.id, k)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_length">length</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): <a href="../move-stdlib/u64.md#0x1_u64">u64</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_is_empty">is_empty</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: &<a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): bool {
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_destroy_empty">destroy_empty</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;) {
    <b>let</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a> { id, size, head: _, tail: _ } = <a href="../pera-framework/table.md#0x2_table">table</a>;
    <b>assert</b>!(size == 0, <a href="../pera-framework/linked_table.md#0x2_linked_table_ETableNotEmpty">ETableNotEmpty</a>);
    id.delete()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_drop">drop</a>&lt;K: <b>copy</b> + drop + store, V: drop + store&gt;(<a href="../pera-framework/table.md#0x2_table">table</a>: <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;) {
    <b>let</b> <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a> { id, size: _, head: _, tail: _ } = <a href="../pera-framework/table.md#0x2_table">table</a>;
    id.delete()
}
</code></pre>
