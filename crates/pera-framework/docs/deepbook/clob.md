...
<dt>
<code>owner: <a href="../pera-framework/object.md#0x2_object_ID">object::ID</a></code>
</dt>
<dd>
...
<dt>
<code>open_orders: <a href="../pera-framework/linked_table.md#0x2_linked_table_LinkedTable">linked_table::LinkedTable</a>&lt;<a href="../move-stdlib/u64.md#0x1_u64">u64</a>, <a href="clob.md#0xdee9_clob_Order">clob::Order</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_create_account">create_account</a>(_ctx: &<b>mut</b> <a href="../pera-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="custodian.md#0xdee9_custodian_AccountCap">custodian::AccountCap</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_deposit_base">deposit_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(<a href="../pera-framework/coin.md#0x2_coin_value">coin::value</a>(&<a href="../pera-framework/coin.md#0x2_coin">coin</a>) != 0, <a href="clob.md#0xdee9_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
    <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(
        ...
        <a href="../pera-framework/object.md#0x2_object_id">object::id</a>(account_cap),
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_deposit_quote">deposit_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(<a href="../pera-framework/coin.md#0x2_coin_value">coin::value</a>(&<a href="../pera-framework/coin.md#0x2_coin">coin</a>) != 0, <a href="clob.md#0xdee9_clob_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>);
    <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_swap_exact_base_for_quote">swap_exact_base_for_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#0xdee9_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(<a href="../pera-framework/coin.md#0x2_coin_value">coin::value</a>(&base_coin) &gt;= quantity, <a href="clob.md#0xdee9_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_swap_exact_quote_for_base">swap_exact_quote_for_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob.md#0xdee9_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(<a href="../pera-framework/coin.md#0x2_coin_value">coin::value</a>(&quote_coin) &gt;= quantity, <a href="clob.md#0xdee9_clob_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_place_market_order">place_market_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>if</b> (is_bid) {
        ...
        <b>assert</b>!(quantity &lt;= <a href="../pera-framework/coin.md#0x2_coin_value">coin::value</a>(&base_coin), <a href="clob.md#0xdee9_clob_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
        <b>let</b> (base_balance_left, quote_balance_filled) = <a href="clob.md#0xdee9_clob_match_ask">match_ask</a>(
            ...
            <a href="../pera-framework/clock.md#0x2_clock_timestamp_ms">clock::timestamp_ms</a>(<a href="../pera-framework/clock.md#0x2_clock">clock</a>),
            <a href="../pera-framework/coin.md#0x2_coin_into_balance">coin::into_balance</a>(base_coin),
        );
        base_coin = <a href="../pera-framework/coin.md#0x2_coin_from_balance">coin::from_balance</a>(base_balance_left, ctx);
        join(
            &<b>mut</b> quote_coin,
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_inject_limit_order">inject_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> user = <a href="../pera-framework/object.md#0x2_object_id">object::id</a>(account_cap);
    ...
    <a href="../pera-framework/event.md#0x2_event_emit">event::emit</a>(<a href="clob.md#0xdee9_clob_OrderPlacedV2">OrderPlacedV2</a>&lt;BaseAsset, QuoteAsset&gt; {
    ...
    <b>if</b> (!contains(&pool.usr_open_orders, user)) {
        add(&<b>mut</b> pool.usr_open_orders, user, <a href="../pera-framework/linked_table.md#0x2_linked_table_new">linked_table::new</a>(ctx));
    };
    <a href="../pera-framework/linked_table.md#0x2_linked_table_push_back">linked_table::push_back</a>(borrow_mut(&<b>mut</b> pool.usr_open_orders, user), order_id, price);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_place_limit_order">place_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(quantity % pool.lot_size == 0, <a href="clob.md#0xdee9_clob_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(expire_timestamp &gt; <a href="../pera-framework/clock.md#0x2_clock_timestamp_ms">clock::timestamp_ms</a>(<a href="../pera-framework/clock.md#0x2_clock">clock</a>), <a href="clob.md#0xdee9_clob_EInvalidExpireTimestamp">EInvalidExpireTimestamp</a>);
    <b>let</b> user = <a href="../pera-framework/object.md#0x2_object_id">object::id</a>(account_cap);
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id: <a href="../pera-framework/object.md#0x2_object_ID">object::ID</a>, order: &<a href="clob.md#0xdee9_clob_Order">clob::Order</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../pera-framework/event.md#0x2_event_emit">event::emit</a>(<a href="clob.md#0xdee9_clob_OrderCanceled">OrderCanceled</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id,
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id: <a href="../pera-framework/object.md#0x2_object_ID">object::ID</a>, order: &<a href="clob.md#0xdee9_clob_Order">clob::Order</a>, base_asset_quantity_filled: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>, taker_commission: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>, maker_rebates: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../pera-framework/event.md#0x2_event_emit">event::emit</a>(<a href="clob.md#0xdee9_clob_OrderFilledV2">OrderFilledV2</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id,
        order_id: order.order_id,
        is_bid: order.is_bid,
        owner: order.owner,
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_cancel_order">cancel_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(<a href="../pera-framework/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(usr_open_orders, order_id), <a href="clob.md#0xdee9_clob_EInvalidOrderId">EInvalidOrderId</a>);
    ...
    <a href="clob.md#0xdee9_clob_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(*<a href="../pera-framework/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id), &order);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_remove_order">remove_order</a>(
    ...
    <b>assert</b>!(<a href="../pera-framework/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(&tick_level.open_orders, order_id), <a href="clob.md#0xdee9_clob_EInvalidOrderId">EInvalidOrderId</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_cancel_all_orders">cancel_all_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> user = <a href="../pera-framework/object.md#0x2_object_id">object::id</a>(account_cap);
    <b>assert</b>!(contains(&pool.usr_open_orders, user), <a href="clob.md#0xdee9_clob_EInvalidUser">EInvalidUser</a>);
    <b>let</b> usr_open_order_ids = <a href="../pera-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> pool.usr_open_orders, user);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_list_open_orders">list_open_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> user = <a href="../pera-framework/object.md#0x2_object_id">object::id</a>(account_cap);
    <b>let</b> usr_open_order_ids = <a href="../pera-framework/table.md#0x2_table_borrow">table::borrow</a>(&pool.usr_open_orders, user);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_get_order_status">get_order_status</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> user = <a href="../pera-framework/object.md#0x2_object_id">object::id</a>(account_cap);
    <b>assert</b>!(<a href="../pera-framework/table.md#0x2_table_contains">table::contains</a>(&pool.usr_open_orders, user), <a href="clob.md#0xdee9_clob_EInvalidUser">EInvalidUser</a>);
    <b>let</b> usr_open_order_ids = <a href="../pera-framework/table.md#0x2_table_borrow">table::borrow</a>(&pool.usr_open_orders, user);
    <b>assert</b>!(<a href="../pera-framework/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(usr_open_order_ids, order_id), <a href="clob.md#0xdee9_clob_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> order_price = *<a href="../pera-framework/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(usr_open_order_ids, order_id);
    <b>let</b> open_orders =
