...
-  [Function `pera_mainnet`](#0xb_chain_ids_pera_mainnet)
-  [Function `pera_testnet`](#0xb_chain_ids_pera_testnet)
-  [Function `pera_custom`](#0xb_chain_ids_pera_custom)
...
<a name="0xb_chain_ids_PeraCustom"></a>



<pre><code><b>const</b> <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a>: u8 = 2;
</code></pre>



<a name="0xb_chain_ids_PeraMainnet"></a>



<pre><code><b>const</b> <a href="chain_ids.md#0xb_chain_ids_PeraMainnet">PeraMainnet</a>: u8 = 0;
</code></pre>



<a name="0xb_chain_ids_PeraTestnet"></a>



<pre><code><b>const</b> <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a>: u8 = 1;
</code></pre>



<a name="0xb_chain_ids_pera_mainnet"></a>

## Function `pera_mainnet`



<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_pera_mainnet">pera_mainnet</a>(): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_pera_mainnet">pera_mainnet</a>(): u8 { <a href="chain_ids.md#0xb_chain_ids_PeraMainnet">PeraMainnet</a> }
</code></pre>
...
<a name="0xb_chain_ids_pera_testnet"></a>

## Function `pera_testnet`



<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_pera_testnet">pera_testnet</a>(): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_pera_testnet">pera_testnet</a>(): u8 { <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a> }
</code></pre>
...
<a name="0xb_chain_ids_pera_custom"></a>

## Function `pera_custom`



<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_pera_custom">pera_custom</a>(): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_pera_custom">pera_custom</a>(): u8 { <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a> }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_assert_valid_chain_id">assert_valid_chain_id</a>(id: u8) {
    <b>assert</b>!(
        id == <a href="chain_ids.md#0xb_chain_ids_PeraMainnet">PeraMainnet</a> ||
        id == <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a> ||
        id == <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a> ||
...
<pre><code><b>public</b> <b>fun</b> <a href="chain_ids.md#0xb_chain_ids_valid_routes">valid_routes</a>(): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a>&gt; {
    <a href="../move-stdlib/vector.md#0x1_vector">vector</a>[
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_PeraMainnet">PeraMainnet</a>, destination: <a href="chain_ids.md#0xb_chain_ids_EthMainnet">EthMainnet</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_EthMainnet">EthMainnet</a>, destination: <a href="chain_ids.md#0xb_chain_ids_PeraMainnet">PeraMainnet</a> },

        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a>, destination: <a href="chain_ids.md#0xb_chain_ids_EthSepolia">EthSepolia</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a>, destination: <a href="chain_ids.md#0xb_chain_ids_EthCustom">EthCustom</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a>, destination: <a href="chain_ids.md#0xb_chain_ids_EthCustom">EthCustom</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a>, destination: <a href="chain_ids.md#0xb_chain_ids_EthSepolia">EthSepolia</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_EthSepolia">EthSepolia</a>, destination: <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_EthSepolia">EthSepolia</a>, destination: <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_EthCustom">EthCustom</a>, destination: <a href="chain_ids.md#0xb_chain_ids_PeraTestnet">PeraTestnet</a> },
        <a href="chain_ids.md#0xb_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="chain_ids.md#0xb_chain_ids_EthCustom">EthCustom</a>, destination: <a href="chain_ids.md#0xb_chain_ids_PeraCustom">PeraCustom</a> }
    ]
}
</code></pre>
