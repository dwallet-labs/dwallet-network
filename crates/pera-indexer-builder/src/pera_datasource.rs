...
pub struct PeraCheckpointDatasource {
    remote_store_url: String,
    concurrency: usize,
    checkpoint_path: PathBuf,
    metrics: DataIngestionMetrics,
}
impl PeraCheckpointDatasource {
    pub fn new(
        remote_store_url: String,
        concurrency: usize,
        checkpoint_path: PathBuf,
...
#[async_trait]
impl Datasource<CheckpointTxnData> for PeraCheckpointDatasource {
...
impl Worker for IndexerWorker<CheckpointTxnData> {
    async fn process_checkpoint(&self, checkpoint: PeraCheckpointData) -> anyhow::Result<()> {
        info!(
            "Received checkpoint [{}] {}: {}",
