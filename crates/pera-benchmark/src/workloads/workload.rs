...
pub const MAX_GAS_FOR_TESTING: u64 = 1_000 * NPERA_PER_PERA;

// TODO: get this information from protocol config
// This is the maximum budget that can be set for a transaction. 50 PERA.
pub const MAX_BUDGET: u64 = 50 * NPERA_PER_PERA;
