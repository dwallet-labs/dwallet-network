...
use pera_types::base_types::{random_object_ref, ObjectRef};
...
use pera_types::{base_types::ObjectID, object::Owner};
use pera_types::{base_types::PeraAddress, crypto::get_key_pair, transaction::Transaction};
use pera_types::{transaction::TransactionData, utils::to_sender_signed_transaction};
use tracing::debug;
...
impl Payload for AdversarialTestPayload {
    fn make_new_payload(&mut self, effects: &ExecutionEffects) {
        ...
        let stat = match effects {
            ...
            ExecutionEffects::PeraTransactionBlockEffects(_) => unimplemented!("Not impl"),
        };
