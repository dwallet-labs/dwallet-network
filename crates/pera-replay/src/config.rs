...
pub const DEFAULT_CONFIG_PATH: &str = "~/.pera-replay/network-config.yaml";
...
impl Default for ReplayableNetworkConfigSet {
    fn default() -> Self {
        let testnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.testnet.pera.io:443")
        ...
        let devnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_start_timestamp: 0,
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.devnet.pera.io:443")
                .expect("invalid socket address")
                .to_string(),
        };
        let mainnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_start_timestamp: 0,
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.mainnet.pera.io:443")
                .expect("invalid socket address")
                .to_string(),
        };
