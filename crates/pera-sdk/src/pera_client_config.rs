...
pub struct PeraClientConfig {
    pub keystore: Keystore,
    pub envs: Vec<PeraEnv>,
    pub active_env: Option<String>,
    pub active_address: Option<PeraAddress>,
}

impl PeraClientConfig {
    ...
    pub fn get_env(&self, alias: &Option<String>) -> Option<&PeraEnv> {
    ...
    pub fn get_active_env(&self) -> Result<&PeraEnv, anyhow::Error> {
    ...
    pub fn add_env(&mut self, env: PeraEnv) {
        if !self
            .envs
            .iter()
...
impl PeraEnv {
    ...
    ) -> Result<PeraClient, anyhow::Error> {
        let mut builder = PeraClientBuilder::default();
    ...
    pub fn localnet() -> Self {
        Self {
            ...
            rpc: PERA_LOCAL_NETWORK_URL.into(),
            ws: None,
            basic_auth: None,
        }
    }
...
impl Config for PeraClientConfig {}

impl Display for PeraClientConfig {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let mut writer = String::new();
