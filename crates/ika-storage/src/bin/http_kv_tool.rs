...
enum Command {
    Fetch {
        // default value of 'https://transactions.ika.io/'
        #[arg(short, long, default_value = "https://transactions.ika.io/mainnet")]
        base_url: String,
    ...
    async fn execute(self) -> anyhow::Result<(), anyhow::Error> {
        match self {
            ...
            Command::DecodeKey { url } => {
                // url may look like
                // https://transactions.ika.io/mainnet/jlkqmZbVuunngIyy2vjBOJSETrM56EH_kIc5wuLvDydN_x0GAAAAAA/ob
