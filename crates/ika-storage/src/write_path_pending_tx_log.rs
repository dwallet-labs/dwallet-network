...
use ika_types::crypto::EmptySignInfo;
use ika_types::error::{IkaError, IkaResult};
use ika_types::message_envelope::TrustedEnvelope;
use ika_types::transaction::{SenderSignedData, VerifiedTransaction};
...
impl WritePathPendingTransactionLog {
    ...
    pub fn finish_transaction(&self, tx: &TransactionDigest) -> IkaResult {
        ...
        write_batch.write().map_err(IkaError::from)
    }
