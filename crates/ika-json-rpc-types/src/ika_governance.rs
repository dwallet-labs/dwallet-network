...
use ika_types::base_types::{AuthorityName, EpochId, ObjectID, IkaAddress};
...
impl From<Committee> for IkaCommittee {
...
pub struct DelegatedStake {
    /// Validator's Address.
    pub validator_address: IkaAddress,
