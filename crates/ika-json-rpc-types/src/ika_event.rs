...
use ika_types::event::{Event, EventEnvelope, EventID};
...
pub type EventPage = Page<IkaEvent, EventID>;
...
impl From<EventEnvelope> for IkaEvent {
...
impl From<IkaEvent> for Event {
    fn from(val: IkaEvent) -> Self {
        Event {
...
impl Filter<IkaEvent> for EventFilter {
    fn matches(&self, item: &IkaEvent) -> bool {
