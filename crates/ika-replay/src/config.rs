...
pub const DEFAULT_CONFIG_PATH: &str = "~/.ika-replay/network-config.yaml";
...
impl Default for ReplayableNetworkConfigSet {
    fn default() -> Self {
        let testnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.testnet.ika.io:443")
        ...
        let devnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_start_timestamp: 0,
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.devnet.ika.io:443")
                .expect("invalid socket address")
                .to_string(),
        };
        let mainnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_start_timestamp: 0,
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.mainnet.ika.io:443")
                .expect("invalid socket address")
                .to_string(),
        };
