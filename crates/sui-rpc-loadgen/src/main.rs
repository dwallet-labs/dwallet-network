...
pub enum ClapCommand {
    ...
    #[arg(name = "query-transaction-blocks")]
    ...
    #[arg(name = "multi-get-transaction-blocks")]
    MultiGetTransactionBlocks {
        #[command(flatten)]
        common: CommonOptions,
    },
    #[arg(name = "multi-get-objects")]
    MultiGetObjects {
        #[command(flatten)]
        common: CommonOptions,
    },
    ...
    #[arg(name = "get-reference-gas-price")]
