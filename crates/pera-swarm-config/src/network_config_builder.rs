...
use pera_types::base_types::{AuthorityName, PeraAddress};
use pera_types::committee::{Committee, ProtocolVersion};
use pera_types::crypto::{get_key_pair_from_rng, AccountKeyPair, KeypairTraits, PublicKey};
...
impl<R: rand::RngCore + rand::CryptoRng> ConfigBuilder<R> {
    ...
    pub fn build(self) -> NetworkConfig {
        ...
        let genesis = {
            let mut builder = pera_genesis_builder::Builder::new()
