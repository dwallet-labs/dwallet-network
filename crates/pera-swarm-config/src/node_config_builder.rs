...
use pera_types::crypto::{AuthorityKeyPair, AuthorityPublicKeyBytes, NetworkKeyPair, PeraKeyPair};
...
impl ValidatorConfigBuilder {
    ...
    pub fn build(
        ...
        genesis: pera_config::genesis::Genesis,
    ) -> NodeConfig {
        ...
        NodeConfig {
            max_active_dwallet_mpc_instances: DEFAULT_MAX_ACTIVE_DWALLET_MPC_SESSIONS,
            ...
            genesis: pera_config::node::Genesis::new(genesis),
            grpc_load_shed: None,
    ...
    pub fn with_network_key_pair(mut self, network_key_pair: Option<NetworkKeyPair>) -> Self {
        if let Some(network_key_pair) = network_key_pair {
            self.network_key_pair =
                Some(KeyPairWithPath::new(PeraKeyPair::Ed25519(network_key_pair)));
        }
        self
    }
    ...
    pub fn build<R: rand::RngCore + rand::CryptoRng>(
        ...
        NodeConfig {
            ...
            network_key_pair: self.network_key_pair.unwrap_or(KeyPairWithPath::new(
                PeraKeyPair::Ed25519(validator_config.network_key_pair),
            )),
            db_path: self
                .db_path
            ...
            remove_deprecated_tables: false,
            enable_index_processing: default_enable_index_processing(),
            genesis: self.genesis.unwrap_or(pera_config::node::Genesis::new(
