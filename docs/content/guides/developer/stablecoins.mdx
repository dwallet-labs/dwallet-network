...
On Ika, you can interact with various stablecoins such as USDC, USDT, Agora, and Ondo USDY.
...
For more detailed information on how to interact with USDC on Ika, refer to the [USDC guide](#usdc-guide).
...
USDT is currently not issued natively on Ika. For more information on bridging USDT to Ika, refer to [IKA Bridging](../../concepts/tokenomics/ika-bridging.mdx).
...
## How to transfer USDC on Ika {#usdc-guide}
...
Here's a quickstart guide for developers to build an app to perform their first USDC transfer on Ika.

### Contract addresses

- [Testnet](https://ikascan.xyz/testnet/coin/0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC)
  ```
  0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC
  ```
- [Mainnet](https://ikascan.xyz/coin/0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC)
  ```
...
- [Ika Wallet](https://chromewebstore.google.com/detail/ika-wallet/opcgpfmipidbgpenhmajoajpbobppdil): Install the Ika Wallet browser extension, set up your wallet, and connect it to the appropriate network. Ensure that your wallet is funded with:
  - Some IKA tokens to cover transaction fees. (**Request Testnet IKA Tokens** from the **Wallet Settings** page)
...
Install Ika dependencies next:

```bash
pnpm add @mysten/dapp-kit @ika-io/ika @tanstack/react-query
```
...
1. Click the **Request Testnet IKA Tokens** button from your Ika Wallet to source gas tokens. The button is visible only when your wallet is connected to Testnet.
