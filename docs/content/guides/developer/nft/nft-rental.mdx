...
- [Ika Kiosk](../../../standards/kiosk.mdx): Kiosk is a decentralized system for commerce applications on Ika.
- [Kiosk Apps](../../../standards/kiosk-apps.mdx): The Kiosk Apps standard extends the functionality of Ika Kiosk.  
