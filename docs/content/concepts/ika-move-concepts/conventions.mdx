---
title: Conventions
description: Recommended Move 2024 best practices for the Ika blockchain.
---
...
module conventions::wallet {
    ...
    public fun destroy_empty(self: Wallet<Balance<IKA>>) {
...
module conventions::access_control {
    ...
    public fun withdraw(state: &mut State, account: &mut Account, ctx: &mut TxContext): Coin<IKA> {
    ...
    public fun wrong_withdraw(state: &mut State, ctx: &mut TxContext): Coin<IKA> {
...
module conventions::vesting_wallet {
    ...
    */
    public fun new(deposit: Coin<IKA>, ctx: &mut TxContext): OwnedWallet {
        // Implementation omitted.
        abort(0)
    }
    ...
    */
    public fun new_shared(deposit: Coin<IKA>, ctx: &mut TxContext) {
        // Implementation omitted.
