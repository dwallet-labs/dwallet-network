---
title: Ika Storage Cost
description: Historical data and the pricing of your storage solutions provide insights into the cost of your operations on the Ika network.
---
...
Compute is a relatively fixed cost for Ika, with hundreds of validators running 24 Core, 128GB RAM machines.

Because Ika is capable of such high throughput compared to other blockchains, the storage costs of running the Ika network aren't as precise.
...
- [Custom Indexers](../../guides/developer/advanced/custom-indexer.mdx): Build custom indexers using the Ika micro-data ingestion framework.
...
- [Ika Archives](../../guides/operator/archives.mdx): Enable archiving on your Full nodes for a historical record of all transactions on Ika.