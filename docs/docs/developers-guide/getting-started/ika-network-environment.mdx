# Ika Environment Setup

**_Note:_** the name of the previous version (dWallet Network) will be updated to Ika soon.
...
You can interact with the Ika network using the dWallet CLI.
For more details about using the dWallet CLI, see [Install dWallet](./install-dwallet.mdx) reference.
