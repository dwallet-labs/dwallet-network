...
Make sure you have this directory in your system's `PATH` environment variable:
...
you can update them to the most recent by repeating the installation process above.
