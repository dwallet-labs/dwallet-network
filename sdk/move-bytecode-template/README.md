...
customized and used to publish new modules on Pera directly in the browser. Hence, removing the need
...
[Move by Example](https://examples.pera.io/samples/coin.html) book.
