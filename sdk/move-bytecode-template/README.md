...
customized and used to publish new modules on Ika directly in the browser. Hence, removing the need
...
[Move by Example](https://examples.ika.io/samples/coin.html) book.
