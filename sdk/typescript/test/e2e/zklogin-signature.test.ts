...
describe('zkLogin signature', () => {
	...
	it(
		...
		async () => {
			...
			// test case generated from `pera keytool zk-login-insecure-sign-personal-message --data "hello" --max-epoch 3`
			...
			// test case generated from `pera keytool zk-login-insecure-sign-personal-message --data "hello" --max-epoch 100`
