...
import type { PeraGraphQLClient } from '../graphql/client.js';
...
export class MultiSigPublicKey extends PublicKey {
	...
	/**
	 * Return the Pera address associated with this MultiSig public key
	 */
	override toPeraAddress(): string {
		...
		return normalizePeraAddress(bytesToHex(blake2b(tmp.slice(0, i), { dkLen: 32 })));
	}
