...
import { isValidPeraAddress, normalizePeraAddress } from '../../utils/pera-types.js';
...
export const PeraAddress = pipe(
	string(),
	transform((value) => normalizePeraAddress(value)),
	check(isValidPeraAddress),
);
export const ObjectID = PeraAddress;
...
// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/base_types.rs#L138
// Implemented as a tuple in rust
export const ObjectRef = object({
	objectId: PeraAddress,
	version: JsonU64,
	digest: string(),
});
export type ObjectRef = InferOutput<typeof ObjectRef>;

// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/transaction.rs#L690-L702
...
// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/transaction.rs#L1387-L1392
export const GasData = object({
	budget: nullable(JsonU64),
	price: nullable(JsonU64),
	owner: nullable(PeraAddress),
...
// https://github.com/MystenLabs/sui/blob/cea8742e810142a8145fd83c4c142d61e561004a/crates/pera-graphql-rpc/schema/current_progress_schema.graphql#L1614-L1627
...
// https://github.com/MystenLabs/sui/blob/cea8742e810142a8145fd83c4c142d61e561004a/crates/pera-graphql-rpc/schema/current_progress_schema.graphql#L1609-L1612
...
// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/transaction.rs#L707-L718
...
// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/transaction.rs#L657-L685
...
// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/transaction.rs#L102-L114
...
// https://github.com/MystenLabs/sui/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/pera-types/src/transaction.rs#L75-L80
