...
export interface ExecuteTransactionBlockParams {
	...
	options?: RpcTypes.PeraTransactionBlockResponseOptions | null | undefined;
...
export interface GetObjectParams {
	...
	id: string;
	/** options for specifying the content to be returned */
	options?: RpcTypes.PeraObjectDataOptions | null | undefined;
}
/**
...
export interface GetBalanceParams {
	 ...
	 * default to 0x2::pera::PERA if not specified.
	 */
...
export interface GetLatestPeraSystemStateParams {}
/**
 ...
 * been updated when the next page is fetched. Please use perax_queryObjects if this is a concern.
 */
export type GetOwnedObjectsParams = {
	...
	limit?: number | null | undefined;
} & RpcTypes.PeraObjectResponseQuery;
...
export interface QueryEventsParams {
	/**
	 * The event query criteria. See [Event filter](https://docs.pera.io/build/event_api#event-filters)
	 * documentation for examples.
	 */
	query: RpcTypes.PeraEventFilter;
	/** optional paging cursor */
...
export type QueryTransactionBlocksParams = {
	...
	/** query result ordering, default to false (ascending order), oldest record first. */
	order?: 'ascending' | 'descending' | null | undefined;
} & RpcTypes.PeraTransactionBlockResponseQuery;
...
export interface SubscribeEventParams {
	 ...
	 * [Event filter](https://docs.pera.io/build/event_api#event-filters) documentation for examples.
	 */
	filter: RpcTypes.PeraEventFilter;
}
...
export interface UnsafeBatchTransactionParams {
	...
	txnBuilderMode?: RpcTypes.PeraTransactionBlockBuilderMode | null | undefined;
}
...
export interface UnsafeMoveCallParams {
	...
	/**
	 * the arguments to be passed into the Move function, in [PeraJson](https://docs.pera.io/build/pera-json)
	 * format
	 */
	arguments: unknown[];
	/**
	 ...
	 * `PeraTransactionBlockBuilderMode::Commit` when it's None.
	 */
	executionMode?: RpcTypes.PeraTransactionBlockBuilderMode | null | undefined;
}
/**
...
/**
 * Send all PERA coins to one recipient. This is for PERA coin only and does not require a separate gas
 * coin object. Specifically, what pay_all_pera does are: 1. accumulate all PERA from input coins and
 * deposit all PERA to the first input coin 2. transfer the updated first coin to the recipient and also
 ...
 */
export interface UnsafePayAllPeraParams {
	/** the transaction signer's Pera address */
	signer: string;
...
/**
 * Send PERA coins to a list of addresses, following a list of amounts. This is for PERA coin only and
 * does not require a separate gas coin object. Specifically, what pay_pera does are: 1. debit each
 * input_coin to create new coin following the order of amounts and assign it to the corresponding
 * recipient. 2. accumulate all residual PERA from input coins left and deposit all PERA to the first
 ...
 */
export interface UnsafePayPeraParams {
	/** the transaction signer's Pera address */
	signer: string;
	/** the Pera coins to be used in this transaction, including the coin for gas payment. */
	inputCoins: string[];
...
/**
 * Create an unsigned transaction to send PERA coin object to a Pera address. The PERA object is also used
 * as the gas object.
 */
export interface UnsafeTransferPeraParams {
	/** the transaction signer's Pera address */
	signer: string;
