...
class TypeTagSerializer {
    static parseFromStr(str, normalizeAddress = false) {
        ...
        if (structMatch) {
            const address = normalizeAddress ? (0, sui_types_js_1.normalizeSuiAddress)(structMatch[1]) : structMatch[1];
            return {
                struct: {
                    address,
    ...
    static parseStructTypeArgs(str, normalizeAddress = false) {
        return (0, bcs_1.splitGenericParameters)(str).map((tok) => TypeTagSerializer.parseFromStr(tok, normalizeAddress));
    }
