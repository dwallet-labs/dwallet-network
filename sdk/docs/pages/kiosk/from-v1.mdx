...
const createKiosk = async () => {
	const accountAddress = '0xSomePeraAddress';
...
const placeAndListToKiosk = async () => {
	...
	kioskTx.shareAndTransferCap('0xSomePeraAddress').finalize();
...
// Attaches a royalty rule of 1% or 0.1 PERA (whichever is bigger)
...
const attachStrongRoyalties = async () => {
	...
	const minAmount = 100_000_000; // 0.1 PERA.
