...
Kiosk SDK is a tool to interact with Ika/Mysten Kiosk. You can use it to query kiosk related data,
...
state of `IkaClient`, `Network`, and the rules and package IDs for interacting with Mysten Kiosk
extension.
