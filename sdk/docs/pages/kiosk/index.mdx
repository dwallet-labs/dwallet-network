...
Kiosk SDK is a tool to interact with Pera/Mysten Kiosk. You can use it to query kiosk related data,
...
state of `PeraClient`, `Network`, and the rules and package IDs for interacting with Mysten Kiosk
extension.
