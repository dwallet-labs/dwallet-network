...
The Ika TypeScript SDK provides a `MultiSigPublicKey` class to support
[Multi-Signature](https://docs.ika.io/concepts/cryptography/transaction-auth/multisig) (MultiSig)
...
transaction is equal to or greater than the threshold value, then the Ika network considers the
transdaction valid.
