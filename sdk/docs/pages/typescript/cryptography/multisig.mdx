...
The Pera TypeScript SDK provides a `MultiSigPublicKey` class to support
[Multi-Signature](https://docs.pera.io/concepts/cryptography/transaction-auth/multisig) (MultiSig)
...
transaction is equal to or greater than the threshold value, then the Pera network considers the
transdaction valid.
