# Paying for Pera Transactions with Gas Coins

With Programmable Transactions, you can use the gas payment coin to construct coins with a set
balance using `splitCoin`. This is useful for Pera payments, and avoids the need for up-front coin
...
[by-reference](https://docs.pera.io/guides/developer/pera-101/simulating-refs). Practically speaking,
...
**Note:** The gas budget is represented in Pera, and should take the gas price of the transaction
into account.
