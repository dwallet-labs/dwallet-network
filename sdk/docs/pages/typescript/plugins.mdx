...
[TransactionDataBuilder](/typedoc/classes/_mysten_ika.transactions.TransactionDataBuilder.html)
...
properties in the
[typedoc definition](/typedoc/classes/_mysten_ika.transactions.TransactionDataBuilder.html).
...
```typescript
import { Commands, Transaction } from '@ika-io/ika/transactions';
...
```typescript
import { Commands, Transaction, TransactionObjectInput } from '@ika-io/ika/transactions';
