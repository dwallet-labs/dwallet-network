...
default coin selection logic, which uses all the `0x2::coin::Coin<0x2::dwlt::DWLT>` objects owned by
...
`0x2::coin::Coin<0x2::dwlt::DWLT>` in your wallet for each transaction that you need to execute in
