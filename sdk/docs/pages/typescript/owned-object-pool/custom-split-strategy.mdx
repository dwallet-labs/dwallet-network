...
`0x2::coin::Coin<0x2::ika::IKA>`) from the `mainPool` that their sum of balances surpasses a minimum
...
[`splitStrategies.ts` file](https://github.com/MystenLabs/Ika_Owned_Object_Pools/blob/main/src/splitStrategies.ts).
