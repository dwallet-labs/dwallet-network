...
`0x2::coin::Coin<0x2::pera::PERA>`) from the `mainPool` that their sum of balances surpasses a minimum
...
[`splitStrategies.ts` file](https://github.com/MystenLabs/Pera_Owned_Object_Pools/blob/main/src/splitStrategies.ts).
