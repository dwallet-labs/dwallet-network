...
- 437f0ca2ef: Add isPeraChain utility which is useful for type-safe dApp interfaces in wallets
...
- 0a7b42a6d: This changes almost all occurences of "delegate", "delegation" (and various
  ...
  convention.
- c718deef4: wallet-standard: changes pera:signAndExecuteTransaction and pera:signTransaction features
...
- dbe73d5a4: Add an optional `contentOptions` field to `PeraSignAndExecuteTransactionOptions` to
  specify which fields to include in `PeraTransactionBlockResponse` (e.g., transaction, effects,
