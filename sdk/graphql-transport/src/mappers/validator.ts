...
import type { PeraValidatorSummary } from '@pera-io/pera/client';
...
export function mapGraphQlValidatorToRpcValidator(
	...
	return {
		...
		pendingTotalPeraWithdraw: validator.pendingTotalPeraWithdraw,
		...
		stakingPoolPeraBalance: validator.stakingPoolPeraBalance,
		peraAddress: validator.address.address,
