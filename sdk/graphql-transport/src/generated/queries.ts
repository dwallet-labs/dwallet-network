...
export type Scalars = {
  ...
  /** String containing 32B hex-encoded address, with a leading "0x". Leading zeroes can be omitted on input but will always appear in outputs (IkaAddress in output is guaranteed to be 66 characters long). */
  IkaAddress: { input: any; output: any; }
  /**
...
export type ActiveJwk = {
  ...
  epoch?: Maybe<Epoch>;
  /** The string (Isikang Authority) that identifies the OIDC provider. */
...
export type Address = IOwner & {
   ...
   *
   * `type` is a filter on the coin's type parameter, defaulting to `0x2::ika::IKA`.
   */
  coins: CoinConnection;
  /** The domain explicitly configured as the default domain pointing to this address. */
  defaultIkansName?: Maybe<Scalars['String']['output']>;
  /** Objects owned by this address, optionally `filter`-ed. */
  objects: MoveObjectConnection;
  /** The `0x3::staking_pool::StakedIka` objects owned by this address. */
  stakedIkas: StakedIkaConnection;
  /**
   * The IkansRegistration NFTs owned by this address. These grant the owner the capability to
   * manage the associated domain.
   */
  ikansRegistrations: IkansRegistrationConnection;
  /**
...
/** The 32-byte address that is an account address (corresponding to a public key). */
export type AddressDefaultIkansNameArgs = {
...
/** The 32-byte address that is an account address (corresponding to a public key). */
export type AddressStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The 32-byte address that is an account address (corresponding to a public key). */
export type AddressIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type Balance = {
  ...
  /** Coin type for the balance, such as 0x2::ika::IKA */
  coinType: MoveType;
...
export type BalanceChange = {
  ...
  /** The inner type of the coin whose balance has changed (e.g. `0x2::ika::IKA`). */
...
export type ChangeEpochTransaction = {
  ...
  /** The total amount of gas charged for computation during the previous epoch (in NIKA). */
   ...
   * the relevant objects are cleaned up (in NIKA).
   */
  ...
  /** The total amount of gas charged for storage during the previous epoch (in NIKA). */
  storageCharge: Scalars['BigInt']['output'];
  /** The IKA returned to transaction senders for cleaning up objects (in NIKA). */
...
export type Coin = IMoveObject & IObject & IOwner & {
   ...
   * transaction command or `ika::transfer::public_transfer`, both of which require the object to
  ...
  /** The `0x3::staking_pool::StakedIka` objects owned by this object. */
  stakedIkas: StakedIkaConnection;
  /**
  ...
  status: ObjectKind;
  /**
   * The amount of IKA we would rebate if this object gets deleted or mutated. This number is
   * recalculated based on the present storage gas price.
   */
  storageRebate?: Maybe<Scalars['BigInt']['output']>;
  /**
   * The IkansRegistration NFTs owned by this object. These grant the owner the capability to
   * manage the associated domain.
   */
  ikansRegistrations: IkansRegistrationConnection;
...
/** Some 0x2::coin::Coin Move object. */
export type CoinDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
...
/** Some 0x2::coin::Coin Move object. */
export type CoinStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Some 0x2::coin::Coin Move object. */
export type CoinIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The metadata for a coin type. */
export type CoinMetadataDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
...
/** The metadata for a coin type. */
export type CoinMetadataStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The metadata for a coin type. */
export type CoinMetadataIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
 ...
 * 2) Dynamic Object Fields values must be Ika objects (have the `key` and `store`
...
/**
 * Operation of the Ika network is temporally partitioned into non-overlapping epochs,
...
export type Epoch = {
  ...
  startTimestamp: Scalars['DateTime']['output'];
  /**
   * IKA set aside to account for objects stored on-chain, at the start of the epoch.
  ...
  /**
   * The value of the `version` field of `0x5`, the `0x3::ika::IkaSystemState` object.  This
  ...
  /** The total amount of gas fees (in NIKA) that were paid in this epoch. */
  totalGasFees?: Maybe<Scalars['BigInt']['output']>;
  /** The total NIKA rewarded as stake. */
...
export enum Feature {
  ...
  /** IkaNS name and reverse name look-up. */
...
export type GasCostSummary = {
  ...
  /** Gas paid for executing this transaction (in NIKA). */
  ...
  /** Gas paid for the data stored on-chain by this transaction (in NIKA). */
...
export type IMoveObject = {
   ...
   */
  dynamicObjectField?: Maybe<DynamicField>;
  /** Determines whether a transaction can transfer this object, using the TransferObjects transaction command or `ika::transfer::public_transfer`, both of which require the object to have the `key` and `store` abilities. */
  hasPublicTransfer: Scalars['Boolean']['output'];
};
...
export type IOwner = {
  address: Scalars['IkaAddress']['output'];
  /** Total balance of all coins with marker type owned by this object or address. If type is not supplied, it defaults to `0x2::ika::IKA`. */
  balance?: Maybe<Balance>;
  ...
  objects: MoveObjectConnection;
  /** The `0x3::staking_pool::StakedIka` objects owned by this object or address. */
  stakedIkas: StakedIkaConnection;
  /** The IkansRegistration NFTs owned by this object or address. These grant the owner the capability to manage the associated domain. */
  ikansRegistrations: IkansRegistrationConnection;
};
 ...
 * possible to know which up-front.
 */
export type IOwnerDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
 ...
 * possible to know which up-front.
 */
export type IOwnerStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
 ...
 * possible to know which up-front.
 */
export type IOwnerIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Abilities are keywords in Ika Move that define how types behave at the compiler level. */
...
export type MoveCallTransaction = {
  ...
  package: Scalars['IkaAddress']['output'];
...
export type MoveObject = IMoveObject & IObject & IOwner & {
  ...
  /** Attempts to convert the Move object into a `0x3::staking_pool::StakedIka`. */
  asStakedIka?: Maybe<StakedIka>;
  /** Attempts to convert the Move object into a `IkansRegistration` object. */
  asIkansRegistration?: Maybe<IkansRegistration>;
  /**
   * Total balance of all coins with marker type owned by this object. If type is not supplied,
   * it defaults to `0x2::ika::IKA`.
   */
 ...
 * (content, module that governs it, version, is transferrable, etc.) about this object.
 */
export type MoveObjectDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
 ...
 * (content, module that governs it, version, is transferrable, etc.) about this object.
 */
export type MoveObjectStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
 ...
 * (content, module that governs it, version, is transferrable, etc.) about this object.
 */
export type MoveObjectIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type MovePackage = IObject & IOwner & {
  ...
  receivedTransactionBlocks: TransactionBlockConnection;
  /**
   * The `0x3::staking_pool::StakedIka` objects owned by this package.
   *
   * Note that objects owned by a package are inaccessible, because packages are immutable and
   * cannot be owned by an address.
   */
  ...
  storageRebate?: Maybe<Scalars['BigInt']['output']>;
  /**
   * The IkansRegistration NFTs owned by this package. These grant the owner the capability to
   * manage the associated domain.
   *
   * Note that objects owned by a package are inaccessible, because packages are immutable and
   * cannot be owned by an address.
 ...
 * It exposes information about its modules, type definitions, functions, and dependencies.
 */
export type MovePackageDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
 ...
 * It exposes information about its modules, type definitions, functions, and dependencies.
 */
export type MovePackageStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
 ...
 * It exposes information about its modules, type definitions, functions, and dependencies.
 */
export type MovePackageIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Mutations are used to write to the Ika network. */
...
/**
 * An object in Ika is a package (set of Move bytecode modules) or object (typed data structure
 ...
 * field indicating how this object can be accessed.
 */
export type ObjectDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
 ...
 * field indicating how this object can be accessed.
 */
export type ObjectStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
 ...
 * field indicating how this object can be accessed.
 */
export type ObjectIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type ObjectRef = {
  /** ID of the object. */
  address: Scalars['IkaAddress']['input'];
...
/**
 * An Owner is an entity that can own an object. Each Owner is identified by a IkaAddress which
...
export type Owner = IOwner & {
   ...
   * supplied, it defaults to `0x2::ika::IKA`.
   */
  balance?: Maybe<Balance>;
  /** The balances of all coin types owned by this object or address. */
  balances: BalanceConnection;
  ...
  stakedIkas: StakedIkaConnection;
  /**
   * The IkansRegistration NFTs owned by this object or address. These grant the owner the
 ...
 * never both (it is not known up-front whether a given Owner is an Address or an Object).
 */
export type OwnerDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};
 ...
 * never both (it is not known up-front whether a given Owner is an Address or an Object).
 */
export type OwnerStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
 ...
 * never both (it is not known up-front whether a given Owner is an Address or an Object).
 */
export type OwnerIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type PublishTransaction = {
  ...
  dependencies: Array<Scalars['IkaAddress']['output']>;
...
export type Query = {
  __typename?: 'Query';
  /** Look-up an Account by its IkaAddress. */
   ...
   * `0x2::ika::IKA`). If no type is provided, it will default to `0x2::ika::IKA`.
   */
  coins: CoinConnection;
  /**
  ...
  objects: ObjectConnection;
  /**
   * Look up an Owner by its IkaAddress.
   *
   ...
   *
   * If `rootVersion` is omitted, dynamic fields will be from a consistent snapshot of the Ika
  ...
  /** Resolves a IkaNS `domain` name to an address, if it has been bound. */
  resolveIkansAddress?: Maybe<Address>;
...
export type QueryResolveIkansAddressArgs = {
...
export type QueryVerifyZkloginSignatureArgs = {
  author: Scalars['IkaAddress']['input'];
...
export type ServiceConfig = {
  ...
  /**
   * Maximum time in milliseconds spent waiting for a response from fullnode after isikang a
...
export type StakeSubsidy = {
  ...
  /**
   * IKA set aside for stake subsidies -- reduces over time as stake subsidies are paid out over
   * time.
   */
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIka = IMoveObject & IObject & IOwner & {
  __typename?: 'StakedIka';
  ...
  poolId?: Maybe<Scalars['IkaAddress']['output']>;
  /** The transaction block that created this version of the object. */
  previousTransactionBlock?: Maybe<TransactionBlock>;
  /** The IKA that was initially staked. */
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaBalanceArgs = {
  type?: InputMaybe<Scalars['String']['input']>;
};


/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaBalancesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaCoinsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};


/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaDynamicFieldArgs = {
  name: DynamicFieldName;
};


/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaDynamicFieldsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaDynamicObjectFieldArgs = {
  name: DynamicFieldName;
};


/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaObjectsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<ObjectFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaReceivedTransactionBlocksArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<TransactionBlockFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Represents a `0x3::staking_pool::StakedIka` Move object on-chain. */
export type StakedIkaIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type StakedIkaConnection = {
  __typename?: 'StakedIkaConnection';
  /** A list of edges. */
  edges: Array<StakedIkaEdge>;
  /** A list of nodes. */
  nodes: Array<StakedIka>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

/** An edge in a connection. */
export type StakedIkaEdge = {
  __typename?: 'StakedIkaEdge';
  /** A cursor for use in pagination */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge */
  node: StakedIka;
...
/** IKA set aside to account for objects stored on-chain. */
...
export type IkansRegistration = IMoveObject & IObject & IOwner & {
  __typename?: 'IkansRegistration';
  address: Scalars['IkaAddress']['output'];
  /**
   * Total balance of all coins with marker type owned by this object. If type is not supplied,
   * it defaults to `0x2::ika::IKA`.
   ...
   */
  display?: Maybe<Array<DisplayEntry>>;
  /** Domain name of the IkansRegistration object */
...
export type IkansRegistrationBalanceArgs = {
  type?: InputMaybe<Scalars['String']['input']>;
};


export type IkansRegistrationBalancesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationCoinsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationDefaultIkansNameArgs = {
  format?: InputMaybe<DomainFormat>;
};


export type IkansRegistrationDynamicFieldArgs = {
  name: DynamicFieldName;
};


export type IkansRegistrationDynamicFieldsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationDynamicObjectFieldArgs = {
  name: DynamicFieldName;
};


export type IkansRegistrationObjectsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<ObjectFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationReceivedTransactionBlocksArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<TransactionBlockFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationStakedIkasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationIkansRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type IkansRegistrationConnection = {
  __typename?: 'IkansRegistrationConnection';
  /** A list of edges. */
  edges: Array<IkansRegistrationEdge>;
  /** A list of nodes. */
  nodes: Array<IkansRegistration>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

/** An edge in a connection. */
export type IkansRegistrationEdge = {
  __typename?: 'IkansRegistrationEdge';
  /** A cursor for use in pagination */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge */
  node: IkansRegistration;
};
...
export type TransactionBlockFilter = {
   ...
   */
  affectedAddress?: InputMaybe<Scalars['IkaAddress']['input']>;
   ...
   */
  changedObject?: InputMaybe<Scalars['IkaAddress']['input']>;
  /**
   ...
   * `affectedObject` is introduced, whichever is later.
   */
  inputObject?: InputMaybe<Scalars['IkaAddress']['input']>;
  /** An input filter selecting for either system or programmable transactions. */
  kind?: InputMaybe<TransactionBlockKindInput>;
  /** Limit to transactions that were sent by the given address. */
  sentAddress?: InputMaybe<Scalars['IkaAddress']['input']>;
...
export type TransactionMetadata = {
  ...
  gasSponsor?: InputMaybe<Scalars['IkaAddress']['input']>;
  sender?: InputMaybe<Scalars['IkaAddress']['input']>;
};
...
export type TypeOrigin = {
  ...
  definingId: Scalars['IkaAddress']['output'];
...
export type UpgradeTransaction = {
  ...
  currentPackage: Scalars['IkaAddress']['output'];
  /** IDs of the transitive dependencies of the package to be published. */
  dependencies: Array<Scalars['IkaAddress']['output']>;
  /** Bytecode for the modules to be published, BCS serialized and Base64 encoded. */
  modules: Array<Scalars['Base64']['output']>;
...
export type Validator = {
   ...
   * the amount of IKA tokens that each past IKA staker can withdraw in the future.
  ...
  /**
   * The total number of IKA tokens in this pool plus
  ...
  pendingTotalIkaWithdraw?: Maybe<Scalars['BigInt']['output']>;
  ...
  stakingPoolId: Scalars['IkaAddress']['output'];
  /** The total number of IKA tokens in this pool. */
  stakingPoolIkaBalance?: Maybe<Scalars['BigInt']['output']>;
...
export type ValidatorSet = {
  ...
  inactivePoolsId?: Maybe<Scalars['IkaAddress']['output']>;
  ...
  pendingActiveValidatorsId?: Maybe<Scalars['IkaAddress']['output']>;
...
export type GetAllBalancesQueryVariables = Exact<{
  owner: Scalars['IkaAddress']['input'];
...
export type GetDynamicFieldObjectQueryVariables = Exact<{
  parentId: Scalars['IkaAddress']['input'];
  name: DynamicFieldName;
}>;
...
export type ResolveNameServiceAddressQuery = { __typename?: 'Query', resolveIkansAddress?: { __typename?: 'Address', address: any } | null };
...
export type ResolveNameServiceNamesQuery = { __typename?: 'Query', address?: { __typename?: 'Address', ikansRegistrations: { __typename?: 'IkansRegistrationConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, nodes: Array<{ __typename?: 'IkansRegistration', domain: string }> } } | null };
...
export type MultiGetObjectsQueryVariables = Exact<{
  ids: Array<Scalars['IkaAddress']['input']> | Scalars['IkaAddress']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
  cursor?: InputMaybe<Scalars['String']['input']>;
  showBcs?: InputMaybe<Scalars['Boolean']['input']>;
  showContent?: InputMaybe<Scalars['Boolean']['input']>;
...
export type GetStakesQuery = { __typename?: 'Query', address?: { __typename?: 'Address', stakedIkas: { __typename?: 'StakedIkaConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, nodes: Array<{ __typename?: 'StakedIka', principal?: any | null, stakeStatus: StakeStatus, address: any, estimatedReward?: any | null, activatedEpoch?: { __typename?: 'Epoch', epochId: any, referenceGasPrice?: any | null } | null, requestedEpoch?: { __typename?: 'Epoch', epochId: any } | null, contents?: { __typename?: 'MoveValue', json: any } | null }> } } | null };
...
export type GetStakesByIdsQuery = { __typename?: 'Query', objects: { __typename?: 'ObjectConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, nodes: Array<{ __typename?: 'Object', asMoveObject?: { __typename?: 'MoveObject', asStakedIka?: { __typename?: 'StakedIka', principal?: any | null, stakeStatus: StakeStatus, address: any, estimatedReward?: any | null, activatedEpoch?: { __typename?: 'Epoch', epochId: any, referenceGasPrice?: any | null } | null, requestedEpoch?: { __typename?: 'Epoch', epochId: any } | null, contents?: { __typename?: 'MoveValue', json: any } | null } | null } | null }> } };

export type Rpc_Stake_FieldsFragment = { __typename?: 'StakedIka', principal?: any | null, stakeStatus: StakeStatus, address: any, estimatedReward?: any | null, activatedEpoch?: { __typename?: 'Epoch', epochId: any, referenceGasPrice?: any | null } | null, requestedEpoch?: { __typename?: 'Epoch', epochId: any } | null, contents?: { __typename?: 'MoveValue', json: any } | null };
...
export const Rpc_Stake_FieldsFragmentDoc = new TypedDocumentString(`
    fragment RPC_STAKE_FIELDS on StakedIka {
  principal
  activatedEpoch {
    epochId
    referenceGasPrice
...
export const GetAllBalancesDocument = new TypedDocumentString(`
    query getAllBalances($owner: IkaAddress!, $limit: Int, $cursor: String) {
...
export const GetBalanceDocument = new TypedDocumentString(`
    query getBalance($owner: IkaAddress!, $type: String = "0x2::ika::IKA") {
  address(address: $owner) {
    balance(type: $type) {
      coinType {
        repr
...
export const GetCoinsDocument = new TypedDocumentString(`
    query getCoins($owner: IkaAddress!, $first: Int, $cursor: String, $type: String = "0x2::ika::IKA") {
  address(address: $owner) {
    address
...
export const GetDynamicFieldObjectDocument = new TypedDocumentString(`
    query getDynamicFieldObject($parentId: IkaAddress!, $name: DynamicFieldName!) {
...
export const GetDynamicFieldsDocument = new TypedDocumentString(`
    query getDynamicFields($parentId: IkaAddress!, $first: Int, $cursor: String) {
  owner(address: $parentId) {
...
export const GetLatestIkaSystemStateDocument = new TypedDocumentString(`
    query getLatestIkaSystemState {
  epoch {
    epochId
    startTimestamp
    endTimestamp
...
fragment RPC_CREDENTIAL_FIELDS on ValidatorCredentials {
  ...
  proofOfPossession
  protocolPubKey
}`) as unknown as TypedDocumentString<GetLatestIkaSystemStateQuery, GetLatestIkaSystemStateQueryVariables>;
export const GetMoveFunctionArgTypesDocument = new TypedDocumentString(`
    query getMoveFunctionArgTypes($packageId: IkaAddress!, $module: String!, $function: String!) {
...
export const GetNormalizedMoveFunctionDocument = new TypedDocumentString(`
    query getNormalizedMoveFunction($packageId: IkaAddress!, $module: String!, $function: String!) {
  object(address: $packageId) {
    address
    asMovePackage {
      module(name: $module) {
...
export const GetNormalizedMoveModuleDocument = new TypedDocumentString(`
    query getNormalizedMoveModule($packageId: IkaAddress!, $module: String!) {
  object(address: $packageId) {
    asMovePackage {
      module(name: $module) {
...
export const PaginateMoveModuleListsDocument = new TypedDocumentString(`
    query paginateMoveModuleLists($packageId: IkaAddress!, $module: String!, $hasMoreFriends: Boolean!, $hasMoreStructs: Boolean!, $hasMoreFunctions: Boolean!, $afterFriends: String, $afterStructs: String, $afterFunctions: String) {
  object(address: $packageId) {
    asMovePackage {
      module(name: $module) {
...
export const GetNormalizedMoveModulesByPackageDocument = new TypedDocumentString(`
    query getNormalizedMoveModulesByPackage($packageId: IkaAddress!, $cursor: String) {
  object(address: $packageId) {
    asMovePackage {
      address
...
export const GetNormalizedMoveStructDocument = new TypedDocumentString(`
    query getNormalizedMoveStruct($packageId: IkaAddress!, $module: String!, $struct: String!) {
  object(address: $packageId) {
    asMovePackage {
      address
      module(name: $module) {
...
export const ResolveNameServiceAddressDocument = new TypedDocumentString(`
  ...
  resolveIkansAddress(domain: $domain) {
    address
  }
}
...
export const ResolveNameServiceNamesDocument = new TypedDocumentString(`
    query resolveNameServiceNames($address: IkaAddress!, $limit: Int, $cursor: String) {
  address(address: $address) {
    ikansRegistrations(first: $limit, after: $cursor) {
      pageInfo {
        hasNextPage
        endCursor
      }
...
export const GetOwnedObjectsDocument = new TypedDocumentString(`
    query getOwnedObjects($owner: IkaAddress!, $limit: Int, $cursor: String, $showBcs: Boolean = false, $showContent: Boolean = false, $showDisplay: Boolean = false, $showType: Boolean = false, $showOwner: Boolean = false, $showPreviousTransaction: Boolean = false, $showStorageRebate: Boolean = false, $filter: ObjectFilter) {
  address(address: $owner) {
...
export const GetObjectDocument = new TypedDocumentString(`
    query getObject($id: IkaAddress!, $showBcs: Boolean = false, $showOwner: Boolean = false, $showPreviousTransaction: Boolean = false, $showContent: Boolean = false, $showDisplay: Boolean = false, $showType: Boolean = false, $showStorageRebate: Boolean = false) {
  object(address: $id) {
    ...RPC_OBJECT_FIELDS
  }
}
...
export const TryGetPastObjectDocument = new TypedDocumentString(`
    query tryGetPastObject($id: IkaAddress!, $version: UInt53, $showBcs: Boolean = false, $showOwner: Boolean = false, $showPreviousTransaction: Boolean = false, $showContent: Boolean = false, $showDisplay: Boolean = false, $showType: Boolean = false, $showStorageRebate: Boolean = false) {
...
export const MultiGetObjectsDocument = new TypedDocumentString(`
    query multiGetObjects($ids: [IkaAddress!]!, $limit: Int, $cursor: String, $showBcs: Boolean = false, $showContent: Boolean = false, $showDisplay: Boolean = false, $showType: Boolean = false, $showOwner: Boolean = false, $showPreviousTransaction: Boolean = false, $showStorageRebate: Boolean = false) {
...
export const GetStakesDocument = new TypedDocumentString(`
    query getStakes($owner: IkaAddress!, $limit: Int, $cursor: String) {
  address(address: $owner) {
    stakedIkas(first: $limit, after: $cursor) {
      pageInfo {
        hasNextPage
        endCursor
      }
...
export const GetStakesByIdsDocument = new TypedDocumentString(`
    query getStakesByIds($ids: [IkaAddress!]!, $limit: Int, $cursor: String) {
  objects(first: $limit, after: $cursor, filter: {objectIds: $ids}) {
    pageInfo {
      hasNextPage
      endCursor
