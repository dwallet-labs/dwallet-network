...
use signature_mpc::twopc_mpc_protocols::encrypt_user_share::{EncryptedUserShareAndProof, encryption_of_discrete_log_public_parameters, parse_and_verify_secret_share};
...
pub fn verify_user_share(
    ...
    let is_matching = parse_and_verify_secret_share(&secret_share, &dkg_output).map_err(to_js_err)?;
