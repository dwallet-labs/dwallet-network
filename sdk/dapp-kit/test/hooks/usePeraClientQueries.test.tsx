...
import { usePeraClientQueries } from '../../src/hooks/usePeraClientQueries.js';
...
describe('usePeraClientQueries', () => {
	...
	test('should fetch data', async () => {
		const getAllBalances = vi.spyOn(peraClient, 'getAllBalances');
