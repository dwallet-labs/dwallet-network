 ...
 *
 * @example
 * import Pera from "@mysten/ledgerjs-hw-app-pera";
 * const pera = new Pera(transport)
 */
export default class Pera {
	transport: Transport;
	readonly #verbose: boolean;

	constructor(transport: Transport, scrambleKey = 'default_pera_scramble_key', verbose = false) {
