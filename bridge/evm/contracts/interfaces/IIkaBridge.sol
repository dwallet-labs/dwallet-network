...
/// @title IIkaBridge
/// @dev Interface for the Ika Bridge contract.
interface IIkaBridge {
    ...
    /// @param ikaAdjustedAmount The amount of tokens to transfer, adjusted for Ika decimals.
