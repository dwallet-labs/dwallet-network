...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let ika_execution = root.join("ika-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&ika_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/ika-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "ika-adapter-latest".to_string(),
                "ika-execution-cut".to_string(),
                "ika-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/ika-execution/cut-cut",
                    "$PATH/ika-execution/cut-move-core-types",
                    "$PATH/ika-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/ika-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "ika-adapter-latest": CutPackage {
                        dst_name: "ika-adapter-feature",
                        src_path: "$PATH/ika-execution/latest/ika-adapter",
                        dst_path: "$PATH/ika-execution/exec-cut/ika-adapter",
                        ws_state: Member,
                    },
                    "ika-execution-cut": CutPackage {
                        dst_name: "ika-execution-cut-feature",
                        src_path: "$PATH/ika-execution/cut",
                        dst_path: "$PATH/ika-execution/cut-cut",
                        ws_state: Member,
                    },
                    "ika-verifier-latest": CutPackage {
                        dst_name: "ika-verifier-feature",
                        src_path: "$PATH/ika-execution/latest/ika-verifier",
                        dst_path: "$PATH/ika-execution/exec-cut/ika-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   ika-adapter-feature
                     ika-execution/exec-cut/ika-adapter
               from: ika-adapter-latest
                     ika-execution/latest/ika-adapter
             - to:   ika-execution-cut-feature
                     ika-execution/cut-cut
               from: ika-execution-cut
                     ika-execution/cut
             - to:   ika-verifier-feature
                     ika-execution/exec-cut/ika-verifier
               from: ika-verifier-latest
                     ika-execution/latest/ika-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     ika-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/ika-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/ika-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "ika-adapter-latest": CutPackage {
                        dst_name: "ika-adapter-feature",
                        src_path: "$PATH/ika-execution/latest/ika-adapter",
                        dst_path: "$PATH/ika-execution/feature/ika-adapter",
                        ws_state: Member,
                    },
                    "ika-execution-cut": CutPackage {
                        dst_name: "ika-execution-cut-feature",
                        src_path: "$PATH/ika-execution/cut",
                        dst_path: "$PATH/ika-execution/feature/cut",
                        ws_state: Member,
                    },
                    "ika-verifier-latest": CutPackage {
                        dst_name: "ika-verifier-feature",
                        src_path: "$PATH/ika-execution/latest/ika-verifier",
                        dst_path: "$PATH/ika-execution/feature/ika-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
