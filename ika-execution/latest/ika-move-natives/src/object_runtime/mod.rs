...
use ika_types::{
    base_types::{MoveObjectType, ObjectID, SequenceNumber, IkaAddress},
    committee::EpochId,
    ...
    IKA_AUTHENTICATOR_STATE_OBJECT_ID, IKA_BRIDGE_OBJECT_ID, IKA_CLOCK_OBJECT_ID,
    IKA_DENY_LIST_OBJECT_ID, IKA_RANDOMNESS_STATE_OBJECT_ID, IKA_SYSTEM_STATE_OBJECT_ID,
};
use tracing::error;
...
pub(crate) struct TestInventories {
    ...
    pub(crate) address_inventories: BTreeMap<IkaAddress, BTreeMap<Type, Set<ObjectID>>>,
