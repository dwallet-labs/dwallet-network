...
pub mod checked {
    ...
    use crate::ika_types::gas::IkaGasStatusAPI;
    use crate::temporary_store::TemporaryStore;
    use ika_protocol_config::ProtocolConfig;
    use ika_types::deny_list_v2::CONFIG_SETTING_DYNAMIC_FIELD_SIZE_FOR_GAS;
    use ika_types::gas::{deduct_gas, GasCostSummary, IkaGasStatus};
    use ika_types::gas_model::gas_predicates::{
    ...
    impl GasCharger {
        ...
        pub fn new_unmetered(tx_digest: TransactionDigest) -> Self {
            Self {
                ...
                gas_coins: vec![],
                smashed_gas_coin: None,
                gas_status: IkaGasStatus::new_unmetered(),
            }
        }
        ...
        pub fn into_gas_status(self) -> IkaGasStatus {
            self.gas_status
        }
        ...
        pub fn charge_input_objects(
            ...
            let total_size = temporary_store
                .objects()
                .iter()
                // don't charge for loading Ika Framework or Move stdlib
