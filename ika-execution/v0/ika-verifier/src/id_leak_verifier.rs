...
use ika_types::{
    ...
    IKA_FRAMEWORK_ADDRESS, IKA_SYSTEM_ADDRESS,
};
...
#[cfg(msim)]
const IKA_DENY_LIST_OBJECT_CREATE: FunctionIdent = (
    &IKA_FRAMEWORK_ADDRESS,
    COIN_MODULE_NAME,
...
#[cfg(not(msim))]
const FUNCTIONS_TO_SKIP: &[FunctionIdent] = &[IKA_SYSTEM_CREATE, IKA_CLOCK_CREATE];
