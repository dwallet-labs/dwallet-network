...
import { IkaObjectChange } from '@ika-io/ika/client';
...
// SPDX-License-Identifier: Apache-2.0
export function ObjectChanges({ objects }: { objects: IkaObjectChange[] }) {
	return (
...
function ChangedObject({ object }: { object: IkaObjectChange }) {
