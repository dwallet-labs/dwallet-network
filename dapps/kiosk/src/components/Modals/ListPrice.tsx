					...
					<Button
						...
						onClick={() =>
							placeAndListToKioskMutation.mutate({
								item,
								price: (Number(price) * Number(NPERA_PER_PERA)).toString(),
