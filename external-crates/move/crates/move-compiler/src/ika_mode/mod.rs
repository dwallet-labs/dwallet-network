...
pub const IKA_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x2);
pub const IKA_SYSTEM_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x3);
...
pub const IKA_ADDR_NAME: Symbol = symbol!("ika");
...
pub const IKA_MODULE_NAME: Symbol = symbol!("ika");
pub const IKA_OTW_NAME: Symbol = symbol!("IKA");

pub const IKA_SYSTEM_ADDR_NAME: Symbol = symbol!("ika_system");
pub const IKA_SYSTEM_MODULE_NAME: Symbol = symbol!("ika_system");
pub const IKA_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const IKA_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const IKA_DIAG_PREFIX: &str = "Ika ";
