...
//! This analysis flags situations when instances of a ika::table::Table or ika::table_vec::TableVec
//! or ika::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use crate::{
    ...
    parser::ast as P,
    ika_mode::{IKA_ADDR_NAME, IKA_ADDR_VALUE},
...
const COLLECTION_TYPES: &[(Symbol, AccountAddress, &str, &str)] = &[
    (IKA_ADDR_NAME, IKA_ADDR_VALUE, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (
        IKA_ADDR_NAME,
        IKA_ADDR_VALUE,
        OBJECT_BAG_MOD_NAME,
