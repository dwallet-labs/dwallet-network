...
use crate::{
    ...
    parser::ast::Ability_,
    ika_mode::{IKA_ADDR_VALUE, TX_CONTEXT_MODULE_NAME},
};
...
const TRANSFER_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (IKA_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_TRANSFER_FUN),
...
impl SimpleAbsInt for SelfTransferVerifierAI {
    ...
    fn call_custom(
        ...
        if f.is(&IKA_ADDR_VALUE, TX_CONTEXT_MODULE_NAME, "sender") {
