...
//! This analysis flags situations when instances of a pera::table::Table or pera::table_vec::TableVec
//! or pera::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use super::{
    ...
    OBJECT_BAG_STRUCT_NAME, OBJECT_TABLE_MOD_NAME, OBJECT_TABLE_STRUCT_NAME, PERA_PKG_NAME,
...
const COLLECTION_TYPES: &[(&str, &str, &str)] = &[
    (PERA_PKG_NAME, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (PERA_PKG_NAME, OBJECT_BAG_MOD_NAME, OBJECT_BAG_STRUCT_NAME),
    (PERA_PKG_NAME, TABLE_MOD_NAME, TABLE_STRUCT_NAME),
    (
        PERA_PKG_NAME,
    ...
    (PERA_PKG_NAME, TABLE_VEC_MOD_NAME, TABLE_VEC_STRUCT_NAME),
    (PERA_PKG_NAME, VEC_MAP_MOD_NAME, VEC_MAP_STRUCT_NAME),
    (PERA_PKG_NAME, VEC_SET_MOD_NAME, VEC_SET_STRUCT_NAME),
];
