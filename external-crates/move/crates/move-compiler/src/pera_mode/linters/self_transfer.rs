...
use super::{
    ...
    LINT_WARNING_PREFIX, PUBLIC_TRANSFER_FUN, PERA_PKG_NAME, TRANSFER_FUN, TRANSFER_MOD_NAME,
};

const TRANSFER_FUNCTIONS: &[(&str, &str, &str)] = &[
    (PERA_PKG_NAME, TRANSFER_MOD_NAME, PUBLIC_TRANSFER_FUN),
...
impl SimpleAbsInt for SelfTransferVerifierAI {
    ...
    fn call_custom(
        ...
        if f.is("pera", "tx_context", "sender") {
