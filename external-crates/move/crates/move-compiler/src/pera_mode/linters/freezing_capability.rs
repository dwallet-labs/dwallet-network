...
//! Implements lint to warn against freezing capability-like types in Pera, identifying function calls that may incorrectly freeze such types.
...
use crate::{
    ...
    pera_mode::linters::{FREEZE_FUN, PUBLIC_FREEZE_FUN, PERA_PKG_NAME, TRANSFER_MOD_NAME},
    typing::{
        ast as T, core,
...
const FREEZE_FUNCTIONS: &[(&str, &str, &str)] = &[
    (PERA_PKG_NAME, TRANSFER_MOD_NAME, PUBLIC_FREEZE_FUN),
    (PERA_PKG_NAME, TRANSFER_MOD_NAME, FREEZE_FUN),
];
