...
pub const PERA_ADDR_NAME: Symbol = symbol!("pera");
...
pub const PERA_MODULE_NAME: Symbol = symbol!("pera");
pub const PERA_OTW_NAME: Symbol = symbol!("PERA");

pub const PERA_SYSTEM_ADDR_NAME: Symbol = symbol!("pera_system");
pub const PERA_SYSTEM_MODULE_NAME: Symbol = symbol!("pera_system");
pub const PERA_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const PERA_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const PERA_DIAG_PREFIX: &str = "Pera ";
