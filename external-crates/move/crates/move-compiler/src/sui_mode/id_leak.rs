...
use super::{
    ...
    SUI_SYSTEM_MODULE_NAME, UID_TYPE_NAME, ETH_STATE_OBJECT_CREATE, ETH_STATE_OBJECT_MODULE_NAME,
};
...
pub const FUNCTIONS_TO_SKIP: &[(Symbol, Symbol, Symbol)] = &[
    ...
    (SUI_ADDR_NAME, ETH_STATE_OBJECT_MODULE_NAME, ETH_STATE_OBJECT_CREATE),
    (
        SUI_ADDR_NAME,
